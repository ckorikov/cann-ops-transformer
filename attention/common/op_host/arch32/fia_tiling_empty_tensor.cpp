...
constexpr uint8_t TILINGKEY_NUM_2 = 2;
...
{
    tilingKey_ = GET_TPL_TILING_KEY(TILINGKEY_NUM_2, TILINGKEY_NUM_0, TILINGKEY_NUM_0, TILINGKEY_NUM_0, TILINGKEY_NUM_0,
                                    TILINGKEY_NUM_0, TILINGKEY_NUM_0, TILINGKEY_NUM_0, TILINGKEY_NUM_0, TILINGKEY_NUM_0,
                                    TILINGKEY_NUM_0, TILINGKEY_NUM_0, TILINGKEY_NUM_3, TILINGKEY_NUM_0, TILINGKEY_NUM_0,
                                    TILINGKEY_NUM_0, TILINGKEY_NUM_0);
...
REGISTER_TILING_TEMPLATE_FIA(FusedInferAttentionScore, FiaTilingEmptyTensor,
    std::vector<int32_t>({(int32_t)platform_ascendc::SocVersion::ASCEND910B}), 0);
} // namespace optiling