...
const int CV_L1_EVENT[2] = {0, 1};      //16  17
const int CV_MM1RES_EVENT[2] = {2, 3};  //18  19
const int CV_MM2RES_EVENT[2] = {4, 5};  //20  21

const int VC_L1_EVENT[2] = {6, 7};      //22  23
const int VC_MM1RES_EVENT[2] = {8, 9};  //24  25
const int VC_MM2RES_EVENT[2] = {10, 15};//26  27  31
