...
/*!
 * \file fa_cube_in_buffer_double_base.h
 * \brief
 */
#ifndef FA_CUBE_IN_BUFFER_DOUBLE_BASE_H_
#define FA_CUBE_IN_BUFFER_DOUBLE_BASE_H_
...
public:
    ...
    {
        (void)tscmGlobal->localQue[tscmIndex_].EnQue(tensor);
    }

    __aicore__ inline void DeQue()
    {
        (void)tscmGlobal->localQue[tscmIndex_].DeQue();
    }
...
#endif // FA_CUBE_IN_BUFFER_DOUBLE_BASE_H_