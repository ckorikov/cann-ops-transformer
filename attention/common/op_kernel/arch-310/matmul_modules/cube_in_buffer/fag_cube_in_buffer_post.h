 ...
 * \brief
 */
#ifndef FAG_CUBE_IN_BUFFER_POST_H
#define FAG_CUBE_IN_BUFFER_POST_H

#include "../fag_flag_data.h"
namespace AscendC {
namespace Impl {
namespace Detail {
template <typename IMPL, class INPUT_TYPE, const auto &MM_CFG> class FagCubeInBufferS1S2Post
{
...
public:
    __aicore__ inline FagCubeInBufferS1S2Post() {}
    ...
    __aicore__ inline void Destroy()
    {
        if constexpr (INPUT_TYPE::TAG == InputTypeTag::B) {
            ...
            // release right mat
            uint8_t tscmIndex = MM2_ENCODING_TABLE[MATMUL_MODULE(Context)->rightMatrixEncodingTableIdx];
