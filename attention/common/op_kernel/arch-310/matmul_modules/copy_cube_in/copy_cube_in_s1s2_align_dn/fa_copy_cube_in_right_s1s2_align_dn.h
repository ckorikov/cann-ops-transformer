...
/*!
 * \file fa_copy_cube_in_right_s1s2_align_dn.h
 * \brief
 */

#ifndef FA_COPY_CUBE_IN_RIGHT_S1S2_ALIGN_DN_H
#define FA_COPY_CUBE_IN_RIGHT_S1S2_ALIGN_DN_H
...
class FACopyCubeInRightS1s2AlignDn {
...
public:
    ...
    __aicore__ inline FACopyCubeInRightS1s2AlignDn() = default;
    __aicore__ inline ~FACopyCubeInRightS1s2AlignDn() = default;
...
#endif // FA_COPY_CUBE_IN_RIGHT_S1S2_ALIGN_DN_H
