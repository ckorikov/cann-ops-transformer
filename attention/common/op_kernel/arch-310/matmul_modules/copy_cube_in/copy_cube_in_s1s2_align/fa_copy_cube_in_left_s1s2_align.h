...
/*!
 * \file fa_copy_cube_in_left_s1s2_align.h
 * \brief
 */

#ifndef FA_COPY_CUBE_IN_LEFT_S1S2_ALIGN_H
#define FA_COPY_CUBE_IN_LEFT_S1S2_ALIGN_H
...
class FACopyCubeInLeftS1s2Align {
...
public:
    ...
    __aicore__ inline FACopyCubeInLeftS1s2Align() = default;
    __aicore__ inline ~FACopyCubeInLeftS1s2Align() = default;
...
#endif // FA_COPY_CUBE_IN_LEFT_S1S2_ALIGN_H
