...
/*!
 * \file flash_attention_score_regbase_empty_tensor.h
 * \brief
 */
...
protected:
    ...
    const FlashAttentionScoreEmptyInputTilingDataRegbase *__restrict tilingData;
...
#endif // FLASH_ATTENTION_SCORE_REGBASE_EMPTY_TENSOR_H
