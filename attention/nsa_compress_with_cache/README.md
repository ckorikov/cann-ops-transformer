...
| 调用方式  | 样例代码                                                                | 说明                                                                                          |
| ----------- | ------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------- |
| aclnn接口 | [test_aclnn_NsaCompressWithCache](./examples/test_nsa_compress_with_cache.cpp) | 通过[`aclnnNsaCompressWithCache`](./docs/aclnnNsaCompressWithCache.md)接口方式调用NsaCompressWithCache算子。 |
