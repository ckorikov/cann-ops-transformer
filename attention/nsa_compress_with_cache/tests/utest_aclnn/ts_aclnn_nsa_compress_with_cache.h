...
/*!
 * \file ts_aclnn_nsa_compress_with_cache.h
 * \brief NsaCompressWithCache ACLNN UTest 相关基类定义.
 */
...
class Ts_Aclnn_NsaCompressWithCache_WithParam : public Ts_WithParam<AclnnNsaCompressWithCacheCase> {};
class Ts_Aclnn_NsaCompressWithCache_WithParam_Ascend910B3
    : public Ts_WithParam_Ascend910B3<AclnnNsaCompressWithCacheCase> {};