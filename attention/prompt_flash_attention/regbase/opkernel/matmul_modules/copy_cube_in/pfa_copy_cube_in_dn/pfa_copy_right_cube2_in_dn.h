...
/*!
 * \file pfa_copy_right_cube2_in_dn.h
 * \brief
 */

#ifndef PFA_COPY_RIGHT_CUBE2_IN_DN_H
#define PFA_COPY_RIGHT_CUBE2_IN_DN_H
...
class PFACopyBmm2RightCubeInDN {
...
public:
    ...
    __aicore__ inline PFACopyBmm2RightCubeInDN() = default;
    __aicore__ inline ~PFACopyBmm2RightCubeInDN() = default;
    ...
    LoadData(int curRow, int curCol, int tileHeight, int tileWidth, int batchNum = -1) {
        ...
        aGlobal.SetGlobalBuffer(srcGlobalAddr_ + (callTimes_ & 1) *
            MATMUL_MODULE(CopyCubeInParams)->GetBaseHeight() * MATMUL_MODULE(CopyCubeInParams)->GetOrgWidth());
...
#endif // PFA_COPY_RIGHT_CUBE2_IN_DN_H
