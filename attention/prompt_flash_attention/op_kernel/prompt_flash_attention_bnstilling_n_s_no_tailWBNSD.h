...
/*!
 * \file prompt_flash_attention_bnstilling_n_s_no_tailWBNSD.h
 * \brief
 */
#ifndef PROMPT_FLASH_ATTENTION_SCORE_BNSTILLING_N_S_WITHBNSD_NO_TAIL_H
#define PROMPT_FLASH_ATTENTION_SCORE_BNSTILLING_N_S_WITHBNSD_NO_TAIL_H
...
__aicore__ inline void PromptFlashAttentionBNSTillingNSWithBNSDNoTail<T, U, FORMAT, O, M>::SInnerLoopFunc(int32_t startIndex,
    ...
    uint32_t sInnerOffset = startIndex * this->singleProcessSInnerSize;
    this->tensorAOffset = this->tensorACoreOffset;
    this->tensorBOffset = this->tensorBCoreOffset + sInnerOffset * this->tilingData->promptAttentionBaseParams.headSize;
