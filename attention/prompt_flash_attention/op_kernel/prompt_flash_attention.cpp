...
template<uint8_t Q_T, uint8_t KV_T, uint16_t OUT_T, uint8_t PAGE_ATTENTIOND, uint16_t LAYOUT_T,  uint16_t KV_LAYOUT_T, uint16_t FLASH_DECODE,
            uint8_t ENABLE_PREFIX, uint8_t M_Q_QUANTMODE_P_MSD_MODE_I_ANTIQUANTMODE, uint8_t M_OUTLAYOUT_P_TAIL_MODE_I_ORIGIN_T, uint8_t M_K_QUANTMODE_P_NEWTILINGFLAG_I_AMLA,  uint16_t M_V_QUANTMODE_P_PRECISION_MODE_I_BALANCE, 
                ...
                uint8_t M_SOFTMAXBRCB_P_CVDIFF_MLA_FLAG,  uint8_t P_TEMPLATE_VERSION, uint8_t TEMPLATE_MODE>
...
{
    {
        ...
        if constexpr ((Q_T == 0 || Q_T == 6) && (KV_T != 1)){
            if constexpr ((Q_T == 0) && (M_V_QUANTMODE_P_PRECISION_MODE_I_BALANCE == 0) && (OUT_T == 0) && (LAYOUT_T == 0) && (M_FIAFLAG_P_MMTYPETMP_I_MODEVAL == 0) && (PAGE_ATTENTIOND == 0) && (ENABLE_PREFIX == 0) && (M_Q_QUANTMODE_P_MSD_MODE_I_ANTIQUANTMODE == 0) && (M_TEMPLATE_TYPE_P_CVDIFF_BASE_FLAG == 0) && (M_SOFTMAXBRCB_P_CVDIFF_MLA_FLAG == 0)
            ...
            else if ((M_OUTLAYOUT_P_TAIL_MODE_I_ORIGIN_T == 2) && (M_K_QUANTMODE_P_NEWTILINGFLAG_I_AMLA == 1) && (Q_T == 0) && (M_V_QUANTMODE_P_PRECISION_MODE_I_BALANCE == 0) && (OUT_T == 0) && (LAYOUT_T == 0) && (M_FIAFLAG_P_MMTYPETMP_I_MODEVAL == 4) && (PAGE_ATTENTIOND == 0) && (ENABLE_PREFIX == 0) && (M_Q_QUANTMODE_P_MSD_MODE_I_ANTIQUANTMODE == 0) && (M_TEMPLATE_TYPE_P_CVDIFF_BASE_FLAG == 2) && (M_SOFTMAXBRCB_P_CVDIFF_MLA_FLAG == 0)   
            ...
            else if ((M_OUTLAYOUT_P_TAIL_MODE_I_ORIGIN_T == 2) && (M_K_QUANTMODE_P_NEWTILINGFLAG_I_AMLA == 1) && (Q_T == 0) && (M_V_QUANTMODE_P_PRECISION_MODE_I_BALANCE == 1) && (OUT_T == 0) && (LAYOUT_T == 0) && (M_FIAFLAG_P_MMTYPETMP_I_MODEVAL == 4) && (PAGE_ATTENTIOND == 0) && (ENABLE_PREFIX == 0) && (M_Q_QUANTMODE_P_MSD_MODE_I_ANTIQUANTMODE == 0) && (M_TEMPLATE_TYPE_P_CVDIFF_BASE_FLAG == 0) && (M_SOFTMAXBRCB_P_CVDIFF_MLA_FLAG == 1)   
                && (KV_T == 0) && (P_TEMPLATE_VERSION == 2)){
                REGISTER_TILING_FOR_TILINGKEY("TRUE", PromptFlashAttentionBaseApiTilingData);
            ...
            if constexpr ((M_OUTLAYOUT_P_TAIL_MODE_I_ORIGIN_T == 2) && (M_K_QUANTMODE_P_NEWTILINGFLAG_I_AMLA == 1) && (Q_T == 0 || Q_T == 6) && (M_V_QUANTMODE_P_PRECISION_MODE_I_BALANCE == 0 || M_V_QUANTMODE_P_PRECISION_MODE_I_BALANCE == 1) && (OUT_T == 0)   
                ...
                && (M_Q_QUANTMODE_P_MSD_MODE_I_ANTIQUANTMODE == 0 || M_Q_QUANTMODE_P_MSD_MODE_I_ANTIQUANTMODE == 1) && (M_TEMPLATE_TYPE_P_CVDIFF_BASE_FLAG == 0) && (M_SOFTMAXBRCB_P_CVDIFF_MLA_FLAG == 0 || M_SOFTMAXBRCB_P_CVDIFF_MLA_FLAG == 1) && (KV_T == 0 || KV_T == 4 || KV_T == 8) && (P_TEMPLATE_VERSION == 1 || P_TEMPLATE_VERSION == 2)){
                if constexpr ((P_TEMPLATE_VERSION == 1) && (M_V_QUANTMODE_P_PRECISION_MODE_I_BALANCE == 1) && (M_K_QUANTMODE_P_NEWTILINGFLAG_I_AMLA == 1) && (M_OUTLAYOUT_P_TAIL_MODE_I_ORIGIN_T == 2)){   
                    if constexpr ((KV_T == 0) && (PAGE_ATTENTIOND == 0) && (Q_T == 6) && (M_Q_QUANTMODE_P_MSD_MODE_I_ANTIQUANTMODE == 0) && (M_SOFTMAXBRCB_P_CVDIFF_MLA_FLAG == 0) && (P_TEMPLATE_VERSION == 1) 
                    ...
                    else if ((KV_T == 0) && (PAGE_ATTENTIOND == 1) && (Q_T == 6) && (M_FIAFLAG_P_MMTYPETMP_I_MODEVAL == 0) && (ENABLE_PREFIX == 0) && (M_Q_QUANTMODE_P_MSD_MODE_I_ANTIQUANTMODE == 0) && (M_SOFTMAXBRCB_P_CVDIFF_MLA_FLAG == 0) && (P_TEMPLATE_VERSION == 1) 
                    ...
                    else if ((KV_T == 8) && (PAGE_ATTENTIOND == 0) && (Q_T == 6) && (M_FIAFLAG_P_MMTYPETMP_I_MODEVAL == 0) && (M_Q_QUANTMODE_P_MSD_MODE_I_ANTIQUANTMODE == 0) && (M_SOFTMAXBRCB_P_CVDIFF_MLA_FLAG == 0) && (P_TEMPLATE_VERSION == 1) 
                    ...
                    else if ((KV_T == 4)  && (PAGE_ATTENTIOND == 0) && (Q_T == 6) && (M_FIAFLAG_P_MMTYPETMP_I_MODEVAL == 0) && (M_Q_QUANTMODE_P_MSD_MODE_I_ANTIQUANTMODE == 1) && (M_SOFTMAXBRCB_P_CVDIFF_MLA_FLAG == 0) && (P_TEMPLATE_VERSION == 1) 
                    ...
                    && (M_Q_QUANTMODE_P_MSD_MODE_I_ANTIQUANTMODE == 0) && (M_SOFTMAXBRCB_P_CVDIFF_MLA_FLAG == 0) && (P_TEMPLATE_VERSION == 1)){
                        if (maskByteNum == FLOAT16BYTENUM) {
                    ...
                    else if ((KV_T == 0) && (PAGE_ATTENTIOND == 0) && (Q_T == 0) && (M_Q_QUANTMODE_P_MSD_MODE_I_ANTIQUANTMODE == 0) && (M_SOFTMAXBRCB_P_CVDIFF_MLA_FLAG == 0) && (P_TEMPLATE_VERSION == 1) 
                    ...
                    else if ((KV_T == 8) && (PAGE_ATTENTIOND == 0) && (Q_T == 0) && (M_FIAFLAG_P_MMTYPETMP_I_MODEVAL == 0) && (M_Q_QUANTMODE_P_MSD_MODE_I_ANTIQUANTMODE == 0) && (M_SOFTMAXBRCB_P_CVDIFF_MLA_FLAG == 0) && (P_TEMPLATE_VERSION == 1) 
                ...
                && (LAYOUT_T == 0) && (M_FIAFLAG_P_MMTYPETMP_I_MODEVAL == 4) && (PAGE_ATTENTIOND == 0) && (ENABLE_PREFIX == 0) && (M_Q_QUANTMODE_P_MSD_MODE_I_ANTIQUANTMODE == 0) && (M_SOFTMAXBRCB_P_CVDIFF_MLA_FLAG == 0 || M_SOFTMAXBRCB_P_CVDIFF_MLA_FLAG == 1) && (KV_T == 0)){
                    if (M_SOFTMAXBRCB_P_CVDIFF_MLA_FLAG == 0){
                        REGISTER_TILING_FOR_TILINGKEY("TRUE", PromptFlashAttentionBaseApiTilingData);
                    ...
                    else if (M_SOFTMAXBRCB_P_CVDIFF_MLA_FLAG == 1){
                        REGISTER_TILING_FOR_TILINGKEY("TRUE", PromptFlashAttentionBaseApiTilingData);
            ...
            if constexpr ((M_OUTLAYOUT_P_TAIL_MODE_I_ORIGIN_T == 2) && (M_K_QUANTMODE_P_NEWTILINGFLAG_I_AMLA == 1) && (Q_T == 0 || Q_T == 6) && (M_V_QUANTMODE_P_PRECISION_MODE_I_BALANCE == 1) && (OUT_T == 2)   
                ...
                && (M_Q_QUANTMODE_P_MSD_MODE_I_ANTIQUANTMODE == 0 || M_Q_QUANTMODE_P_MSD_MODE_I_ANTIQUANTMODE == 1) && (M_TEMPLATE_TYPE_P_CVDIFF_BASE_FLAG == 0) && (M_SOFTMAXBRCB_P_CVDIFF_MLA_FLAG == 0) && (KV_T == 0 || KV_T == 4 || KV_T == 8) && (P_TEMPLATE_VERSION == 1)){
            ...
            if constexpr ((Q_T == 0 || Q_T == 1) && (KV_T != 1) && (M_OUTLAYOUT_P_TAIL_MODE_I_ORIGIN_T == 0 || M_OUTLAYOUT_P_TAIL_MODE_I_ORIGIN_T == 1 || M_OUTLAYOUT_P_TAIL_MODE_I_ORIGIN_T == 2 || M_OUTLAYOUT_P_TAIL_MODE_I_ORIGIN_T == 5 || M_OUTLAYOUT_P_TAIL_MODE_I_ORIGIN_T == 6 || M_OUTLAYOUT_P_TAIL_MODE_I_ORIGIN_T == 3)     
                ...
                && (M_Q_QUANTMODE_P_MSD_MODE_I_ANTIQUANTMODE == 0) && (M_TEMPLATE_TYPE_P_CVDIFF_BASE_FLAG == 0 || M_TEMPLATE_TYPE_P_CVDIFF_BASE_FLAG == 2) && (M_SOFTMAXBRCB_P_CVDIFF_MLA_FLAG == 0 || M_SOFTMAXBRCB_P_CVDIFF_MLA_FLAG == 1) && (KV_T == 0) && (P_TEMPLATE_VERSION == 1 || P_TEMPLATE_VERSION == 2 || P_TEMPLATE_VERSION == 4)){
            ...
            && (M_TEMPLATE_TYPE_P_CVDIFF_BASE_FLAG == 0)  && (M_SOFTMAXBRCB_P_CVDIFF_MLA_FLAG == 0)){
                // Non-BNSD layout, split NS no tail
            ...
            else if ((P_TEMPLATE_VERSION == 2) && (M_SOFTMAXBRCB_P_CVDIFF_MLA_FLAG == 0) && (M_TEMPLATE_TYPE_P_CVDIFF_BASE_FLAG == 2) && (M_OUTLAYOUT_P_TAIL_MODE_I_ORIGIN_T == 2) && (M_K_QUANTMODE_P_NEWTILINGFLAG_I_AMLA == 1) && (Q_T == 1) && (OUT_T == 1) && (LAYOUT_T == 0) 
            ...
            else if ((P_TEMPLATE_VERSION == 2) && (M_SOFTMAXBRCB_P_CVDIFF_MLA_FLAG == 0) && (M_TEMPLATE_TYPE_P_CVDIFF_BASE_FLAG == 0) && (M_OUTLAYOUT_P_TAIL_MODE_I_ORIGIN_T == 2) && (M_K_QUANTMODE_P_NEWTILINGFLAG_I_AMLA == 1) && (Q_T == 1) && (OUT_T == 1) && (LAYOUT_T == 0) 
            && (M_FIAFLAG_P_MMTYPETMP_I_MODEVAL == 4) && (PAGE_ATTENTIOND == 0)){
                REGISTER_TILING_FOR_TILINGKEY("TRUE", PromptFlashAttentionBaseApiTilingData);
            ...
            else if ((P_TEMPLATE_VERSION == 2) && (M_SOFTMAXBRCB_P_CVDIFF_MLA_FLAG == 1) && (M_TEMPLATE_TYPE_P_CVDIFF_BASE_FLAG == 0) && (M_OUTLAYOUT_P_TAIL_MODE_I_ORIGIN_T == 2) && (M_K_QUANTMODE_P_NEWTILINGFLAG_I_AMLA == 1) && (Q_T == 1) && (OUT_T == 1) && (LAYOUT_T == 0) 
            && (M_FIAFLAG_P_MMTYPETMP_I_MODEVAL == 4) && (PAGE_ATTENTIOND == 0)){
                REGISTER_TILING_FOR_TILINGKEY("TRUE", PromptFlashAttentionBaseApiTilingData);
            ...
            && (PAGE_ATTENTIOND == 0) && (M_TEMPLATE_TYPE_P_CVDIFF_BASE_FLAG == 0)  && (M_SOFTMAXBRCB_P_CVDIFF_MLA_FLAG == 0)){
            ...
            if constexpr ((M_OUTLAYOUT_P_TAIL_MODE_I_ORIGIN_T == 2) && (M_K_QUANTMODE_P_NEWTILINGFLAG_I_AMLA == 1) && (Q_T == 1) && (M_V_QUANTMODE_P_PRECISION_MODE_I_BALANCE == 1) && (OUT_T == 1)   
                ...
                && (M_Q_QUANTMODE_P_MSD_MODE_I_ANTIQUANTMODE == 0 || M_Q_QUANTMODE_P_MSD_MODE_I_ANTIQUANTMODE == 1) && (M_TEMPLATE_TYPE_P_CVDIFF_BASE_FLAG == 0) && (M_SOFTMAXBRCB_P_CVDIFF_MLA_FLAG == 0) && (KV_T == 0 || KV_T == 4) && (P_TEMPLATE_VERSION == 1)){
        ...
        if constexpr ((M_OUTLAYOUT_P_TAIL_MODE_I_ORIGIN_T == 0 || M_OUTLAYOUT_P_TAIL_MODE_I_ORIGIN_T == 1 || M_OUTLAYOUT_P_TAIL_MODE_I_ORIGIN_T == 2 || M_OUTLAYOUT_P_TAIL_MODE_I_ORIGIN_T == 5 || M_OUTLAYOUT_P_TAIL_MODE_I_ORIGIN_T == 6 || M_OUTLAYOUT_P_TAIL_MODE_I_ORIGIN_T == 7)    
                ...
                && (M_Q_QUANTMODE_P_MSD_MODE_I_ANTIQUANTMODE == 0) && (M_TEMPLATE_TYPE_P_CVDIFF_BASE_FLAG == 0) && (M_SOFTMAXBRCB_P_CVDIFF_MLA_FLAG == 0) && (KV_T == 0) && (P_TEMPLATE_VERSION == 1)){
        ...
        __gm__ uint8_t* user = GetUserWorkspace(workspace);
        KERNEL_TASK_TYPE_DEFAULT(KERNEL_TYPE_MIX_AIC_1_2);
        if constexpr( (M_FIAFLAG_P_MMTYPETMP_I_MODEVAL == 0) && (PAGE_ATTENTIOND == 0) && (ENABLE_PREFIX == 0) && (M_Q_QUANTMODE_P_MSD_MODE_I_ANTIQUANTMODE == 0) && (M_TEMPLATE_TYPE_P_CVDIFF_BASE_FLAG == 0) && (M_SOFTMAXBRCB_P_CVDIFF_MLA_FLAG == 0)   
            && (KV_T == 0) && (P_TEMPLATE_VERSION == 1)){
                                            ...
                                            __gm__ uint8_t* workspace, __gm__ uint8_t* tiling)
{
        prompt_flash_attention_FIAS<Q_T, KV_T, OUT_T, PAGE_ATTENTIOND, LAYOUT_T, KV_LAYOUT_T, FLASH_DECODE, ENABLE_PREFIX, M_Q_QUANTMODE_P_MSD_MODE_I_ANTIQUANTMODE,
                                    ...
                                    M_FIAFLAG_P_MMTYPETMP_I_MODEVAL, M_TEMPLATE_TYPE_P_CVDIFF_BASE_FLAG, M_SOFTMAXBRCB_P_CVDIFF_MLA_FLAG, P_TEMPLATE_VERSION, TEMPLATE_MODE>
