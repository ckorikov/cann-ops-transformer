...
#define INVOKE_PFA_NO_KFC_MLA_OP_IMPL_VAR_LEN(templateClass, ...)                                                          \
    ...
    do {                                                                                                                \
        ...
        templateClass<__VA_ARGS__> op;                                                                                  \
        op.UnpackInit(query, key, value, attenMask, actualSeqLengths, actualSeqLengthsKV, queryRope, keyRope, blocktable, \
...
{
    {
        ...
        prompt_flash_attention_FIAS_regbase(query, key, value, pseShift, attenMask, actualSeqLengths, actualSeqLengthsKV,
            ...
            value_antiquant_offset, keySharedPrefix, valueSharedPrefix, actualSharedPrefixLen, queryRope, keyRope, attentionOut,
        ...
        KERNEL_TASK_TYPE_DEFAULT(KERNEL_TYPE_MIX_AIC_1_2);
            ...
            TILING_KEY_IS(2000000010004001012);
            ...
            #if TILING_KEY_VAR == 1000000000000000100
                // split NS no tail
            ...
            TILING_KEY_IS(1000000000000020200);
            TILING_KEY_IS(1000000000000020201);
            ...
            TILING_KEY_IS(1000000000000000200);
            TILING_KEY_IS(1000000000000000201);
                                                             ...
                                                             __gm__ uint8_t* workspace, __gm__ uint8_t* tiling)
{
    prompt_flash_attention_FIAS(query, key, value, pseShift, attenMask, actualSeqLengths, actualSeqLengthsKV, deq_scale1, quant_scale1, deq_scale2, quant_scale2,
                                quant_offset2, nullptr, nullptr, nullptr, nullptr, nullptr, nullptr,nullptr, nullptr, nullptr, nullptr, nullptr, nullptr, nullptr, nullptr, attentionOut, nullptr, workspace, tiling);
}