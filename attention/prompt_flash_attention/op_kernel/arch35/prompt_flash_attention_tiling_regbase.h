...
public:
    ...
    void Bmm1TilingDataRectFromLegacyFormat(TCubeTiling& bmm1TilingDataRect) {
        this->bmm1TilingDataRect.usedCoreNum = bmm1TilingDataRect.get_usedCoreNum();
        this->bmm1TilingDataRect.M = bmm1TilingDataRect.get_M();
        this->bmm1TilingDataRect.N = bmm1TilingDataRect.get_N();
        this->bmm1TilingDataRect.Ka = bmm1TilingDataRect.get_Ka();
        this->bmm1TilingDataRect.Kb = bmm1TilingDataRect.get_Kb();
        this->bmm1TilingDataRect.singleCoreM = bmm1TilingDataRect.get_singleCoreM();
        this->bmm1TilingDataRect.singleCoreN = bmm1TilingDataRect.get_singleCoreN();
        this->bmm1TilingDataRect.singleCoreK = bmm1TilingDataRect.get_singleCoreK();
        this->bmm1TilingDataRect.baseM = bmm1TilingDataRect.get_baseM();
        this->bmm1TilingDataRect.baseN = bmm1TilingDataRect.get_baseN();
        this->bmm1TilingDataRect.baseK = bmm1TilingDataRect.get_baseK();
        this->bmm1TilingDataRect.depthA1 = bmm1TilingDataRect.get_depthA1();
        this->bmm1TilingDataRect.depthB1 = bmm1TilingDataRect.get_depthB1();
        this->bmm1TilingDataRect.stepM = bmm1TilingDataRect.get_stepM();
        this->bmm1TilingDataRect.stepN = bmm1TilingDataRect.get_stepN();
        this->bmm1TilingDataRect.stepKa = bmm1TilingDataRect.get_stepKa();
        this->bmm1TilingDataRect.stepKb = bmm1TilingDataRect.get_stepKb();
        this->bmm1TilingDataRect.isBias = bmm1TilingDataRect.get_isBias();
        this->bmm1TilingDataRect.transLength = bmm1TilingDataRect.get_transLength();
        this->bmm1TilingDataRect.iterateOrder = bmm1TilingDataRect.get_iterateOrder();
        this->bmm1TilingDataRect.dbL0A = bmm1TilingDataRect.get_dbL0A();
        this->bmm1TilingDataRect.dbL0B = bmm1TilingDataRect.get_dbL0B();
        this->bmm1TilingDataRect.dbL0C = bmm1TilingDataRect.get_dbL0C();
        this->bmm1TilingDataRect.shareMode = bmm1TilingDataRect.get_shareMode();
        this->bmm1TilingDataRect.shareL1Size = bmm1TilingDataRect.get_shareL1Size();
        this->bmm1TilingDataRect.shareL0CSize = bmm1TilingDataRect.get_shareL0CSize();
        this->bmm1TilingDataRect.shareUbSize = bmm1TilingDataRect.get_shareUbSize();
        this->bmm1TilingDataRect.batchM = bmm1TilingDataRect.get_batchM();
        this->bmm1TilingDataRect.batchN = bmm1TilingDataRect.get_batchN();
        this->bmm1TilingDataRect.singleBatchM = bmm1TilingDataRect.get_singleBatchM();
        this->bmm1TilingDataRect.singleBatchN = bmm1TilingDataRect.get_singleBatchN();
    }

    void Bmm2TilingDataRectFromLegacyFormat(TCubeTiling& bmm2TilingDataRect) {
        this->bmm2TilingDataRect.usedCoreNum = bmm2TilingDataRect.get_usedCoreNum();
        this->bmm2TilingDataRect.M = bmm2TilingDataRect.get_M();
        this->bmm2TilingDataRect.N = bmm2TilingDataRect.get_N();
        this->bmm2TilingDataRect.Ka = bmm2TilingDataRect.get_Ka();
        this->bmm2TilingDataRect.Kb = bmm2TilingDataRect.get_Kb();
        this->bmm2TilingDataRect.singleCoreM = bmm2TilingDataRect.get_singleCoreM();
        this->bmm2TilingDataRect.singleCoreN = bmm2TilingDataRect.get_singleCoreN();
        this->bmm2TilingDataRect.singleCoreK = bmm2TilingDataRect.get_singleCoreK();
        this->bmm2TilingDataRect.baseM = bmm2TilingDataRect.get_baseM();
        this->bmm2TilingDataRect.baseN = bmm2TilingDataRect.get_baseN();
        this->bmm2TilingDataRect.baseK = bmm2TilingDataRect.get_baseK();
        this->bmm2TilingDataRect.depthA1 = bmm2TilingDataRect.get_depthA1();
        this->bmm2TilingDataRect.depthB1 = bmm2TilingDataRect.get_depthB1();
        this->bmm2TilingDataRect.stepM = bmm2TilingDataRect.get_stepM();
        this->bmm2TilingDataRect.stepN = bmm2TilingDataRect.get_stepN();
        this->bmm2TilingDataRect.stepKa = bmm2TilingDataRect.get_stepKa();
        this->bmm2TilingDataRect.stepKb = bmm2TilingDataRect.get_stepKb();
        this->bmm2TilingDataRect.isBias = bmm2TilingDataRect.get_isBias();
        this->bmm2TilingDataRect.transLength = bmm2TilingDataRect.get_transLength();
        this->bmm2TilingDataRect.iterateOrder = bmm2TilingDataRect.get_iterateOrder();
        this->bmm2TilingDataRect.dbL0A = bmm2TilingDataRect.get_dbL0A();
        this->bmm2TilingDataRect.dbL0B = bmm2TilingDataRect.get_dbL0B();
        this->bmm2TilingDataRect.dbL0C = bmm2TilingDataRect.get_dbL0C();
        this->bmm2TilingDataRect.shareMode = bmm2TilingDataRect.get_shareMode();
        this->bmm2TilingDataRect.shareL1Size = bmm2TilingDataRect.get_shareL1Size();
        this->bmm2TilingDataRect.shareL0CSize = bmm2TilingDataRect.get_shareL0CSize();
        this->bmm2TilingDataRect.shareUbSize = bmm2TilingDataRect.get_shareUbSize();
        this->bmm2TilingDataRect.batchM = bmm2TilingDataRect.get_batchM();
        this->bmm2TilingDataRect.batchN = bmm2TilingDataRect.get_batchN();
        this->bmm2TilingDataRect.singleBatchM = bmm2TilingDataRect.get_singleBatchM();
        this->bmm2TilingDataRect.singleBatchN = bmm2TilingDataRect.get_singleBatchN();
    }

    void softmaxTilingDataRectFromLegacyFormat(SoftMaxTiling& softmaxTilingDataRect) {
        this->softmaxTilingDataRect.srcM = softmaxTilingDataRect.get_srcM();
        this->softmaxTilingDataRect.srcK = softmaxTilingDataRect.get_srcK();
        this->softmaxTilingDataRect.srcSize = softmaxTilingDataRect.get_srcSize();
        this->softmaxTilingDataRect.outMaxM = softmaxTilingDataRect.get_outMaxM();
        this->softmaxTilingDataRect.outMaxK = softmaxTilingDataRect.get_outMaxK();
        this->softmaxTilingDataRect.outMaxSize = softmaxTilingDataRect.get_outMaxSize();
        this->softmaxTilingDataRect.splitM = softmaxTilingDataRect.get_splitM();
        this->softmaxTilingDataRect.splitK = softmaxTilingDataRect.get_splitK();
        this->softmaxTilingDataRect.splitSize = softmaxTilingDataRect.get_splitSize();
        this->softmaxTilingDataRect.reduceM = softmaxTilingDataRect.get_reduceM();
        this->softmaxTilingDataRect.reduceK = softmaxTilingDataRect.get_reduceK();
        this->softmaxTilingDataRect.reduceSize = softmaxTilingDataRect.get_reduceSize();
        this->softmaxTilingDataRect.rangeM = softmaxTilingDataRect.get_rangeM();
        this->softmaxTilingDataRect.tailM = softmaxTilingDataRect.get_tailM();
        this->softmaxTilingDataRect.tailSplitSize = softmaxTilingDataRect.get_tailSplitSize();
        this->softmaxTilingDataRect.tailReduceSize = softmaxTilingDataRect.get_tailReduceSize();
    }

    void softmaxFlashTilingDataRectFromLegacyFormat(SoftMaxTiling& softmaxFlashTilingDataRect) {
        this->softmaxFlashTilingDataRect.srcM = softmaxFlashTilingDataRect.get_srcM();
        this->softmaxFlashTilingDataRect.srcK = softmaxFlashTilingDataRect.get_srcK();
        this->softmaxFlashTilingDataRect.srcSize = softmaxFlashTilingDataRect.get_srcSize();
        this->softmaxFlashTilingDataRect.outMaxM = softmaxFlashTilingDataRect.get_outMaxM();
        this->softmaxFlashTilingDataRect.outMaxK = softmaxFlashTilingDataRect.get_outMaxK();
        this->softmaxFlashTilingDataRect.outMaxSize = softmaxFlashTilingDataRect.get_outMaxSize();
        this->softmaxFlashTilingDataRect.splitM = softmaxFlashTilingDataRect.get_splitM();
        this->softmaxFlashTilingDataRect.splitK = softmaxFlashTilingDataRect.get_splitK();
        this->softmaxFlashTilingDataRect.splitSize = softmaxFlashTilingDataRect.get_splitSize();
        this->softmaxFlashTilingDataRect.reduceM = softmaxFlashTilingDataRect.get_reduceM();
        this->softmaxFlashTilingDataRect.reduceK = softmaxFlashTilingDataRect.get_reduceK();
        this->softmaxFlashTilingDataRect.reduceSize = softmaxFlashTilingDataRect.get_reduceSize();
        this->softmaxFlashTilingDataRect.rangeM = softmaxFlashTilingDataRect.get_rangeM();
        this->softmaxFlashTilingDataRect.tailM = softmaxFlashTilingDataRect.get_tailM();
        this->softmaxFlashTilingDataRect.tailSplitSize = softmaxFlashTilingDataRect.get_tailSplitSize();
        this->softmaxFlashTilingDataRect.tailReduceSize = softmaxFlashTilingDataRect.get_tailReduceSize();
    }
