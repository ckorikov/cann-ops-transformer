...
class Ts_MlaPrologV3_Ascend910B2_tc_kernel : public Ts_MlaPrologV3_WithParam_Ascend910B2 {};

TEST_P(Ts_MlaPrologV3_Ascend910B2_tc_kernel, Tc_Case)
{
...
const auto Tc_MlaPrologV3_Case = ::testing::Values(
    ...
    MlaPrologV3Case("MlaPrologV3_Tc_00002", true,                    /* CaseName, Enable */
           ...
           MlaPrologV3Param(32, 2, 7168, 1536, 512, 64, 128, 64,             /* B, S, He, Hcq, Hckv, N, D, Dr */
                   ...
                   {Tensor("smoothScalesCq", {1, 1536}, "1", ge::DataType::DT_FLOAT, ge::FORMAT_ND, Tensor::TensorType::OPTIONAL_INPUT)},                                             /* smoothScalesCq */
                   {},                                             /* actualSeqLen */
                   {Tensor("kvCacheOut", {16, 128, 1, 512}, "1", ge::DataType::DT_BF16, ge::FORMAT_ND, Tensor::TensorType::REQUIRED_INPUT)},                                             /* kvCacheOut */                                            /* kvCacheOut */
                   {},                                             /* krCacheOut */
    ...
    // 半量化kv量化
    MlaPrologV3Case("MlaPrologV3_Tc_kernel_00003", true,                    /* CaseName, Enable */
           "",                                                     /* DebugInfo */
           OpInfo(ControlInfo(true, true),                        /* RunTiling, RunKernel */
                  ExpectInfo(true,                                 /* ExpectSuccess */
    ...
    // 半量化kv不量化
    MlaPrologV3Case("MlaPrologV3_Tc_kernel_00004", true,                    /* CaseName, Enable */
           "",                                                     /* DebugInfo */
           OpInfo(ControlInfo(true, true),                        /* RunTiling, RunKernel */
                  ExpectInfo(true,                                 /* ExpectSuccess */
       ...
       // 非量化
    MlaPrologV3Case("MlaPrologV2_Tc_kernel_00005", true,                    /* CaseName, Enable */
           "",                                                     /* DebugInfo */
           OpInfo(ControlInfo(true, true),                        /* RunTiling, RunKernel */
                  ExpectInfo(true,                                 /* ExpectSuccess */
                             17,        /* ExpectTilingKey */
...
INSTANTIATE_TEST_SUITE_P(MlaPrologV3, Ts_MlaPrologV3_Ascend910B2_tc_kernel, Tc_MlaPrologV3_Case);