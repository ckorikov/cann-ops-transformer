...
/**
 * @brief The first interface of aclnnMlaPrologV3WeightNz calculates the workspace size based on the specific calculation process.
...
__attribute__((visibility("default"))) aclnnStatus aclnnMlaPrologV3WeightNzGetWorkspaceSize(
    ...
    int64_t queryNormFlag, int64_t weightQuantMode, int64_t kvCacheQuantMode, int64_t queryQuantMode, int64_t ckvkrRepoMode, int64_t quantScaleRepoMode,
    ...
    const aclTensor *dequantScaleQNopeOutOptional, const aclTensor *queryNormOutOptional, const aclTensor *dequantScaleQNormOutOptional,
    uint64_t *workspaceSize, aclOpExecutor **executor);

/**
 * @brief The second interface of aclnnMlaPrologV3WeightNz is used to perform calculations.
 */
__attribute__((visibility("default"))) aclnnStatus aclnnMlaPrologV3WeightNz(void *workspace,
