...
#ifndef OP_API_INC_LEVEL0_OP_NSA_COMPRESS_ATTENTION_INFER_OP_H_
#define OP_API_INC_LEVEL0_OP_NSA_COMPRESS_ATTENTION_INFER_OP_H_
...
#endif // OP_API_INC_LEVEL0_OP_NSA_NSA_COMPRESS_ATTENTION_INFER_OP_H_