...
/*!
 * \file mla_prolog_v2_param.h
 * \brief MlaPrologV2 参数信息.
 */

#ifndef MLA_PROLOG_V2_PARAM_H
#define MLA_PROLOG_V2_PARAM_H
...
public:
    MlaPrologV2Param() = default;
    MlaPrologV2Param(int64_t pB, int64_t pS, int64_t pHe, int64_t pHcq, int64_t pHckv, int64_t pN, int64_t pD, int64_t pDr, int64_t pSkv, int64_t pNkv, int64_t pBlockSize, int64_t pBlockNum,
        CacheModeType pCacheModeType, float pRmsnormEpsilonCq, float pRmsnormEpsilonCkv);

    // for TND
    MlaPrologV2Param(int64_t pT, int64_t pB, int64_t pS, int64_t pHe, int64_t pHcq, int64_t pHckv, int64_t pN, int64_t pD, int64_t pDr, int64_t pSkv, int64_t pNkv, int64_t pBlockSize, int64_t pBlockNum,
        CacheModeType pCacheModeType, float pRmsnormEpsilonCq, float pRmsnormEpsilonCkv);
    ...
    virtual ~MlaPrologV2Param() = default;
