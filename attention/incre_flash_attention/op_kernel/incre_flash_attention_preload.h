...
protected:
    ...
    BufferManager<TPosition::A2, 2> l0aBufferManager;   // 2:l0a buf size
    // L0_B
    TBuf<TPosition::B2> tmpBufL0B;
    LocalTensor<KV_T> bL0TensorPingPong[2];
    BufferManager<TPosition::B2, 2> l0bBufferManager;   // 2:l0b buf size
    // L0_C
    TBuf<TPosition::CO1> tmpBufL0C;
    LocalTensor<MM_OUT_T> cL0TensorPingPong[2];
    BufferManager<TPosition::CO1, 2> l0cBufferManager;  // 2:l0c buf size
#endif
