...
- **参数说明**
  ...
  <ul>
    <li>Atlas A2 训练系列产品/Atlas 800I A2 推理产品/A200I A2 Box 异构组件、Atlas A3 训练系列产品/Atlas A3 推理系列产品：支持FLOAT32的localOut和out。</li>
    <li>昇腾910_95 AI处理器：支持FLOAT32，FLOAT16，BFLOAT16的localOut和out。</li>
  </ul>
- **返回值**
