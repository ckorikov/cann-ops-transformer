...
TEST_F(Ts_Fas_Ascend910B2, Tc_Fas_Invalid_QKVShape_Case_007)
{
    FasCase cs("Tc_Fas_Invalid_QKVShape_Case_007", true,               /* CaseName, Enable */
               "",                                                     /* DebugInfo */
               OpInfoWithSocversion(ControlInfo(true, false),                        /* RunTiling, RunKernel */
                      ExpectInfoWithSocversion(false,                                /* ExpectSuccess */
                                 ExpectInfoWithSocversion::kInvalidTilingKey,        /* ExpectTilingKey */
    ...
    ASSERT_TRUE(cs.Init(static_cast<int32_t>(this->socVersion_)));
    cs.mParam.query = Tensor("query", {2048, 2048, 128},
                             "QueryInvalidShape", cs.mParam.dtype, ge::FORMAT_ND);
    cs.mParam.key = Tensor("key", {2048, 2048, 100}, "KeyInvalidShape",
                           cs.mParam.dtype, ge::FORMAT_ND);
    cs.mParam.value = Tensor("value", {2048, 2048, 100}, "ValueInvalidShape",
                             cs.mParam.dtype, ge::FORMAT_ND);
    ASSERT_EQ(cs.Run(), cs.mForward.mExp.mSuccess);
}
...
TEST_F(Ts_Fas_Ascend910B2, Tc_Fas_Invalid_AttenMask_Case_005)
{
    FasCase cs("Tc_Fas_Invalid_AttenMask_Case_005", true,              /* CaseName, Enable */
               "",                                                     /* DebugInfo */
               OpInfoWithSocversion(ControlInfo(true, false),                        /* RunTiling, RunKernel */
                      ExpectInfoWithSocversion(false,                                /* ExpectSuccess */
                                 ExpectInfoWithSocversion::kInvalidTilingKey,        /* ExpectTilingKey */
    ...
    ASSERT_TRUE(cs.Init(static_cast<int32_t>(this->socVersion_)));
    cs.mParam.attenMask = Tensor("atten_mask", {512, 1020}, "AttenMaskInvalidShape",
                                 cs.mParam.attenMaskDtype, ge::FORMAT_ND);
    ASSERT_EQ(cs.Run(), cs.mForward.mExp.mSuccess);
}
...
TEST_F(Ts_Fas_Ascend910B2, Tc_Fas_Invalid_Pse_Case_005)
{
    FasCase cs("Tc_Fas_Invalid_Pse_Case_005", true,                    /* CaseName, Enable */
               ...
               FaParam(3, 40, 1, 2048, 3072, 128,                      /* B, N2, G, S1, S2, D */
                       ...
                       {},                                             /* PrefixTensorData */
                       {2048, 2048, 2048},                             /* ActualSeqQLenList */
                       {1024, 3072, 2048})                             /* ActualSeqKVLenList */
    );
...
TEST_F(Ts_Fas_Ascend910B2, Tc_Fas_Invalid_Prefix_Case_006)
{
    FasCase cs("Tc_Fas_Invalid_Prefix_Case_006", true,                 /* CaseName, Enable */
               ...
               FaParam(3, 40, 1, 1024, 2048, 128,                      /* B, N2, G, S1, S2, D */
                       ...
                       {1024, 1024, 1024},                             /* ActualSeqQLenList */
                       {2048, 2048, 2048})                             /* ActualSeqKVLenList */
    );
...
TEST_F(Ts_Fas_Ascend910B2, Tc_Fas_Invalid_kvStartIdx_Case001)
{
    FasCase cs("Tc_Fas_Invalid_kvStartIdx_Case001", true,              /* CaseName, Enable */
               "",                                                     /* DebugInfo */
               OpInfoWithSocversion(ControlInfo(true, false),                        /* RunTiling, RunKernel */
                      ExpectInfoWithSocversion(false,                                /* ExpectSuccess */
                                 ExpectInfoWithSocversion::kInvalidTilingKey,        /* ExpectTilingKey */
               ...
               FaParam(3, 40, 1, 2048, 1024, 128,                      /* B, N2, G, S1, S2, D */
                       ...
                       0, 3, 2,                                        /* InnerPrecise, SparseMode, pseType*/
...
TEST_F(Ts_Fas_Ascend910B2, Tc_Fas_Invalid_D_Case001)
{
    FasCase cs("Tc_Fas_Invalid_D_Case001", true,    /* CaseName, Enable */
               "",                                                     /* DebugInfo */
               OpInfoWithSocversion(ControlInfo(true, false),                        /* RunTiling, RunKernel */
                      ExpectInfoWithSocversion(false,                                /* ExpectSuccess */
                                 ExpectInfoWithSocversion::kInvalidTilingKey,        /* ExpectTilingKey */
                                 ExpectInfoWithSocversion::kInvalidTilingBlockDim)), /* ExpectTilingBlockDim */
               FaParam(3, 40, 1, 2048, 1024, 896,                      /* B, N2, G, S1, S2, D */
                       ge::DataType::DT_FLOAT16, LayoutType::BNSD,     /* Dtype, LayoutType */
                       0.08838f, 0.9f, 1024, 0,                        /* Scale, KeepProb, PreTokens, NxtTokens */
                       0, 8,                                           /* InnerPrecise, SparseMode */
                       PseShapeType::NONE,                             /* PseShapeType */
