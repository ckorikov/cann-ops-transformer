...
每个算子分为[两段式接口](../../../docs/context/两段式接口.md)，必须先调用“aclnnFlashAttentionScoreVXGetWorkspaceSize”接口获取计算所需workspace大小以及包含了算子计算流程的执行器，再调用“aclnnFlashAttentionScoreVX”接口执行计算。
  ...
  <table style="undefined;table-layout: fixed; width: 1565px"><colgroup>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          <ul>
              <li>数据类型与attentionOut的数据类型一致。</li>
      ...
      <tr>
        ...
        <td>输入</td>
        <td>Device侧的aclTensor，query的量化参数。</td>
      ...
      <tr>
        ...
        <td>输入</td>
        <td>Device侧的aclTensor，key的量化参数。</td>
      ...
      <tr>
        ...
        <td>输入</td>
        <td>Device侧的aclTensor，value的量化参数。</td>
        <td>输入shape为[B,N2,Ceil(Skv/128),1]。</td>
        <td>FLOAT32</td>
        <td>ND</td>
        <td>0、3、4</td>
      ...
      <tr>
        <td>offset</td>
        <td>输入</td>
        <td>Host侧的int64_t，生成dropmask的offset。</td>
        <td>-</td>
        <td>INT64</td>
        <td>-</td>
        <td>-</td>
...
- aclnn单算子调用方式
  ...
  int main() {
    ...
    ret = aclnnFlashAttentionScoreVXGetWorkspaceSize(
              ...
              headNum, layOut, innerPrecise, sparseMod, outDtype, pseType, seed, offset, softmaxMax, softmaxSum,
