...
ASCENDC_TPL_ARGS_DECL(FusedInferAttentionScore,
    ...
    ASCENDC_TPL_UINT_DECL(M_SOFTMAXBRCB_P_CVDIFF_MLA_FLAG, ASCENDC_TPL_1_BW, ASCENDC_TPL_UI_LIST, 0, 1, 4),
...
ASCENDC_TPL_SEL(
    ASCENDC_TPL_ARGS_SEL(
        ...
        ASCENDC_TPL_UINT_SEL(M_SOFTMAXBRCB_P_CVDIFF_MLA_FLAG, ASCENDC_TPL_UI_LIST, 0),
    ...
    ASCENDC_TPL_ARGS_SEL(
        ...
        ASCENDC_TPL_UINT_SEL(M_SOFTMAXBRCB_P_CVDIFF_MLA_FLAG, ASCENDC_TPL_UI_LIST, 0, 4),
        ASCENDC_TPL_UINT_SEL(P_TEMPLATE_VERSION, ASCENDC_TPL_UI_LIST, 0),
        ASCENDC_TPL_UINT_SEL(TEMPLATE_MODE, ASCENDC_TPL_UI_LIST, 0),
        ASCENDC_TPL_TILING_STRUCT_SEL(optiling::FusedInferAttentionScoreTilingData)
    ),
...
//PFA
    ...
    ASCENDC_TPL_ARGS_SEL(
        ...
        ASCENDC_TPL_UINT_SEL(M_FIAFLAG_P_MMTYPETMP_I_MODEVAL, ASCENDC_TPL_UI_LIST, 4),
        ASCENDC_TPL_UINT_SEL(M_TEMPLATE_TYPE_P_CVDIFF_BASE_FLAG, ASCENDC_TPL_UI_LIST, 0),
        ASCENDC_TPL_UINT_SEL(M_SOFTMAXBRCB_P_CVDIFF_MLA_FLAG, ASCENDC_TPL_UI_LIST, 1),
        ASCENDC_TPL_UINT_SEL(P_TEMPLATE_VERSION, ASCENDC_TPL_UI_LIST, 2),
        ASCENDC_TPL_UINT_SEL(TEMPLATE_MODE, ASCENDC_TPL_UI_LIST, 2),
        ASCENDC_TPL_TILING_STRUCT_SEL(PromptFlashAttentionBaseApiTilingData)
    ),
