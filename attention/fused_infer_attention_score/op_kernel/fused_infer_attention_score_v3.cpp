...
// Mla PA fp16 kv_NZ
    ...
    INVOKE_FIA_OP_GENERAL_IMPL(FiaKernelNonQuantMla, FiaBlockCubeNonQuantMla, FiaBlockVecNonQuantMla,
                               FiaBlockVecFlashDecode, half, half, half, half, true, false, FIA_LAYOUT::BNSD, false,
                               false, FIA_LAYOUT::NZ);
#elif TILING_KEY_VAR == QF16_KVF16_OUTF16_BNSD_KVNZ_PAGEDCACHE_FLASHDECODING_MLA_TILING   // 7buf
    INVOKE_FIA_OP_GENERAL_IMPL(FiaKernelNonQuantMla, FiaBlockCubeNonQuantMla, FiaBlockVecNonQuantMla,
                               FiaBlockVecFlashDecode, half, half, half, half, true, true, FIA_LAYOUT::BNSD, false,
                               false, FIA_LAYOUT::NZ);
#elif TILING_KEY_VAR == QF16_KVF16_OUTF16_BSH_KVNZ_PAGEDCACHE_MLA_TILING                  // 7buf
    INVOKE_FIA_OP_GENERAL_IMPL(FiaKernelNonQuantMla, FiaBlockCubeNonQuantMla, FiaBlockVecNonQuantMla,
                               FiaBlockVecFlashDecode, half, half, half, half, true, false, FIA_LAYOUT::BSH, false,
                               false, FIA_LAYOUT::NZ);
#elif TILING_KEY_VAR == QF16_KVF16_OUTF16_BSH_KVNZ_PAGEDCACHE_FLASHDECODING_MLA_TILING    // 7buf
    INVOKE_FIA_OP_GENERAL_IMPL(FiaKernelNonQuantMla, FiaBlockCubeNonQuantMla, FiaBlockVecNonQuantMla,
                               FiaBlockVecFlashDecode, half, half, half, half, true, true, FIA_LAYOUT::BSH, false,
                               false, FIA_LAYOUT::NZ);
#elif TILING_KEY_VAR == QF16_KVF16_OUTF16_TND_KVNZ_PAGEDCACHE_MLA_TILING                  // 7buf
    INVOKE_FIA_OP_GENERAL_IMPL(FiaKernelNonQuantMla, FiaBlockCubeNonQuantMla, FiaBlockVecNonQuantMla,
                               FiaBlockVecFlashDecode, half, half, half, half, true, false, FIA_LAYOUT::TND, false,
                               false, FIA_LAYOUT::NZ);
#elif TILING_KEY_VAR == QF16_KVF16_OUTF16_TND_KVNZ_PAGEDCACHE_FLASHDECODING_MLA_TILING    // 7buf
    INVOKE_FIA_OP_GENERAL_IMPL(FiaKernelNonQuantMla, FiaBlockCubeNonQuantMla, FiaBlockVecNonQuantMla,
                               FiaBlockVecFlashDecode, half, half, half, half, true, true, FIA_LAYOUT::TND, false,
                               false, FIA_LAYOUT::NZ);
// Mla PA fp16 kv_BNSD
...
// Mla NoPA fp16 kv_BNSD
    ...
    INVOKE_FIA_OP_GENERAL_IMPL(FiaKernelNonQuantMla, FiaBlockCubeNonQuantMla, FiaBlockVecNonQuantMla,
                               FiaBlockVecFlashDecode, half, half, half, half, false, false, FIA_LAYOUT::BNSD, false,
                               false, FIA_LAYOUT::BNSD);
#elif TILING_KEY_VAR == QF16_KVF16_OUTF16_BNSD_KVBNSD_FLASHDECODING_MLA_TILING            // 7buf
    INVOKE_FIA_OP_GENERAL_IMPL(FiaKernelNonQuantMla, FiaBlockCubeNonQuantMla, FiaBlockVecNonQuantMla,
                               FiaBlockVecFlashDecode, half, half, half, half, false, true, FIA_LAYOUT::BNSD, false,
                               false, FIA_LAYOUT::BNSD);
// Mla NoPA fp16 kv_BSH_BSND
#elif TILING_KEY_VAR == QF16_KVF16_OUTF16_BSH_KVBSH_MLA_TILING                            // 7buf
    INVOKE_FIA_OP_GENERAL_IMPL(FiaKernelNonQuantMla, FiaBlockCubeNonQuantMla, FiaBlockVecNonQuantMla,
                               FiaBlockVecFlashDecode, half, half, half, half, false, false, FIA_LAYOUT::BSH, false,
                               false, FIA_LAYOUT::BSH);
#elif TILING_KEY_VAR == QF16_KVF16_OUTF16_BSH_KVBSH_FLASHDECODING_MLA_TILING              // 7buf
    INVOKE_FIA_OP_GENERAL_IMPL(FiaKernelNonQuantMla, FiaBlockCubeNonQuantMla, FiaBlockVecNonQuantMla,
                               FiaBlockVecFlashDecode, half, half, half, half, false, true, FIA_LAYOUT::BSH, false,
                               false, FIA_LAYOUT::BSH);
// Mla NoPA fp16 kv_TND
#elif TILING_KEY_VAR == QF16_KVF16_OUTF16_TND_KVTND_MLA_TILING                            // 7buf
    INVOKE_FIA_OP_GENERAL_IMPL(FiaKernelNonQuantMla, FiaBlockCubeNonQuantMla, FiaBlockVecNonQuantMla,
                               FiaBlockVecFlashDecode, half, half, half, half, false, false, FIA_LAYOUT::TND, false,
                               false, FIA_LAYOUT::TND);
#elif TILING_KEY_VAR == QF16_KVF16_OUTF16_TND_KVTND_FLASHDECODING_MLA_TILING              // 7buf
    INVOKE_FIA_OP_GENERAL_IMPL(FiaKernelNonQuantMla, FiaBlockCubeNonQuantMla, FiaBlockVecNonQuantMla,
                               FiaBlockVecFlashDecode, half, half, half, half, false, true, FIA_LAYOUT::TND, false,
                               false, FIA_LAYOUT::TND);
...
// Mla PA bf16 kv_NZ
    ...
    INVOKE_FIA_OP_GENERAL_IMPL(FiaKernelNonQuantMla, FiaBlockCubeNonQuantMla, FiaBlockVecNonQuantMla,
                               FiaBlockVecFlashDecode, bfloat16_t, bfloat16_t, bfloat16_t, bfloat16_t, true, false,
    ...
    INVOKE_FIA_OP_GENERAL_IMPL(FiaKernelNonQuantMla, FiaBlockCubeNonQuantMla, FiaBlockVecNonQuantMla,
                               FiaBlockVecFlashDecode, bfloat16_t, bfloat16_t, bfloat16_t, bfloat16_t, true, true,
                               FIA_LAYOUT::BNSD, false, false, FIA_LAYOUT::NZ);
...
// Mla PA bf16 kv_BNSD
    ...
    INVOKE_FIA_OP_GENERAL_IMPL(FiaKernelNonQuantMla, FiaBlockCubeNonQuantMla, FiaBlockVecNonQuantMla,
                               FiaBlockVecFlashDecode, bfloat16_t, bfloat16_t, bfloat16_t, bfloat16_t, true, false,
                               FIA_LAYOUT::BSH, false, false, FIA_LAYOUT::BNSD);
...
// Mla NoPA bf16 kv_BNSD
    ...
    INVOKE_FIA_OP_GENERAL_IMPL(FiaKernelNonQuantMla, FiaBlockCubeNonQuantMla, FiaBlockVecNonQuantMla,
                               FiaBlockVecFlashDecode, bfloat16_t, bfloat16_t, bfloat16_t, bfloat16_t, false, false,
                               FIA_LAYOUT::BNSD, false, false, FIA_LAYOUT::BNSD);
#elif TILING_KEY_VAR == QBF16_KVBF16_OUTBF16_BNSD_KVBNSD_FLASHDECODING_MLA_TILING            // 7buf
    INVOKE_FIA_OP_GENERAL_IMPL(FiaKernelNonQuantMla, FiaBlockCubeNonQuantMla, FiaBlockVecNonQuantMla,
                               FiaBlockVecFlashDecode, bfloat16_t, bfloat16_t, bfloat16_t, bfloat16_t, false, true,
                               FIA_LAYOUT::BNSD, false, false, FIA_LAYOUT::BNSD);
// Mla NoPA bf16 kv_BSH_BSND
...
// Mla NoPA bf16 kv_TND
    ...
    INVOKE_FIA_OP_GENERAL_IMPL(FiaKernelNonQuantMla, FiaBlockCubeNonQuantMla, FiaBlockVecNonQuantMla,
                               FiaBlockVecFlashDecode, bfloat16_t, bfloat16_t, bfloat16_t, bfloat16_t, false, false,
                               FIA_LAYOUT::TND, false, false, FIA_LAYOUT::TND);
