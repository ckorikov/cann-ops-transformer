...
public:
    bool qPaddingFlag;
    bool kvPaddingFlag;
    bool get_qPaddingFlag() { return qPaddingFlag; }
    bool get_kvPaddingFlag() { return kvPaddingFlag; }
...
public:
    bool pseShiftFlag;
    bool pseShiftByBatch;
    uint32_t pseShiftS1;
    uint32_t pseShiftS2;
    uint32_t pseShiftB;	
    uint32_t pseShiftS;

    bool get_pseShiftFlag() { return pseShiftFlag; }
    bool get_pseShiftByBatch() { return pseShiftByBatch; }
...
public:
    ...
    bool get_prefixFlag() { return prefixFlag; }
    ...
    void set_prefixFlag(bool prefixFlag) { this->prefixFlag = prefixFlag; }
};
