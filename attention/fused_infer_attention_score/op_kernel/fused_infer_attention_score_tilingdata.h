...
// 空tensor 参数
class FusedInferAttentionScoreEmptyTensorTilingData {
public:
...
public:
    ...
    FiaLeftPaddingTilingParam leftPaddingParams;
    FiaPseShiftTilingParam pseParams;
    FiaPrefixTilingParam prefixParams; 
};
} // namespace optiling
