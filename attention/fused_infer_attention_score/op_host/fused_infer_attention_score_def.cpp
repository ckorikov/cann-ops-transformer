...
public:
    FusedInferAttentionScore(const char *name) : OpDef(name)
    {
        ...
        config_310p.Input("block_table")
            ...
            .FormatList({ge::FORMAT_ND})
            .AutoContiguous();
        config_310p.Input("query_padding_size")
            .ParamType(OPTIONAL)
            .DataTypeList({ge::DT_INT64})
            .FormatList({ge::FORMAT_ND})
            .AutoContiguous();
        config_310p.Input("kv_padding_size")
            ...
            .FormatList({ge::FORMAT_ND})
            .AutoContiguous();
        config_310p.Input("key_antiquant_scale")
            .ParamType(OPTIONAL)
            .DataType({ge::DT_FLOAT16})
            .FormatList({ge::FORMAT_ND})
            .AutoContiguous();
        config_310p.Input("key_antiquant_offset")
            .ParamType(OPTIONAL)
            .DataType({ge::DT_FLOAT16})
            .FormatList({ge::FORMAT_ND})
            .AutoContiguous();
        config_310p.Input("value_antiquant_scale")
            .ParamType(OPTIONAL)
            .DataType({ge::DT_FLOAT16})
            .FormatList({ge::FORMAT_ND})
            .AutoContiguous();
        config_310p.Input("value_antiquant_offset")
            .ParamType(OPTIONAL)
            .DataType({ge::DT_FLOAT16})
            .FormatList({ge::FORMAT_ND})
            .AutoContiguous();
        config_310p.Input("key_shared_prefix")
            .ParamType(OPTIONAL)
            .DataType({ge::DT_FLOAT16})
            .FormatList({ge::FORMAT_ND})
            .AutoContiguous();
        config_310p.Input("value_shared_prefix")
            .ParamType(OPTIONAL)
            .DataType({ge::DT_FLOAT16})
            .FormatList({ge::FORMAT_ND})
            .AutoContiguous();
        config_310p.Input("actual_shared_prefix_len")
            .ParamType(OPTIONAL)
            .ValueDepend(OPTIONAL)
            .DataTypeList({ge::DT_INT64})
            .FormatList({ge::FORMAT_ND})
            .AutoContiguous();
        config_310p.Input("query_rope")
            .ParamType(OPTIONAL)
            .DataType({ge::DT_FLOAT16})
            .FormatList({ge::FORMAT_ND})
            .AutoContiguous();
        config_310p.Input("key_rope")
            .ParamType(OPTIONAL)
            .DataType({ge::DT_FLOAT16})
            .FormatList({ge::FORMAT_ND})
            .AutoContiguous();
        config_310p.Input("key_rope_antiquant_scale")
            .ParamType(OPTIONAL)
            .DataType({ge::DT_FLOAT16})
            .FormatList({ge::FORMAT_ND})
            .AutoContiguous();
        config_310p.Input("dequant_scale_query")
            .ParamType(OPTIONAL)
            .DataTypeList({ge::DT_FLOAT})
            .FormatList({ge::FORMAT_ND})
            .AutoContiguous();
        config_310p.Input("learnable_sink")
            .ParamType(OPTIONAL)
            .DataTypeList({ge::DT_BF16})
            .FormatList({ge::FORMAT_ND})
            .AutoContiguous();
        config_310p.Input("q_start_idx")
            .ParamType(OPTIONAL)
            .ValueDepend(OPTIONAL)
            .DataTypeList({ge::DT_INT64})
            .FormatList({ge::FORMAT_ND})
            .AutoContiguous();
        config_310p.Input("kv_start_idx")
            .ParamType(OPTIONAL)
            .ValueDepend(OPTIONAL)
            .DataTypeList({ge::DT_INT64})
            .FormatList({ge::FORMAT_ND})
