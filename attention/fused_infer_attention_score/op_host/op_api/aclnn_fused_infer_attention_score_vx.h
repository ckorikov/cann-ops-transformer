...
#ifndef ACLNN_FUSED_INFER_ATTENTION_SCORE_VX_H_
#define ACLNN_FUSED_INFER_ATTENTION_SCORE_VX_H_
...
/**
 * @brief The first interface of aclnnFusedInferAttentionScoreVX calculates the workspace size based on the specific calculation process.
 * @domain aclnn_ops_infer
 */
__attribute__((visibility("default"))) aclnnStatus aclnnFusedInferAttentionScoreVXGetWorkspaceSize(
...
/**
 * @brief The second interface of aclnnFusedInferAttentionScoreVX is used to perform calculations.
 */
__attribute__((visibility("default"))) aclnnStatus aclnnFusedInferAttentionScoreVX(void *workspace,
