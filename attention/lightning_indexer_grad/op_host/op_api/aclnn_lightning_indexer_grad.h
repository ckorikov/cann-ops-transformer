...
#ifndef OP_API_INC_LIGHTNING_INDEXER_GRAD_H_
#define OP_API_INC_LIGHTNING_INDEXER_GRAD_H_
...
/**
 * @brief aclnnLightningIndexerGrad的第一段接口，根据具体的计算流程，计算workspace大小。
...
#endif // OP_API_INC_LIGHTNING_INDEXER_GRAD_H_
