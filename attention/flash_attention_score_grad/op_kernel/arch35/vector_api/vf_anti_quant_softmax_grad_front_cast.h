    ...
    if constexpr (srcN <= 128) {
        ...
        __VEC_SCOPE__
        {
            ...
            for (uint16_t m = 0; m < static_cast<uint16_t>(srcM); m++) {
                DataCopy<T1, MicroAPI::PostLiteral::POST_MODE_UPDATE>(vregSrcFp8, ((__ubuf__ T1 *&)srcLocalInt), srcN);
                DataCopy<OUTDTYPE, MicroAPI::PostLiteral::POST_MODE_UPDATE>(vregGradB16, ((__ubuf__ OUTDTYPE *&)gradLocalInt), srcN);
        ...
        const uint32_t fullExeSize = 128;
        uint64_t gradLocalIntTail = gradTensor.GetPhyAddr() + fullExeSize * sizeof(OUTDTYPE);
        ...
        __VEC_SCOPE__
        {
            ...
            for (uint16_t m = 0; m < static_cast<uint16_t>(srcM); m++) {
                DataCopy<T1, MicroAPI::PostLiteral::POST_MODE_UPDATE>(vregSrcFp8, ((__ubuf__ T1 *&)srcLocalInt), srcN);
                DataCopy<OUTDTYPE, MicroAPI::PostLiteral::POST_MODE_UPDATE>(vregGradB16, ((__ubuf__ OUTDTYPE *&)gradLocalInt), srcN);
                DataCopy<OUTDTYPE, MicroAPI::PostLiteral::POST_MODE_UPDATE>(vregGradB16Tail, ((__ubuf__ OUTDTYPE *&)gradLocalIntTail), srcN);
        ...
        uint64_t gradLocalInt1 = gradTensor.GetPhyAddr() + fullExeSize * sizeof(OUTDTYPE);
        uint64_t gradLocalIntTail = gradTensor.GetPhyAddr() + fullExeSize * 2 * sizeof(OUTDTYPE);
        ...
        __VEC_SCOPE__
        {
            ...
            for (uint16_t m = 0; m < static_cast<uint16_t>(srcM); m++) {
                DataCopy<T1, MicroAPI::PostLiteral::POST_MODE_UPDATE>(vregSrcFp8, ((__ubuf__ T1 *&)srcLocalInt), 512);
                DataCopy<T1, MicroAPI::PostLiteral::POST_MODE_UPDATE>(vregSrcFp8Tail,
                                                                    ((__ubuf__ T1 *&)srcLocalIntTail), 512);
                DataCopy<OUTDTYPE, MicroAPI::PostLiteral::POST_MODE_UPDATE>(vregGradDtype, ((__ubuf__ OUTDTYPE *&)gradLocalInt), 512);
                DataCopy<OUTDTYPE, MicroAPI::PostLiteral::POST_MODE_UPDATE>(vregGradDtype1,
                                                                    ((__ubuf__ OUTDTYPE *&)gradLocalInt1), 512);
                DataCopy<OUTDTYPE, MicroAPI::PostLiteral::POST_MODE_UPDATE>(vregGradDtypeTail,
        ...
        uint64_t srcLocalIntTail = srcTensor.GetPhyAddr() + fullExeSize * 2 * sizeof(T1);
        uint64_t gradLocalInt1 = gradTensor.GetPhyAddr() + fullExeSize * sizeof(OUTDTYPE);
        uint64_t gradLocalInt2 = gradTensor.GetPhyAddr() + fullExeSize * 2 * sizeof(OUTDTYPE);
        uint64_t gradLocalIntTail = gradTensor.GetPhyAddr() + fullExeSize * 3 * sizeof(OUTDTYPE);
        ...
        __VEC_SCOPE__
        {
            ...
            for (uint16_t m = 0; m < static_cast<uint16_t>(srcM); m++) {
                if constexpr (OUTDTYPE_IS_B16) {
                    ...
                    DataCopy<OUTDTYPE, MicroAPI::PostLiteral::POST_MODE_UPDATE>(vregGradDtype1,
                                                                        ((__ubuf__ OUTDTYPE *&)gradLocalInt1), 512);
                    DataCopy<OUTDTYPE, MicroAPI::PostLiteral::POST_MODE_UPDATE>(vregGradDtype2,
        ...
        uint64_t gradLocalInt1 = gradTensor.GetPhyAddr() + fullExeSize * sizeof(OUTDTYPE);
        uint64_t gradLocalInt2 = gradTensor.GetPhyAddr() + fullExeSize * 2 * sizeof(OUTDTYPE);
        uint64_t gradLocalInt3 = gradTensor.GetPhyAddr() + fullExeSize * 3 * sizeof(OUTDTYPE);
        uint64_t gradLocalIntTail = gradTensor.GetPhyAddr() + fullExeSize * 4 * sizeof(OUTDTYPE);
        ...
        __VEC_SCOPE__
        {
            ...
            for (uint16_t m = 0; m < static_cast<uint16_t>(srcM); m++) {
                if constexpr (OUTDTYPE_IS_B16) {
                    DataCopy<T1, MicroAPI::PostLiteral::POST_MODE_UPDATE>(vregSrcFp8, ((__ubuf__ T1 *&)srcLocalInt), 512);
                    DataCopy<T1, MicroAPI::PostLiteral::POST_MODE_UPDATE>(vregSrcFp81, ((__ubuf__ T1 *&)srcLocalInt1), 512);
                    DataCopy<T1, MicroAPI::PostLiteral::POST_MODE_UPDATE>(vregSrcFp8Tail,
                                                                        ((__ubuf__ T1 *&)srcLocalIntTail), 512);
                    DataCopy<OUTDTYPE, MicroAPI::PostLiteral::POST_MODE_UPDATE>(vregGradDtype, ((__ubuf__ OUTDTYPE *&)gradLocalInt), 512);
                    DataCopy<OUTDTYPE, MicroAPI::PostLiteral::POST_MODE_UPDATE>(vregGradDtype1,
                    ...
                    DataCopy<OUTDTYPE, MicroAPI::PostLiteral::POST_MODE_UPDATE>(vregGradDtype2,
                                                                        ((__ubuf__ OUTDTYPE *&)gradLocalInt2), 512);
                    DataCopy<OUTDTYPE, MicroAPI::PostLiteral::POST_MODE_UPDATE>(vregGradDtype3,
        ...
        uint64_t gradLocalInt2 = gradTensor.GetPhyAddr() + fullExeSize * 2 * sizeof(OUTDTYPE);
        uint64_t gradLocalInt3 = gradTensor.GetPhyAddr() + fullExeSize * 3 * sizeof(OUTDTYPE);
        uint64_t gradLocalInt4 = gradTensor.GetPhyAddr() + fullExeSize * 4 * sizeof(OUTDTYPE);
        uint64_t gradLocalIntTail = gradTensor.GetPhyAddr() + fullExeSize * 5 * sizeof(OUTDTYPE);
        ...
        __VEC_SCOPE__
        {
            ...
            for (uint16_t m = 0; m < static_cast<uint16_t>(srcM); m++) {
                if constexpr (OUTDTYPE_IS_B16) {
                    ...
                    DataCopy<OUTDTYPE, MicroAPI::PostLiteral::POST_MODE_UPDATE>(vregGradDtype3,
                                                                        ((__ubuf__ OUTDTYPE *&)gradLocalInt3), 512);
                    DataCopy<OUTDTYPE, MicroAPI::PostLiteral::POST_MODE_UPDATE>(vregGradDtype4,
