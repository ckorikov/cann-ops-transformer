                                                                                 ...
                                                                                 __gm__ float *out, const bool isFisrt)
{
    ...
    for (uint32_t n_loop_index = 0; n_loop_index < n_loop; n_loop_index++) {
        ...
        WaitFlag<HardEvent::MTE1_MTE2>(static_cast<int32_t>(ping_pong_flag_l1_b_));
        ...
        AscendC::DataCopy(*l1_b_buf_tensor, temp_tensor_bf16[right_offset + n_loop_index * kvHeadNum * 128 * headDim],
                          commonNd2NzParams);
        SetFlag<HardEvent::MTE2_MTE1>(static_cast<int32_t>(ping_pong_flag_l1_b_));
        ...
        for (uint32_t m_loop_index = 0; m_loop_index < m_loop; m_loop_index++) {
            ...
            WaitFlag<HardEvent::MTE1_MTE2>(static_cast<int32_t>(ping_pong_flag_l1_a_ + 2));
            if (!is_skip) {
            ...
            SetFlag<HardEvent::MTE2_MTE1>(static_cast<int32_t>(ping_pong_flag_l1_a_ + 2));
        ...
        WaitFlag<HardEvent::MTE2_MTE1>(static_cast<int32_t>(ping_pong_flag_l1_b_));
        WaitFlag<HardEvent::M_MTE1>(static_cast<int32_t>(ping_pong_flag_l0_b_ + 2 + FLAG_SHIFT));
        ...
        SetFlag<HardEvent::MTE1_M>(static_cast<int32_t>(ping_pong_flag_l0_b_ + 2));
        SetFlag<HardEvent::MTE1_MTE2>(static_cast<int32_t>(ping_pong_flag_l1_b_));

        ping_pong_flag_l1_a_ = 0;
        ping_pong_flag_l0_a_ = 0;
        WaitFlag<HardEvent::MTE1_M>(static_cast<int32_t>(ping_pong_flag_l0_b_ + 2));
        ...
        for (uint32_t m_loop_index = 0; m_loop_index < m_loop; m_loop_index++) {
            ...
            WaitFlag<HardEvent::MTE2_MTE1>(static_cast<int32_t>(ping_pong_flag_l1_a_ + 2));
            WaitFlag<HardEvent::M_MTE1>(static_cast<int32_t>(ping_pong_flag_l0_a_ + FLAG_SHIFT));
            if (!is_skip) {
            ...
            SetFlag<HardEvent::MTE1_M>(static_cast<int32_t>(ping_pong_flag_l0_a_));
            SetFlag<HardEvent::MTE1_MTE2>(static_cast<int32_t>(ping_pong_flag_l1_a_ + 2));
            bool last_k = false;
            last_k = (m_loop_index == 0 && upperRight) ? n_loop_index == n_loop - 2 : n_loop_index == n_loop - 1;

            WaitFlag<HardEvent::MTE1_M>(static_cast<int32_t>(ping_pong_flag_l0_a_));
            if (!is_skip) {
            ...
            SetFlag<HardEvent::M_MTE1>(static_cast<int32_t>(ping_pong_flag_l0_a_ + FLAG_SHIFT));
        ...
        SetFlag<HardEvent::M_MTE1>(static_cast<int32_t>(ping_pong_flag_l0_b_ + 2 + FLAG_SHIFT));
