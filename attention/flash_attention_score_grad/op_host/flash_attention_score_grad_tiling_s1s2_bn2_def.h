...
TILING_DATA_FIELD_DEF(uint32_t, unpadEmptyInput);
...
// L1Custom (bf16 layout mmconfig mmout mm345)
REGISTER_TILING_DATA_CLASS(FlashAttentionScoreGrad_10000001000010022134, FlashAttentionScoreGradTilingDataS1s2Bn2)
REGISTER_TILING_DATA_CLASS(FlashAttentionScoreGrad_10000001000010012134, FlashAttentionScoreGradTilingDataS1s2Bn2)
REGISTER_TILING_DATA_CLASS(FlashAttentionScoreGrad_10000001000010002134, FlashAttentionScoreGradTilingDataS1s2Bn2)

REGISTER_TILING_DATA_CLASS(FlashAttentionScoreGrad_10000001000011022134, FlashAttentionScoreGradTilingDataS1s2Bn2)
REGISTER_TILING_DATA_CLASS(FlashAttentionScoreGrad_10000001000011012134, FlashAttentionScoreGradTilingDataS1s2Bn2)
REGISTER_TILING_DATA_CLASS(FlashAttentionScoreGrad_10000001000011002134, FlashAttentionScoreGradTilingDataS1s2Bn2)

REGISTER_TILING_DATA_CLASS(FlashAttentionScoreGrad_10000001100010022134, FlashAttentionScoreGradTilingDataS1s2Bn2)
REGISTER_TILING_DATA_CLASS(FlashAttentionScoreGrad_10000001100010012134, FlashAttentionScoreGradTilingDataS1s2Bn2)
REGISTER_TILING_DATA_CLASS(FlashAttentionScoreGrad_10000001100010002134, FlashAttentionScoreGradTilingDataS1s2Bn2)

REGISTER_TILING_DATA_CLASS(FlashAttentionScoreGrad_10000001100011022134, FlashAttentionScoreGradTilingDataS1s2Bn2)
REGISTER_TILING_DATA_CLASS(FlashAttentionScoreGrad_10000001100011012134, FlashAttentionScoreGradTilingDataS1s2Bn2)
REGISTER_TILING_DATA_CLASS(FlashAttentionScoreGrad_10000001100011002134, FlashAttentionScoreGradTilingDataS1s2Bn2)
// 占位 fp32
REGISTER_TILING_DATA_CLASS(FlashAttentionScoreGrad_10000001000010021134, FlashAttentionScoreGradTilingDataS1s2Bn2)
} // namespace optiling