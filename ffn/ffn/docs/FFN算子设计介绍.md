...
<img src="../../../docs/figures/FFN计算流程.png" alt="FFN计算流程" style="zoom:75%;" />
...
* dequant scale float32转uint64
  ...
  通过gather的方式将float32数据排放在uint64的低32中，过程如下：<img src="../../../docs/figures/FFN dequant转uint64计算过程.png" alt="FFN dequant转uint64计算过程" style="zoom:67%;" />
...
![FFN量化场景vector计算过程](../../../docs/figures/FFN量化场景vector计算过程.png)
...
* 单核切分
  ...
  6. 往AiCore中搬运时，连续数据尽可能为128倍数，且越接近512越好（与产品版本有关）；
...
* 专家并行分核
  ...
  <img src="../../../docs/figures/FFN专家并行示意图.png" alt="FFN专家并行示意图" style="zoom:67%;" />
...
![FFN量化场景UB buffer分配](../../../docs/figures/FFN量化场景UB_buffer分配.png)
...
<img src="../../../docs/figures/FFN伪量化场景流水并发.png" alt="FFN伪量化场景流水并发" style="zoom:67%;" />
