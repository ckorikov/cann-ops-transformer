...
class OpOnnxPluginUtEnvironment : public testing::Environment {
public:
    OpOnnxPluginUtEnvironment(char** argv) : argv_(argv)
    {}
    virtual void SetUp()
    {
...
int main(int argc, char** argv)
{
    ...
    testing::AddGlobalTestEnvironment(new OpOnnxPluginUtEnvironment(argv));
