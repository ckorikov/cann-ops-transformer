...
#define KERNEL_FUNC_NAME groupedmatmul_kernel
 ...
 __gm__ uint64_t g_tilingKey = 0;
// 声明核函数（无模板，通过宏确定类型）
// extern "C" 
// __global__  __aicore__ void KERNEL_FUNC_NAME(__gm__ uint8_t *x, __gm__ uint8_t *weight, __gm__ uint8_t *bias,
//                                                        __gm__ uint8_t *scale, __gm__ uint8_t *offset,
//                                                        __gm__ uint8_t *antiquantScale, __gm__ uint8_t *antiquantOffset,
//                                                        __gm__ uint8_t *groupList, __gm__ uint8_t *perTokenScale,
//                                                        __gm__ uint8_t *y,  __gm__ uint8_t *workspace, const GroupedMatmulTilingData tilingData)
// {
