...
if (MC2_OP_DIR_LIST AND EXISTS ${CMAKE_CURRENT_SOURCE_DIR}/mc2/common/CMakeLists.txt AND EXISTS ${CMAKE_CURRENT_SOURCE_DIR}/mc2/3rd/CMakeLists.txt)
        list(APPEND MC2_OP_DIR_LIST ${CMAKE_CURRENT_SOURCE_DIR}/mc2/common)
        list(APPEND MC2_OP_DIR_LIST ${CMAKE_CURRENT_SOURCE_DIR}/mc2/3rd)
        list(REMOVE_DUPLICATES MC2_OP_DIR_LIST)
endif()
...
foreach (OP_DEPEND_DIR ${OP_DEPEND_DIR_LIST})
    if (EXISTS "${OP_DEPEND_DIR}/ophost")
...
if (NOT ENABLE_BUILT_IN AND BUILD_OPEN_PROJECT)
    ...
    set(CPACK_PACKAGE_FILE_NAME "cann-ops-transformer-${VENDOR_NAME}-linux.${ARCH}.run")
