...
if(UT_TEST_ALL OR OP_HOST_UT)
    set(OP_TILING_MODULE_NAME ${PKG_NAME}_op_tiling_ut CACHE STRING "op_tiling ut module name" FORCE)
    set(OP_INFERSHAPE_MODULE_NAME ${PKG_NAME}_op_infershape_ut CACHE STRING "op_infershape ut module name" FORCE)
    ...
    function(add_infershape_ut_modules OP_INFERSHAPE_MODULE_NAME)
        ...
        target_link_libraries(${OP_INFERSHAPE_MODULE_NAME}_cases PRIVATE
...
if(UT_TEST_ALL OR OP_API_UT)
    set(OP_API_MODULE_NAME ${PKG_NAME}_op_api_ut CACHE STRING "op_api ut module name" FORCE)
...
if(UT_TEST_ALL OR OP_KERNEL_UT)
    set(OP_KERNEL_MODULE_NAME ${PKG_NAME}_op_kernel_ut CACHE STRING "op_kernel ut module name" FORCE)
    ...
    function(AddOpTestCase opName supportedSocVersion otherCompileOptions tilingSrcFiles)
        ...
        foreach(oriSocVersion ${supportedSocVersion})
            ...
            add_library(${opName}_${socVersion}_tiling_tmp SHARED
                    ${tilingSrc}
                    $<TARGET_OBJECTS:${COMMON_NAME}_obj>
                    )
