...
TEST_F(l2_GroupedMatmulFinalizeRoutingWeightNzV2_test, ascend910B2_test_normal_case_x2_null)
{
    int64_t m = 192;
    int64_t k = 2048;
    int64_t n = 7168;
    ...
    aclIntArray* tuningConfig = aclCreateIntArray(tuningConfigVal.data(), tuningConfigVal.size());
    auto ut = OP_API_UT(aclnnGroupedMatmulFinalizeRoutingWeightNzV2,
                        INPUT(x1_desc, nullptr, scale_desc, nullptr, nullptr, nullptr, nullptr, perTokenScale_desc,
                              groupList_desc, shared_input_desc, logits_desc, row_index_desc, 0, 1.0, 0, false, false,
                              1, tuningConfig),
                        OUTPUT(out_desc));
    uint64_t workspace_size = 0;
