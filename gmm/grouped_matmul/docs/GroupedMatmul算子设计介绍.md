...
![GroupedMatmul量化场景流程图](../../../docs/figures/GMM量化场景流程图.png)
...
![GroupedMatmul量化场景UB_buffer分配](../../../docs/figures/GMM量化场景UB_Buffer分配.png)
...
![基本块分核](../../../docs/figures/GMM横向分核方案.png)
...
![对角线分核](../../../docs/figures/GMM对角线分核方案.png)
...
![对角线分组](../../../docs/figures/GMM对角线分组方案.png)
