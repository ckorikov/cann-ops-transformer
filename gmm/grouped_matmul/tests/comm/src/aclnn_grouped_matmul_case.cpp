...
bool GroupedMatmulTilingRunCbf(void *curCase, uint64_t *workSpaceSize, aclOpExecutor **opExecutor)
{
    ...
    if (aclnnParam->mAclnnGroupedMatmulVersion == AclnnGroupedMatmulVersion::V1) {
    ...
    } else if (aclnnParam->mAclnnGroupedMatmulVersion == AclnnGroupedMatmulVersion::V5) {
        ret = aclnnGroupedMatmulV5GetWorkspaceSize(
            ...
            aclnnParam->aclnnGroupListTensor.GetAclTensor(), nullptr, nullptr, nullptr,
            aclnnParam->mSplitItem, aclnnParam->mGroupType, aclnnParam->mGroupListType, aclnnParam->mActType,
            aclnnParam->aclnnTuningConfigIntAry,
            aclnnParam->aclnnY.GetAclTensorList(), nullptr, nullptr, workSpaceSize, opExecutor);
    } else if (aclnnParam->mAclnnGroupedMatmulVersion == AclnnGroupedMatmulVersion::WeightNz) {
        ret = aclnnGroupedMatmulWeightNzGetWorkspaceSize(
            ...
            aclnnParam->aclnnGroupListTensor.GetAclTensor(), nullptr, nullptr, nullptr,
            aclnnParam->mSplitItem, aclnnParam->mGroupType, aclnnParam->mGroupListType, aclnnParam->mActType,
            aclnnParam->aclnnTuningConfigIntAry, (int64_t)0,
            aclnnParam->aclnnY.GetAclTensorList(), nullptr, nullptr, workSpaceSize, opExecutor);
    }
...
bool GroupedMatmulKernelRunCbf(void *curCase)
{
    ...
    if (aclnnParam->mAclnnGroupedMatmulVersion == AclnnGroupedMatmulVersion::V1) {
        ...
        ret = aclnnGroupedMatmulV5(aclnnCtx->GetWorkspacePtr(), aclnnCtx->GetWorkspaceSize(), aclnnCtx->GetAclOpExecutor(),
                                   aclnnCtx->GetAclRtStream());
    } else if (aclnnParam->mAclnnGroupedMatmulVersion == AclnnGroupedMatmulVersion::WeightNz) {
        ret = aclnnGroupedMatmulWeightNz(aclnnCtx->GetWorkspacePtr(), aclnnCtx->GetWorkspaceSize(), aclnnCtx->GetAclOpExecutor(),
                                   aclnnCtx->GetAclRtStream());
    }
