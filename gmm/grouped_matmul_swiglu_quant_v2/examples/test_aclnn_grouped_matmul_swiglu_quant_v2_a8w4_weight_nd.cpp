...
int main() {
    ...
    std::vector<std::vector<int64_t>> weightShape = {{E, K, N / 8}};
    ...
    ret = CreateAclTensorList(weightHostData, weightShape, weightDeviceAddr, aclDataType::ACL_INT32, aclFormat::ACL_FORMAT_ND, &weight);
    CHECK_RET(ret == ACL_SUCCESS, return ret);
