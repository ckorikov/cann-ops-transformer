 ...
 *
 * @param [in] x: 表示公式中的x，数据类型支持INT8、FLOAT4_E1M2、FLOAT4_E2M1、FLOAT8_E4M3FN、FLOAT8_E5M2数据类型，数据格式支持ND。
 * @param [in] weight:
 * 表示公式中的weight，数据类型支持INT4、FLOAT4_E1M2、FLOAT4_E2M1、FLOAT8_E4M3FN、FLOAT8_E5M2数据类型，数据格式支持ND。
 * @param [in] weightScale:
 * 表示量化参数，数据类型支持UINT64、FLOAT32、FLOAT8_E8M0数据类型，数据格式支持ND。 
