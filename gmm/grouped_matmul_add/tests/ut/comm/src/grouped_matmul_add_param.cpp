...
/*!
 * \file grouped_matmul_add_param.cpp
...
Param::Param(std::vector<TensorList> inputs, Tensor groupList, std::vector<int64_t> groupListData, bool transposeX,
          bool transposeWeight, int32_t groupType, int32_t groupListType)
    : mGroupListData(std::move(groupListData)), mTransposeX(transposeX), mTransposeWeight(transposeWeight),
      mGroupType(groupType), mGroupListType(groupListType)
{
