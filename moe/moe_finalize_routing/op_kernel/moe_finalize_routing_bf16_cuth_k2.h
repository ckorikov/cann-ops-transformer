...
/*!
 * \file moe_finalize_routing_bf16_cuth_k2.h
 * \brief
 */
#ifndef MOE_FINALIZE_ROUTING_BF16_CUTH_K_TWO
#define MOE_FINALIZE_ROUTING_BF16_CUTH_K_TWO
...
template <typename T>
class MoeFinalizeRoutingBf16CuthK2 {
public:
    __aicore__ inline MoeFinalizeRoutingBf16CuthK2(){};
...
template <typename T>
__aicore__ inline int64_t MoeFinalizeRoutingBf16CuthK2<T>::AlignmentProcess(int64_t param)
{
    return (param + onceAlgnNum_ - 1) / onceAlgnNum_ * onceAlgnNum_;
}

template <typename T>
__aicore__ inline int64_t MoeFinalizeRoutingBf16CuthK2<T>::PadProcessT(int64_t param)
{
    return onceAlgnNum_ - param % onceAlgnNum_;
}

template <typename T>
__aicore__ inline void MoeFinalizeRoutingBf16CuthK2<T>::ParseTilingData(const MoeFinalizeRoutingTilingData *tilingData)
{
...
template <typename T>
__aicore__ inline void MoeFinalizeRoutingBf16CuthK2<T>::CkechColAlignment()
{
...
template <typename T>
__aicore__ inline void MoeFinalizeRoutingBf16CuthK2<T>::Init(GM_ADDR expandedPermutedRows, GM_ADDR skip1, GM_ADDR skip2,
...
template <typename T>
__aicore__ inline void MoeFinalizeRoutingBf16CuthK2<T>::CopyIn(int64_t nLoopIdx, int64_t bias, int64_t dataLen,
...
template <typename T>
__aicore__ inline void MoeFinalizeRoutingBf16CuthK2<T>::Compute(int64_t nLoopIdx, int64_t bias, int64_t dataLen,
                                                                bool isPadH, int64_t rightPaddingH)
{
...
template <typename T>
__aicore__ inline void MoeFinalizeRoutingBf16CuthK2<T>::CopyOut(int64_t nLoopIdx, int64_t bias, int64_t dataLen)
{
...
template <typename T>
__aicore__ inline void MoeFinalizeRoutingBf16CuthK2<T>::Process()
{
