...
/*!
 * \file moe_finalize_routing_fp_cuth_k2.h
 * \brief
 */
#ifndef MOE_FINALIZE_ROUTING_FP_CUTH_K_TWO
#define MOE_FINALIZE_ROUTING_FP_CUTH_K_TWO
...
template <typename T>
class MoeFinalizeRoutingFpCuthK2 {
public:
    __aicore__ inline MoeFinalizeRoutingFpCuthK2(){};
...
template <typename T>
__aicore__ inline int64_t MoeFinalizeRoutingFpCuthK2<T>::AlignmentProcess(int64_t param)
{
    return (param + onceAlgnNum_ - 1) / onceAlgnNum_ * onceAlgnNum_;
}

template <typename T>
__aicore__ inline int64_t MoeFinalizeRoutingFpCuthK2<T>::PadProcessT(int64_t param)
{
    return onceAlgnNum_ - param % onceAlgnNum_;
}

template <typename T>
__aicore__ inline void MoeFinalizeRoutingFpCuthK2<T>::ParseTilingData(const MoeFinalizeRoutingTilingData *tilingData)
{
...
template <typename T>
__aicore__ inline void MoeFinalizeRoutingFpCuthK2<T>::CkechColAlignment()
{
...
template <typename T>
__aicore__ inline void MoeFinalizeRoutingFpCuthK2<T>::Init(GM_ADDR expandedPermutedRows, GM_ADDR skip1, GM_ADDR skip2,
...
template <typename T>
__aicore__ inline void MoeFinalizeRoutingFpCuthK2<T>::CopyIn(int64_t nLoopIdx, int64_t bias, int64_t dataLen,
...
template <typename T>
__aicore__ inline void MoeFinalizeRoutingFpCuthK2<T>::Compute(int64_t nLoopIdx, int64_t bias, int64_t dataLen,
                                                              bool isPadH, int64_t rightPaddingH)
{
...
template <typename T>
__aicore__ inline void MoeFinalizeRoutingFpCuthK2<T>::CopyOut(int64_t nLoopIdx, int64_t bias, int64_t dataLen)
{
...
template <typename T>
__aicore__ inline void MoeFinalizeRoutingFpCuthK2<T>::Process()
{
...
#endif // MOE_FINALIZE_ROUTING_FP_CUTH_K_TWO
