...
#include "transformer/moe_gating_top_k_softmax/op_host/moe_gating_top_k_softmax_tiling.h"
...
TEST_F(MoeGatingTopKSoftmaxTiling, moe_gating_top_k_softmax_tiling_001)
{
    ...
    platform_info.Init();
    // compile info
    optiling::MoeGatingTopKSoftmaxCompileInfo compile_info;

    std::string op_type("MoeGatingTopKSoftmax");
    ...
    auto holder = gert::TilingContextFaker()
                      .SetOpType("MoeGatingTopKSoftmax")
                      .NodeIoNum(1, 3)
                      .IrInstanceNum({1})
...
TEST_F(MoeGatingTopKSoftmaxTiling, moe_gating_top_k_softmax_tiling_009)
{
    ...
    auto holder = gert::TilingContextFaker()
                      ...
                      .IrInstanceNum({1})
                      .InputShapes({&input_shape})
                      .OutputShapes({&out_shape, &out_shape_1, &out_shape})
                      .CompileInfo(&compile_info)
                      .PlatformInfo(reinterpret_cast<char*>(&platform_info))
                      .NodeAttrs({{"k", ge::AnyValue::CreateFrom<int64_t>(5000)}})
                      .NodeInputTd(0, ge::DT_FLOAT, ge::FORMAT_ND, ge::FORMAT_ND)
...
{
    dlog_setlevel(0, 0, 0);
    gert::StorageShape input_shape = {{1, 256, 8}, {1, 256, 8}};
    ...
    auto holder = gert::TilingContextFaker()
                      ...
                      .CompileInfo(&compile_info)
                      .PlatformInfo(reinterpret_cast<char*>(&platform_info))
                      .NodeAttrs({{"k", ge::AnyValue::CreateFrom<int64_t>(4)}})
                      .NodeInputTd(0, ge::DT_FLOAT, ge::FORMAT_ND, ge::FORMAT_ND)
                      .NodeOutputTd(0, ge::DT_FLOAT, ge::FORMAT_ND, ge::FORMAT_ND)
                      .NodeOutputTd(1, ge::DT_INT32, ge::FORMAT_ND, ge::FORMAT_ND)
                      .NodeOutputTd(2, ge::DT_INT32, ge::FORMAT_ND, ge::FORMAT_ND)
...
{
    dlog_setlevel(0, 0, 0);
    gert::StorageShape input_shape = {{1, 256, 256}, {1, 256, 256}};
    gert::StorageShape out_shape = {{1, 256, 256}, {1, 256, 256}};
