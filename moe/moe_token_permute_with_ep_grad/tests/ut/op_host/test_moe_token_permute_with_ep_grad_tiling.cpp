...
#include "transformer/moe_token_permute_with_ep_grad/op_host/moe_token_permute_with_ep_grad_tiling.h"
...
TEST_F(MoeTokenPermuteWithEpGradTiling, test_tiling_bf16) {
  ...
  std::string op_type("MoeTokenPermuteWithEpGrad");
  ...
  auto holder = gert::TilingContextFaker()
                    ...
                    .NodeIoNum(3, 2)
                    .IrInstanceNum({1, 1, 1})
                    .InputShapes({&permuted_token_output_d_shape, &sorted_indices_shape, &permuted_probs_output_d_shape})
                    .OutputShapes({&input_token_grad_shape, &input_probs_grad_shape})
