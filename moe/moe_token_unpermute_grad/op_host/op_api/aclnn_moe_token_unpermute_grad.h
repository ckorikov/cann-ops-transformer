...
/*!
 * \file aclnn_moe_token_unpermute_grad.h
 * \brief
 */
#ifndef OP_API_INC_MOE_TOKEN_UNPERMUTE_GRAD_H_
#define OP_API_INC_MOE_TOKEN_UNPERMUTE_GRAD_H_
...
/**
 * @brief aclnnMoeTokenUnpermuteGrad的第一段接口，根据具体的计算流程，计算workspace大小。
...
aclnnMoeTokenUnpermuteGrad(void* workspace, uint64_t workspaceSize, aclOpExecutor* executor, aclrtStream stream);
