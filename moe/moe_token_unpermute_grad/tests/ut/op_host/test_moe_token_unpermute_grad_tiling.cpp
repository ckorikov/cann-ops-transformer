...
#include "transformer/moe_token_unpermute_grad/op_host/moe_token_unpermute_grad_tiling.h"
...
TEST_F(MoeTokenUnpermuteGradTiling, test_tiling_prob_not_none_bf16_001)
{
    ...
    MoeTokenUnpermuteGradCompileInfo compile_info;

    std::string op_type("MoeTokenUnpermuteGrad");
...
TEST_F(MoeTokenUnpermuteGradTiling, test_tiling_prob_none_bf16_001)
{
    ...
    auto holder = gert::TilingContextFaker()
                      ...
                      .NodeIoNum(3, 2)
                      .IrInstanceNum({1, 1, 1})
                      .InputShapes({&permuted_tokens_shape, &unpermuted_output_d_shape, &sorted_indices_shape})
                      .OutputShapes({&permuted_tokens_grad_shape, &probs_grad_shape})
                      .CompileInfo(&compile_info)
                      .PlatformInfo(reinterpret_cast<char*>(&platform_info))
                      .NodeInputTd(0, ge::DT_BF16, ge::FORMAT_ND, ge::FORMAT_ND)
