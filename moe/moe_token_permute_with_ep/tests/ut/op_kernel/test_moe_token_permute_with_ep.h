...
inline void InitMoeTokenPermuteWithEpTilingData(uint8_t* tiling, MoeTokenPermuteWithEpTilingData* const_data)
{
    memcpy(const_data, tiling, sizeof(MoeTokenPermuteWithEpTilingData));
}

#define GET_TILING_DATA(tilingData, tilingPointer) \
    MoeTokenPermuteWithEpTilingData tilingData;    \
    InitMoeTokenPermuteWithEpTilingData(tilingPointer, &tilingData)
#endif