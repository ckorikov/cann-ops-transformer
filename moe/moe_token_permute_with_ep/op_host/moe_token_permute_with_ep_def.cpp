...
/*!
 * \file moe_token_permute_with_ep_def.cpp
 * \brief
 */
#include "register/op_def_registry.h"

namespace ops {
class MoeTokenPermuteWithEp : public OpDef
{
public:
    explicit MoeTokenPermuteWithEp(const char* name) : OpDef(name)
    {
        this->Input("tokens")
            .ParamType(REQUIRED)
