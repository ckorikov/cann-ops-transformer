...
/*!
 * \file moe_init_routing_v2_grad_with_dropless.h
 * \brief
 */
#ifndef MOE_INIT_ROUTING_V2_GRAD_DROPLESS_COMPUTE_H
#define MOE_INIT_ROUTING_V2_GRAD_DROPLESS_COMPUTE_H
...
template <typename T>
__aicore__ inline void MoeInitRoutingV2GradDroplessCompute<T>::GradProcessTokenAccumulate(
    int64_t tokenIdxStart, int64_t tokenIdxEnd, int64_t tokenBinBuffSizeOffset, int64_t tokenTmpBuffSizeOffset,
    int64_t colOffset, int64_t cpyCols)
{
...
template <typename T>
__aicore__ inline void MoeInitRoutingV2GradDroplessCompute<T>::Process()
{
...
#endif // MOE_INIT_ROUTING_V2_GRAD_DROPLESS_COMPUTE_H
