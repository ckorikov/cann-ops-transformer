...
/*!
 * \file moe_token_unpermute_with_routing_map_not_pad.h
 * \brief
 */

#ifndef MOE_TOKEN_UNPERMUTE_WITH_ROUTING_MAP_NOT_PAD
#define MOE_TOKEN_UNPERMUTE_WITH_ROUTING_MAP_NOT_PAD

#include "kernel_operator.h"
using namespace AscendC;
namespace MoeTokenUnpermuteWithRoutingMap {
template <typename T1, typename T2, typename T3, bool PROBS>
class KernelMoeTokenUnpermuteWithRoutingMap {
public:
  __aicore__ inline KernelMoeTokenUnpermuteWithRoutingMap() {}

  __aicore__ inline void Init(GM_ADDR permuted_tokens, GM_ADDR sorted_indices, GM_ADDR probs, GM_ADDR unpermuted_tokens,
                              const MoeTokenUnpermuteWithRoutingMapTilingData* __restrict tiling_data);
 ...
 protected:
  ...
  __aicore__ inline void CalPartOutToken(const int64_t start_token, const int64_t h_index, const int64_t h_length, const int64_t out_token_index);
...
template <typename T1, typename T2, typename T3, bool PROBS>
__aicore__ inline void KernelMoeTokenUnpermuteWithRoutingMap<T1, T2, T3, PROBS>::Init(
  ...
  //core
  this->usedCoreNum = tiling_data->used_core_num;
...
template <typename T1, typename T2, typename T3, bool PROBS>
__aicore__ inline void KernelMoeTokenUnpermuteWithRoutingMap<T1, T2, T3, PROBS>::Process() {
  if (GetBlockIdx() < this->usedCoreNum){
...
template <typename T1, typename T2, typename T3, bool PROBS>
__aicore__ inline void KernelMoeTokenUnpermuteWithRoutingMap<T1, T2, T3, PROBS>::CalMultiOutToken(const int64_t out_offset, 
...
template <typename T1, typename T2, typename T3, bool PROBS>
__aicore__ inline void KernelMoeTokenUnpermuteWithRoutingMap<T1, T2, T3, PROBS>::CalSingleOutToken(const int64_t start_token, 
...
template <typename T1, typename T2, typename T3, bool PROBS>
__aicore__ inline void KernelMoeTokenUnpermuteWithRoutingMap<T1, T2, T3, PROBS>::CopyTokenIn(const T2 in_token_index,
                                                                               const int64_t h_index,
                                                                               const int64_t h_length) {
...
template <typename T1, typename T2, typename T3, bool PROBS>
__aicore__ inline void KernelMoeTokenUnpermuteWithRoutingMap<T1, T2, T3, PROBS>::CalFirstToken(const float prob_value,
                                                                                 const int64_t h_length) {
...
template <typename T1, typename T2, typename T3, bool PROBS>
__aicore__ inline void KernelMoeTokenUnpermuteWithRoutingMap<T1, T2, T3, PROBS>::CalToken(const float prob_value,
                                                                            const int64_t h_length) {
  LocalTensor<T1> tokensLocal = this->tokens_inque.template DeQue<T1>();
...
template <typename T1, typename T2, typename T3, bool PROBS>
__aicore__ inline void KernelMoeTokenUnpermuteWithRoutingMap<T1, T2, T3, PROBS>::CopyOut(const int64_t out_token_index,
                                                                           const int64_t h_index,
                                                                           const int64_t h_length) {
...
#endif  // MOE_TOKEN_UNPERMUTE_WITH_ROUTING_MAP_NOT_PAD
