 ...
 * \brief
 */
#ifndef OPS_OP_PROTO_INC_MOE_INIT_ROUTING_V2_H_
#define OPS_OP_PROTO_INC_MOE_INIT_ROUTING_V2_H_
...
namespace ge {
   ...
   *                 it can be (num_row, ) in Ascend 910_95 AI Processor.
   ...
   *                 0. Type is:Int32 or Int64, Int64 only support in Ascend 910_95 AI Processor. Format support ND.
   * @par Outputs:
