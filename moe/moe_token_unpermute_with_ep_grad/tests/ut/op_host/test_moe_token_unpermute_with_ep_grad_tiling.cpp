...
#include "transformer/moe_token_unpermute_with_ep_grad/op_host/moe_token_unpermute_with_ep_grad_tiling.h"
...
TEST_F(MoeTokenUnpermuteWithEpGradTiling, test_tiling_prob_not_none_bf16_001)
{
    ...
    MoeTokenUnpermuteWithEpGradCompileInfo compile_info;

    std::string op_type("MoeTokenUnpermuteWithEpGrad");
...
TEST_F(MoeTokenUnpermuteWithEpGradTiling, test_tiling_prob_none_bf16_001)
{
    ...
    auto holder = gert::TilingContextFaker()
                      ...
                      .NodeIoNum(3, 2)
                      .IrInstanceNum({1, 1, 1})
                      .InputShapes({&unpermuted_output_d_shape, &sorted_indices_shape, &permuted_tokens_shape})
                      .OutputShapes({&permuted_tokens_grad_shape, &probs_grad_shape})
                      .CompileInfo(&compile_info)
                      .PlatformInfo(reinterpret_cast<char*>(&platform_info))
                      .NodeInputTd(0, ge::DT_BF16, ge::FORMAT_ND, ge::FORMAT_ND)
                      ...
                      .NodeAttrs(
                          {{"padded_mode", ge::AnyValue::CreateFrom<bool>(false)},
                           {"topk_num", ge::AnyValue::CreateFrom<int64_t>(3)}})
                      .TilingData(param.get())
                      .Workspace(ws_size)
                      .Build();
    gert::TilingContext* tiling_context = holder.GetContext<gert::TilingContext>();
