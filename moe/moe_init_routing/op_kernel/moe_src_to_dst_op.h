 ...
 * \brief
 */
#ifndef MOE_SRC_TO_DST_H
#define MOE_SRC_TO_DST_H
...
public:
    ...
    __aicore__ inline void Init(
        GM_ADDR expandSrcToDstRow, GM_ADDR workspace, const MoeInitRoutingTilingData* tilingData, TPipe* tPipe);
