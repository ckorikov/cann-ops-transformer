...
#include "transformer/moe_re_routing/op_host/moe_re_routing_tiling.h"
...
TEST_F(MoeReRoutingTiling, moe_re_routing_tiling_000)
{
    ...
    platform_info.Init();
    // compile info
    optiling::MoeReRoutingCompileInfo compile_info;

    std::string op_type("MoeReRouting");
    ...
    auto holder = gert::TilingContextFaker()
                      ...
                      .NodeAttrs({{"expert_token_num_type", ge::AnyValue::CreateFrom<int64_t>(1)},
                          {"idx_type", ge::AnyValue::CreateFrom<int64_t>(0)}})
...
{
    dlog_setlevel(0, 0, 0);
    gert::StorageShape tokens_shape = {{1, 7168}, {1, 7168}};
    gert::StorageShape expert_token_num_per_rank_shape = {{16, 16}, {16, 16}};
    gert::StorageShape per_token_scales_shape = {{1}, {1}};
    gert::StorageShape permute_tokens_shape_out = {{1, 7168}, {1, 7168}};
    gert::StorageShape permute_tokens_scales_shape_out = {{1}, {1}};
...
{
    dlog_setlevel(0, 0, 0);
    gert::StorageShape tokens_shape = {{64, 7168}, {64, 7168}};
    gert::StorageShape expert_token_num_per_rank_shape = {{16, 16}, {16, 16}};
    gert::StorageShape per_token_scales_shape = {{64}, {64}};
    gert::StorageShape permute_tokens_shape_out = {{64, 7168}, {64, 7168}};
    gert::StorageShape permute_tokens_scales_shape_out = {{64}, {64}};
    gert::StorageShape permute_token_idx_shape_out = {{64}, {64}};
    gert::StorageShape expert_token_num_shape_out = {{16}, {16}};
...
TEST_F(MoeReRoutingTiling, moe_re_routing_regbase_tiling_000)
{
    ...
    holder.GetContext<gert::TilingContext>()->GetPlatformInfo()->SetCoreNumByCoreType("AICore");
    holder.GetContext<gert::TilingContext>()->GetPlatformInfo()->SetPlatformRes("AICoreintrinsicDtypeMap", intrinsics);
    holder.GetContext<gert::TilingContext>()->GetPlatformInfo()->SetPlatformRes("version", short_soc_version);

    // workspaces nullptr return failed
    EXPECT_EQ(tiling_func(tiling_context), ge::GRAPH_SUCCESS);
    auto tiling_key = tiling_context->GetTilingKey();
    ASSERT_EQ(tiling_key, 210100);
    auto block_dim = tiling_context->GetBlockDim();
    ASSERT_EQ(block_dim, 16);
    dlog_setlevel(static_cast<int>(OP), 0, 1);
}
...
TEST_F(MoeReRoutingTiling, moe_re_routing_regbase_tiling_001)
{
    dlog_setlevel(0, 0, 0);
    gert::StorageShape tokens_shape = {{64, 7168}, {64, 7168}};
    gert::StorageShape expert_token_num_per_rank_shape = {{4, 4}, {4, 4}};
    gert::StorageShape per_token_scales_shape = {{64}, {64}};
    gert::StorageShape permute_tokens_shape_out = {{64, 7168}, {64, 7168}};
    gert::StorageShape permute_tokens_scales_shape_out = {{64}, {64}};
    gert::StorageShape permute_token_idx_shape_out = {{64}, {64}};
    gert::StorageShape expert_token_num_shape_out = {{4}, {4}};
    ...
    auto holder = gert::TilingContextFaker()
                      ...
                      .NodeIoNum(3, 4)
                      .IrInstanceNum({1, 1, 1})
                      .InputShapes({&tokens_shape, &expert_token_num_per_rank_shape, nullptr})
                      .OutputShapes({&permute_tokens_shape_out,
                          &permute_tokens_scales_shape_out,
                          &permute_token_idx_shape_out,
                          &expert_token_num_shape_out})
...
TEST_F(MoeReRoutingTiling, moe_re_routing_regbase_tiling_003)
{
    dlog_setlevel(0, 0, 0);
    gert::StorageShape tokens_shape = {{64, 7168}, {64, 7168}};
    gert::StorageShape expert_token_num_per_rank_shape = {{4, 2}, {4, 2}};
    gert::StorageShape per_token_scales_shape = {{64}, {64}};
    gert::StorageShape permute_tokens_shape_out = {{64, 7168}, {64, 7168}};
    gert::StorageShape permute_tokens_scales_shape_out = {{64}, {64}};
    gert::StorageShape permute_token_idx_shape_out = {{64}, {64}};
