...
public:
    ...
    __aicore__ inline void Init(GM_ADDR expertIdx, GM_ADDR expandedRowIdx,
                                GM_ADDR expertTokensCountOrCumsum, GM_ADDR workspace, const MoeInitRoutingV3TilingData *tilingData, TPipe *tPipe);
...
template <typename T>
__aicore__ inline void MoeV3FullLoadBase<T>::Compute()
{
    if (epFullload_) {
...
template <typename T>
__aicore__ inline void MoeV3FullLoadBase<T>::SortComputeWithRange()
{
...
template <typename T>
__aicore__ inline void MoeV3FullLoadBase<T>::CopyOutIdx()
{
...
template <typename T>
__aicore__ inline void MoeV3FullLoadBase<T>::ComputeExpertTokenCountOrCumsum()
{
    // compute
    LocalTensor<int32_t> expandedExpertIdx = expandedExpertIdxCopyOutQueue_.DeQue<int32_t>();
...
template <typename T>
__aicore__ inline void MoeV3FullLoadBase<T>::TilingInKernel()
{
