...
/*!
 * \file moe_v3_sort_multi_core.h
 * \brief
 */
#ifndef MOE_V3_VBS_ONE_CORE_H_REGBASE
#define MOE_V3_VBS_ONE_CORE_H_REGBASE
                                              ...
                                              const MoeInitRoutingV3TilingData *tilingData, TPipe *tPipe)
{
    ...
    if (rowIdxType_ == SCATTER) {
        ...
        expandedRowIdxGm.SetGlobalBuffer((__gm__ int32_t *)workspace + Align(this->totalLength, sizeof(int32_t)),
                                         Align(this->totalLength, sizeof(int32_t)));
    }
...
#endif // MOE_V3_VBS_ONE_CORE_H_REGBASE