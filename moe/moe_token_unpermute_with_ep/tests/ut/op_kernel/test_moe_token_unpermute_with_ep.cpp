...
/*!
 * \file test_moe_token_unpermute_with_ep.cpp
 * \brief
 */
#include <array>
#include <vector>
...
class moe_token_unpermute_with_ep_test : public testing::Test
{
protected:
    static void SetUpTestCase()
    {
        cout << "moe_token_unpermute_with_ep_test SetUp\n" << endl;
    }
    static void TearDownTestCase()
    {
        cout << "moe_token_unpermute_with_ep_test TearDown\n" << endl;
    }
};

TEST_F(moe_token_unpermute_with_ep_test, test_prob_none_bf16)
{
    ...
    ICPU_RUN_KF(
        moe_token_unpermute_with_ep, blockDim, permuted_tokens, sorted_indices, nullptr, unpermuted_tokens, workspace,
...
TEST_F(moe_token_unpermute_with_ep_test, test_bf16)
{
    ...
    ICPU_RUN_KF(
        moe_token_unpermute_with_ep, blockDim, permuted_tokens, sorted_indices, probs, unpermuted_tokens, workspace,
        (uint8_t*)tilingDatafromBin);
...
TEST_F(moe_token_unpermute_with_ep_test, test_prob_none_fp16)
{
...
TEST_F(moe_token_unpermute_with_ep_test, test_fp16)
{
...
TEST_F(moe_token_unpermute_with_ep_test, test_prob_none_fp32)
{
...
TEST_F(moe_token_unpermute_with_ep_test, test_fp32)
{
    size_t permutedTokensByteSize = 32 * 8 * 5120 * sizeof(float);
    size_t sortedIndicesByteSize = 32 * 8 * sizeof(int32_t);
...
TEST_F(moe_token_unpermute_with_ep_test, test_mix_bf16_fp16)
{
...
TEST_F(moe_token_unpermute_with_ep_test, test_mix_bf16_fp32)
{
    size_t permutedTokensByteSize = 32 * 8 * 5120 * sizeof(bfloat16_t);
    size_t sortedIndicesByteSize = 32 * 8 * sizeof(int32_t);
    size_t probsByteSize = 32 * 8 * sizeof(float);
...
TEST_F(moe_token_unpermute_with_ep_test, test_mix_fp16_bf16)
{
...
TEST_F(moe_token_unpermute_with_ep_test, test_mix_fp16_fp32)
{
    size_t permutedTokensByteSize = 32 * 8 * 5120 * sizeof(half);
    size_t sortedIndicesByteSize = 32 * 8 * sizeof(int32_t);
    size_t probsByteSize = 32 * 8 * sizeof(float);
...
TEST_F(moe_token_unpermute_with_ep_test, test_mix_fp32_bf16)
{
    size_t permutedTokensByteSize = 32 * 8 * 5120 * sizeof(float);
    size_t sortedIndicesByteSize = 32 * 8 * sizeof(int32_t);
    size_t probsByteSize = 32 * 8 * sizeof(bfloat16_t);
...
TEST_F(moe_token_unpermute_with_ep_test, test_mix_fp32_fp16)
{
    size_t permutedTokensByteSize = 32 * 8 * 5120 * sizeof(float);
    size_t sortedIndicesByteSize = 32 * 8 * sizeof(int32_t);
    size_t probsByteSize = 32 * 8 * sizeof(half);
