...
TEST_F(MoeTokenUnpermuteWithEp, test_infershape_bf16)
{
    ...
    auto infer_shape_func = gert::OpImplRegistry::GetInstance().GetOpImpl("MoeTokenUnpermuteWithEp")->infer_shape;
...
{
    ASSERT_NE(gert::OpImplRegistry::GetInstance().GetOpImpl("MoeTokenUnpermuteWithEp"), nullptr);
    auto data_type_func = gert::OpImplRegistry::GetInstance().GetOpImpl("MoeTokenUnpermuteWithEp")->infer_datatype;
