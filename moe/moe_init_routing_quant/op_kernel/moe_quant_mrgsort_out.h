...
/*!
 * \file moe_quant_mrgsort_out.h
 * \brief
 */
#ifndef MOE_QUANT_MRGSORT_OUT_H
#define MOE_QUANT_MRGSORT_OUT_H
...
__aicore__ inline void MoeMrgsortOut::SetOutput(
    GlobalTensor<int32_t>& gmOutput1, GlobalTensor<int32_t>& gmOutput2, LocalTensor<float>& ubOutput1,
    LocalTensor<float>& ubOutput2)
{
