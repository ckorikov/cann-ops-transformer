...
/* !
 * \file test_moe_init_routing_quant_proto.cpp
 * \brief
 */
...
TEST_F(MoeInitRoutingQuant, moe_init_routing_quant_infer_shape_14)
{
    ...
    std::vector<std::pair<int64_t, int64_t>> shape_range = { { 2, 64 } };
    auto x_tensor_desc =
        create_desc_shape_range({ -1 }, ge::DT_FLOAT16, ge::FORMAT_ND, { 32 }, ge::FORMAT_ND, shape_range);
    auto row_idx_tensor_desc =
        create_desc_shape_range({ -1, -1 }, ge::DT_INT32, ge::FORMAT_ND, { 32 }, ge::FORMAT_ND, shape_range);
    auto expert_idx_tensor_desc =
        create_desc_shape_range({ -1, -1 }, ge::DT_INT32, ge::FORMAT_ND, { 32 }, ge::FORMAT_ND, shape_range);
...
TEST_F(MoeInitRoutingQuant, moe_init_routing_quant_infer_shape_27)
{
    ge::op::MoeInitRoutingQuant op;
    std::vector<std::pair<int64_t, int64_t>> shape_range = { { 2, 64 } };
    auto x_tensor_desc =
...
TEST_F(MoeInitRoutingQuant, moe_init_routing_quant_infer_shape_28)
{
    ge::op::MoeInitRoutingQuant op;
    std::vector<std::pair<int64_t, int64_t>> shape_range = { { 2, 64 } };
    auto x_tensor_desc =
...
TEST_F(MoeInitRoutingQuant, moe_init_routing_quant_infer_shape_29)
{
    ge::op::MoeInitRoutingQuant op;
    std::vector<std::pair<int64_t, int64_t>> shape_range = { { 2, 64 } };
    auto x_tensor_desc =
...
TEST_F(MoeInitRoutingQuant, moe_init_routing_quant_infer_shape_30)
{
    ge::op::MoeInitRoutingQuant op;
    std::vector<std::pair<int64_t, int64_t>> shape_range = { { 2, 64 } };
    auto x_tensor_desc =
...
TEST_F(MoeInitRoutingQuant, moe_init_routing_quant_infer_shape_31)
{
    ge::op::MoeInitRoutingQuant op;
    std::vector<std::pair<int64_t, int64_t>> shape_range = { { 2, 64 } };
    auto x_tensor_desc =
...
TEST_F(MoeInitRoutingQuant, moe_init_routing_quant_infer_shape_32)
{
    ge::op::MoeInitRoutingQuant op;
    std::vector<std::pair<int64_t, int64_t>> shape_range = { { 2, 64 } };
    auto x_tensor_desc =
...
TEST_F(MoeInitRoutingQuant, moe_init_routing_quant_infer_shape_33)
{
    ge::op::MoeInitRoutingQuant op;
    std::vector<std::pair<int64_t, int64_t>> shape_range = { { 2, 64 } };
    auto x_tensor_desc =
...
TEST_F(MoeInitRoutingQuant, moe_init_routing_quant_infer_shape_34)
{
    ge::op::MoeInitRoutingQuant op;
    std::vector<std::pair<int64_t, int64_t>> shape_range = { { 2, 64 } };
    auto x_tensor_desc =
...
TEST_F(MoeInitRoutingQuant, moe_init_routing_quant_infer_shape_35)
{
    ge::op::MoeInitRoutingQuant op;
    std::vector<std::pair<int64_t, int64_t>> shape_range = { { 2, 64 } };
    auto x_tensor_desc =
...
TEST_F(MoeInitRoutingQuant, moe_init_routing_quant_infer_shape_36)
{
    ge::op::MoeInitRoutingQuant op;
    std::vector<std::pair<int64_t, int64_t>> shape_range = { { 2, 64 } };
    auto x_tensor_desc =
        create_desc_shape_range({ -3 }, ge::DT_FLOAT16, ge::FORMAT_ND, { 32 }, ge::FORMAT_ND, shape_range);
    auto row_idx_tensor_desc =
        create_desc_shape_range({ 2, 3 }, ge::DT_INT32, ge::FORMAT_ND, { 32 }, ge::FORMAT_ND, shape_range);
    auto expert_idx_tensor_desc =
        create_desc_shape_range({ 2, 3 }, ge::DT_INT32, ge::FORMAT_ND, { 32 }, ge::FORMAT_ND, shape_range);
...
TEST_F(MoeInitRoutingQuant, moe_init_routing_quant_infer_shape_37)
{
    ge::op::MoeInitRoutingQuant op;
    std::vector<std::pair<int64_t, int64_t>> shape_range = { { 2, 64 } };
    auto x_tensor_desc =
...
TEST_F(MoeInitRoutingQuant, moe_init_routing_quant_infer_shape_38)
{
    ge::op::MoeInitRoutingQuant op;
    std::vector<std::pair<int64_t, int64_t>> shape_range = { { 2, 64 } };
    auto x_tensor_desc =
...
TEST_F(MoeInitRoutingQuant, moe_init_routing_quant_infer_shape_39)
{
    ge::op::MoeInitRoutingQuant op;
    std::vector<std::pair<int64_t, int64_t>> shape_range = { { 2, 64 } };
    auto x_tensor_desc =
...
TEST_F(MoeInitRoutingQuant, moe_init_routing_quant_infer_shape_40)
{
    ge::op::MoeInitRoutingQuant op;
    std::vector<std::pair<int64_t, int64_t>> shape_range = { { 2, 64 } };
    auto x_tensor_desc =
...
TEST_F(MoeInitRoutingQuant, moe_init_routing_quant_infer_shape_41)
{
    ge::op::MoeInitRoutingQuant op;
    std::vector<std::pair<int64_t, int64_t>> shape_range = { { 2, 64 } };
    auto x_tensor_desc =
...
{
    ASSERT_NE(gert::OpImplRegistry::GetInstance().GetOpImpl("MoeInitRoutingQuant"), nullptr);
    auto data_type_func = gert::OpImplRegistry::GetInstance().GetOpImpl("MoeInitRoutingQuant")->infer_datatype;
