...
TEST_F(moe_token_permute_grad_test, test_bf16) {
  system(
      "cp -rf "
      "../../../../../moe/moe_token_permute_grad/tests/ut/op_kernel/moe_token_permute_grad_data ./");
  system("chmod -R 755 ./moe_token_permute_grad_data/");
  // token_num, topk, hiddensize, dtype, flag
  // system("cd ./moe_token_permute_grad_data/ && python3 gen_data.py 6144 8 5120 bfloat16_t True");
