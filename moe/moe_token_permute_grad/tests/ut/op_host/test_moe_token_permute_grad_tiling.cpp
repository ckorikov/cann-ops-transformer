...
#include "transformer/moe_token_permute_grad/op_host/moe_token_permute_grad_tiling.h"
...
TEST_F(MoeTokenPermuteGradTiling, test_tiling_bf16) {
  dlog_setlevel(0, 0, 0);
  gert::StorageShape permuted_output_d_shape = {{49152, 5120}, {49152, 5120}};
  ...
  MoeTokenPermuteGradCompileInfo compile_info;

  std::string op_type("MoeTokenPermuteGrad");
  ...
  auto holder = gert::TilingContextFaker()
                    ...
                    .NodeIoNum(2, 1)
                    .IrInstanceNum({1, 1})
                    .InputShapes({&permuted_output_d_shape, &sorted_indices_shape})
