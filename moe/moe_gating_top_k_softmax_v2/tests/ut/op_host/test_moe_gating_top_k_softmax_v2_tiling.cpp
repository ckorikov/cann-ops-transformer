...
#include "transformer/moe_gating_top_k_softmax_v2/op_host/moe_gating_top_k_softmax_v2_tiling.h"
...
{
    dlog_setlevel(0, 0, 0);
    gert::StorageShape input_shape = {{1, 256, 16}, {1, 256, 16}};
    gert::StorageShape out_shape = {{1, 256, 16}, {1, 256, 16}};
    ...
    platform_info.Init();
    // compile info
    optiling::MoeGatingTopKSoftmaxV2CompileInfo compile_info;

    std::string op_type("MoeGatingTopKSoftmaxV2");
    ...
    auto holder =
        gert::TilingContextFaker()
            .SetOpType("MoeGatingTopKSoftmaxV2")
            .NodeIoNum(1, 3)
            .IrInstanceNum({1})
            .InputShapes({&input_shape})
            .OutputShapes({&out_shape, &out_shape, &input_shape})
            .CompileInfo(&compile_info)
            .PlatformInfo(reinterpret_cast<char*>(&platform_info))
            .NodeAttrs({{"k", ge::AnyValue::CreateFrom<int64_t>(16)}, {"renorm", ge::AnyValue::CreateFrom<int64_t>(1)}})
...
TEST_F(MoeGatingTopKSoftmaxV2Tiling, moe_gating_top_k_softmax_v2_tiling_002)
{
    ...
    auto holder = gert::TilingContextFaker()
                      ...
                      .CompileInfo(&compile_info)
                      .PlatformInfo(reinterpret_cast<char*>(&platform_info))
                      .NodeAttrs({{"k", ge::AnyValue::CreateFrom<int64_t>(16)}})
...
{
    dlog_setlevel(0, 0, 0);
    gert::StorageShape input_shape = {{1, 24, 7500}, {1, 24, 7500}};
    gert::StorageShape out_shape = {{1, 24, 16}, {1, 24, 16}};
...
TEST_F(MoeGatingTopKSoftmaxV2Tiling, moe_gating_top_k_softmax_v2_tiling_004)
{
    dlog_setlevel(0, 0, 0);
    gert::StorageShape input_shape = {{1, 256, 16}, {1, 256, 16}};
    gert::StorageShape out_shape = {{1, 256, 8}, {1, 256, 8}};
    ...
    auto holder = gert::TilingContextFaker()
                      ...
                      .CompileInfo(&compile_info)
                      .PlatformInfo(reinterpret_cast<char*>(&platform_info))
                      .NodeAttrs({{"k", ge::AnyValue::CreateFrom<int64_t>(8)}})
                      .NodeInputTd(0, ge::DT_FLOAT, ge::FORMAT_ND, ge::FORMAT_ND)
                      .NodeOutputTd(0, ge::DT_FLOAT, ge::FORMAT_ND, ge::FORMAT_ND)
                      .NodeOutputTd(1, ge::DT_INT32, ge::FORMAT_ND, ge::FORMAT_ND)
                      .NodeOutputTd(2, ge::DT_FLOAT, ge::FORMAT_ND, ge::FORMAT_ND)
    ...
    // workspaces nullptr return failed
    auto tilingTemplateRegistryMap = optiling::TilingRegistry::GetInstance().GetTilingTemplates(op_type);
    auto tilingTemplate = tilingTemplateRegistryMap[1000](tiling_context);
    EXPECT_EQ(tilingTemplate->DoTiling(), ge::GRAPH_SUCCESS);
    auto tiling_key = tiling_context->GetTilingKey();
    ASSERT_EQ(tiling_key, 103012);
    dlog_setlevel(static_cast<int>(OP), 0, 1);
}
...
TEST_F(MoeGatingTopKSoftmaxV2Tiling, moe_gating_top_k_softmax_v2_tiling_006)
{
    dlog_setlevel(0, 0, 0);
    gert::StorageShape input_shape = {{1, 24, 7500}, {1, 24, 7500}};
    gert::StorageShape out_shape = {{1, 24, 5000}, {1, 24, 5000}};
    ...
    auto holder = gert::TilingContextFaker()
                      ...
                      .CompileInfo(&compile_info)
                      .PlatformInfo(reinterpret_cast<char*>(&platform_info))
                      .NodeAttrs({{"k", ge::AnyValue::CreateFrom<int64_t>(5000)}})
                      .NodeInputTd(0, ge::DT_FLOAT, ge::FORMAT_ND, ge::FORMAT_ND)
                      .NodeOutputTd(0, ge::DT_FLOAT, ge::FORMAT_ND, ge::FORMAT_ND)
                      .NodeOutputTd(1, ge::DT_INT32, ge::FORMAT_ND, ge::FORMAT_ND)
                      .NodeOutputTd(2, ge::DT_FLOAT, ge::FORMAT_ND, ge::FORMAT_ND)
...
TEST_F(MoeGatingTopKSoftmaxV2Tiling, moe_gating_top_k_softmax_v2_tiling_007)
{
    ...
    gert::StorageShape input_shape = {{1, 24, 7500}, {1, 24, 7500}};
    gert::StorageShape out_shape = {{1, 24, 5000}, {1, 24, 5000}};
    gert::StorageShape finish_shape = {{1, 24}, {1, 24}};
    ...
    auto holder = gert::TilingContextFaker()
                      ...
                      .NodeIoNum(2, 3)
                      .IrInstanceNum({1})
                      .InputShapes({&input_shape, &finish_shape})
...
TEST_F(MoeGatingTopKSoftmaxV2Tiling, moe_gating_top_k_softmax_v2_tiling_009)
{
    ...
    gert::StorageShape input_shape = {{1, 24, 7500}, {1, 24, 7500}};
    gert::StorageShape out_shape = {{1, 24, 5000}, {1, 24, 5000}};
    gert::StorageShape out_shape_1 = {{1, 1, 5000}, {1, 1, 5000}};
    ...
    auto holder = gert::TilingContextFaker()
                      ...
                      .IrInstanceNum({1})
                      .InputShapes({&input_shape})
                      .OutputShapes({&out_shape, &out_shape_1, &input_shape})
                      .CompileInfo(&compile_info)
                      .PlatformInfo(reinterpret_cast<char*>(&platform_info))
                      .NodeAttrs({{"k", ge::AnyValue::CreateFrom<int64_t>(5000)}})
                      .NodeInputTd(0, ge::DT_FLOAT, ge::FORMAT_ND, ge::FORMAT_ND)
...
TEST_F(MoeGatingTopKSoftmaxV2Tiling, moe_gating_top_k_softmax_v2_tiling_010)
{
    ...
    // workspaces nullptr return failed
    auto tilingTemplateRegistryMap = optiling::TilingRegistry::GetInstance().GetTilingTemplates(op_type);
    auto tilingTemplate = tilingTemplateRegistryMap[20001](tiling_context);
    EXPECT_EQ(tilingTemplate->DoTiling(), ge::GRAPH_SUCCESS);
    auto tiling_key = tiling_context->GetTilingKey();
    ASSERT_EQ(tiling_key, 102111);
    dlog_setlevel(static_cast<int>(OP), 0, 1);
}
...
TEST_F(MoeGatingTopKSoftmaxV2Tiling, moe_gating_top_k_softmax_v2_tiling_011)
{
    ...
    auto holder = gert::TilingContextFaker()
                      ...
                      .PlatformInfo(reinterpret_cast<char*>(&platform_info))
                      .NodeAttrs(
                          {{"k", ge::AnyValue::CreateFrom<int64_t>(16)},
                           {"renorm", ge::AnyValue::CreateFrom<int64_t>(0)},
                           {"output_softmax_result_flag", ge::AnyValue::CreateFrom<bool>(true)}})
                      .NodeInputTd(0, ge::DT_FLOAT, ge::FORMAT_ND, ge::FORMAT_ND)
                      .NodeOutputTd(0, ge::DT_FLOAT, ge::FORMAT_ND, ge::FORMAT_ND)
                      .NodeOutputTd(1, ge::DT_INT32, ge::FORMAT_ND, ge::FORMAT_ND)
                      .NodeOutputTd(2, ge::DT_FLOAT, ge::FORMAT_ND, ge::FORMAT_ND)
