...
#include "transformer/moe_token_unpermute_with_routing_map_grad/op_host/moe_token_unpermute_with_routing_map_grad_tiling.h"
...
{
    dlog_setlevel(0, 0, 0);
    gert::StorageShape unpermuted_tokens_grad_shape = {{30, 64}, {30, 64}};
    gert::StorageShape out_index_shape = {
        {
            30,
        },
        {
    ...
    gert::StorageShape permute_token_id_shape = {
        {
            30,
        },
        {
    ...
    gert::StorageShape routing_map_shape = {{30, 64}, {30, 64}};
    gert::StorageShape permuted_tokens_shape = {{30, 64}, {30, 64}};
    gert::StorageShape probs_shape = {{30, 64}, {30, 64}};
    // output
    gert::StorageShape permuted_tokens_grad_shape = {{30, 64}, {30, 64}};
    gert::StorageShape probs_grad_shape = {{30, 64}, {30, 64}};
    ...
    MoeTokenUnpermuteWithRoutingMapGradCompileInfo compile_info;

    std::string op_type("MoeTokenUnpermuteWithRoutingMapGrad");
    ...
    auto holder = gert::TilingContextFaker()
                      .SetOpType("MoeTokenUnpermuteWithRoutingMapGrad")
                      .NodeIoNum(6, 2)
                      .IrInstanceNum({1, 1, 1, 1, 1, 1})
                      .InputShapes(
                          {&unpermuted_tokens_grad_shape, &out_index_shape, &permute_token_id_shape, &routing_map_shape,
                           &permuted_tokens_shape, &probs_shape})
                      ...
                      .NodeAttrs({{"drop_and_pad", ge::AnyValue::CreateFrom<bool>(false)}})
...
TEST_F(MoeTokenUnpermuteWithRoutingMapGradTiling, test_tiling_prob_not_none_bf16_tilingkey_11)
{
    ...
    auto holder = gert::TilingContextFaker()
                      ...
                      .NodeOutputTd(0, ge::DT_BF16, ge::FORMAT_ND, ge::FORMAT_ND)
                      .NodeOutputTd(1, ge::DT_BF16, ge::FORMAT_ND, ge::FORMAT_ND)
                      .NodeAttrs({{"drop_and_pad", ge::AnyValue::CreateFrom<bool>(true)}})
                      .TilingData(param.get())
                      .Workspace(ws_size)
                      .Build();
...
TEST_F(MoeTokenUnpermuteWithRoutingMapGradTiling, test_tiling_prob_none_bf16_tilingkey_0)
{
    ...
    auto holder = gert::TilingContextFaker()
                      .SetOpType("MoeTokenUnpermuteWithRoutingMapGrad")
                      .NodeIoNum(5, 1)
                      .IrInstanceNum({1, 1, 1, 1, 1, 0})
                      .InputShapes(
                          {&unpermuted_tokens_grad_shape, &out_index_shape, &permute_token_id_shape, &routing_map_shape,
                           &permuted_tokens_shape})
                      .OutputShapes({&permuted_tokens_grad_shape})
                      .CompileInfo(&compile_info)
                      .PlatformInfo(reinterpret_cast<char*>(&platform_info))
                      .NodeInputTd(0, ge::DT_BF16, ge::FORMAT_ND, ge::FORMAT_ND)
                      .NodeInputTd(1, ge::DT_INT32, ge::FORMAT_ND, ge::FORMAT_ND)
