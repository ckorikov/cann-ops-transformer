...
#include "transformer/moe_compute_expert_tokens/op_host/moe_compute_expert_tokens_tiling.h"
...
{
    // input shape
    gert::StorageShape sorted_expert_shape = {{100}, {100}};
    // output shape
    gert::StorageShape out_shape = {{98}, {98}};
    ...
    // compile info
    optiling::MoeComputeExpertTokensCompileInfo compile_info;

    std::string op_type("MoeComputeExpertTokens");
...
{
    // input shape
    gert::StorageShape sorted_expert_shape = {{20000}, {20000}};
    // output shape
    gert::StorageShape out_shape = {{100}, {100}};
    ...
    auto holder = gert::TilingContextFaker()
                      ...
                      .NodeInputTd(0, ge::DT_INT32, ge::FORMAT_ND, ge::FORMAT_ND)
                      .NodeOutputTd(0, ge::DT_INT32, ge::FORMAT_ND, ge::FORMAT_ND)
                      .NodeAttrs({{"num_experts", ge::AnyValue::CreateFrom<int64_t>(100)}})
                      .TilingData(param.get())
                      .Workspace(ws_size)
                      .Build();
...
{
    // input shape
    gert::StorageShape sorted_expert_shape = {{65536}, {65536}};
    // output shape
    ...
    auto holder = gert::TilingContextFaker()
                      ...
                      .NodeInputTd(0, ge::DT_INT32, ge::FORMAT_ND, ge::FORMAT_ND)
                      .NodeOutputTd(0, ge::DT_INT32, ge::FORMAT_ND, ge::FORMAT_ND)
                      .NodeAttrs({{"num_experts", ge::AnyValue::CreateFrom<int64_t>(8)}})
                      .TilingData(param.get())
                      .Workspace(ws_size)
                      .Build();
