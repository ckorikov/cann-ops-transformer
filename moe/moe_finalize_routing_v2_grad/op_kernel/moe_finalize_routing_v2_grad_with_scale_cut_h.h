...
class MoeFinalizeRoutingV2GradWithScaleCutH : MoeFinalizeRoutingV2GradBase<T1, T2>
{
public:
...
template <typename T1, typename T2>
__aicore__ inline void MoeFinalizeRoutingV2GradWithScaleCutH<T1, T2>::Init(
    GM_ADDR gradY, GM_ADDR expandedRowIdx, GM_ADDR expandedX, GM_ADDR scales, GM_ADDR expertIdx, GM_ADDR bias,
...
template <typename T1, typename T2>
__aicore__ inline void MoeFinalizeRoutingV2GradWithScaleCutH<T1, T2>::Process()
{
...
template <typename T1, typename T2>
__aicore__ inline void MoeFinalizeRoutingV2GradWithScaleCutH<T1, T2>::SubProcess()
{
