...
#include "transformer/moe_gating_top_k/op_host/moe_gating_top_k_tiling.h"
...
TEST_F(MoeGatingTopKTiling, moe_gating_top_k_tiling_succ_01)
{
    ...
    gert::StorageShape expert_idx_shape = {{16, 8}, {16, 8}};
    gert::StorageShape out_shape = {{16, 256}, {16, 256}};
    ...
    platform_info.Init();
    // compile info
    optiling::MoeGatingTopKCompileInfo compile_info;

    std::string op_type("MoeGatingTopK");
    ...
    auto holder = gert::TilingContextFaker()
                      ...
                      .OutputShapes({&y_shape, &expert_idx_shape, &out_shape})
                      ...
                      .NodeAttrs({
                          {"k", ge::AnyValue::CreateFrom<int64_t>(8)},
                          {"k_group", ge::AnyValue::CreateFrom<int64_t>(4)},
                          {"group_count", ge::AnyValue::CreateFrom<int64_t>(8)},
                          {"group_select_mode", ge::AnyValue::CreateFrom<int64_t>(1)},
                          {"renorm", ge::AnyValue::CreateFrom<int64_t>(0)},
                          {"norm_type", ge::AnyValue::CreateFrom<int64_t>(1)},
                          {"out_flag", ge::AnyValue::CreateFrom<bool>(false)},
                          {"routed_scaling_factor", ge::AnyValue::CreateFrom<float>(0)},
                          {"eps", ge::AnyValue::CreateFrom<float>(0)},
                      })
...
TEST_F(MoeGatingTopKTiling, moe_gating_top_k_tiling_succ_02)
{
    ...
    auto holder = gert::TilingContextFaker()
                      ...
                      .NodeAttrs({
                          {"k", ge::AnyValue::CreateFrom<int64_t>(8)},
                          {"k_group", ge::AnyValue::CreateFrom<int64_t>(1)},
                          {"group_count", ge::AnyValue::CreateFrom<int64_t>(1)},
                          {"group_select_mode", ge::AnyValue::CreateFrom<int64_t>(1)},
                          {"renorm", ge::AnyValue::CreateFrom<int64_t>(0)},
                          {"norm_type", ge::AnyValue::CreateFrom<int64_t>(1)},
                          {"out_flag", ge::AnyValue::CreateFrom<bool>(false)},
                          {"routed_scaling_factor", ge::AnyValue::CreateFrom<float>(1.0)},
                          {"eps", ge::AnyValue::CreateFrom<float>(1e-20)},
                      })
                      .TilingData(param.get())
                      .Workspace(ws_size)
                      .Build();
...
TEST_F(MoeGatingTopKTiling, moe_gating_top_k_tiling_succ_03)
{
    ...
    gert::StorageShape y_shape = {{16, 8}, {16, 8}};
    gert::StorageShape expert_idx_shape = {{16, 8}, {16, 8}};
    gert::StorageShape out_shape = {{16, 64}, {16, 64}};
    ...
    auto holder = gert::TilingContextFaker()
                      ...
                      .NodeAttrs({
                          {"k", ge::AnyValue::CreateFrom<int64_t>(8)},
                          {"k_group", ge::AnyValue::CreateFrom<int64_t>(8)},
                          {"group_count", ge::AnyValue::CreateFrom<int64_t>(8)},
                          {"group_select_mode", ge::AnyValue::CreateFrom<int64_t>(0)},
                          {"renorm", ge::AnyValue::CreateFrom<int64_t>(0)},
                          {"norm_type", ge::AnyValue::CreateFrom<int64_t>(0)},
                          {"out_flag", ge::AnyValue::CreateFrom<bool>(false)},
                          {"routed_scaling_factor", ge::AnyValue::CreateFrom<float>(0)},
                          {"eps", ge::AnyValue::CreateFrom<float>(1e-20)},
                      })
...
{
    gert::StorageShape x_shape = {{16, 72}, {16, 72}};
    gert::StorageShape bias_shape = {
        {
            72,
        },
    ...
    gert::StorageShape y_shape = {{16, 8}, {16, 8}};
    gert::StorageShape expert_idx_shape = {{16, 8}, {16, 8}};
    gert::StorageShape out_shape = {{16, 72}, {16, 72}};
    ...
    auto holder = gert::TilingContextFaker()
                      ...
                      .NodeAttrs({
                          {"k", ge::AnyValue::CreateFrom<int64_t>(8)},
                          {"k_group", ge::AnyValue::CreateFrom<int64_t>(5)},
                          {"group_count", ge::AnyValue::CreateFrom<int64_t>(9)},
                          {"group_select_mode", ge::AnyValue::CreateFrom<int64_t>(1)},
                          {"renorm", ge::AnyValue::CreateFrom<int64_t>(0)},
                          {"norm_type", ge::AnyValue::CreateFrom<int64_t>(0)},
                          {"out_flag", ge::AnyValue::CreateFrom<bool>(false)},
...
TEST_F(MoeGatingTopKTiling, moe_gating_top_k_tiling_fail_01)
{
    ...
    auto holder = gert::TilingContextFaker()
                      ...
                      .NodeAttrs({
                          {"k", ge::AnyValue::CreateFrom<int64_t>(-1)},
                          {"k_group", ge::AnyValue::CreateFrom<int64_t>(4)},
                          {"group_count", ge::AnyValue::CreateFrom<int64_t>(8)},
                          {"group_select_mode", ge::AnyValue::CreateFrom<int64_t>(1)},
                          {"renorm", ge::AnyValue::CreateFrom<int64_t>(0)},
...
TEST_F(MoeGatingTopKTiling, moe_gating_top_k_tiling_fail_02)
{
    ...
    auto holder = gert::TilingContextFaker()
                      ...
                      .NodeOutputTd(2, ge::DT_INT32, ge::FORMAT_ND, ge::FORMAT_ND)
                      .NodeAttrs({
                          {"k", ge::AnyValue::CreateFrom<int64_t>(33)},
                          {"k_group", ge::AnyValue::CreateFrom<int64_t>(4)},
                          {"group_count", ge::AnyValue::CreateFrom<int64_t>(8)},
                          {"group_select_mode", ge::AnyValue::CreateFrom<int64_t>(1)},
                          {"renorm", ge::AnyValue::CreateFrom<int64_t>(0)},
...
TEST_F(MoeGatingTopKTiling, moe_gating_top_k_tiling_fail_04)
{
    ...
    auto holder = gert::TilingContextFaker()
                      ...
                      .NodeAttrs({
                          {"k", ge::AnyValue::CreateFrom<int64_t>(8)},
                          {"k_group", ge::AnyValue::CreateFrom<int64_t>(3)},
                          {"group_count", ge::AnyValue::CreateFrom<int64_t>(8)},
                          {"group_select_mode", ge::AnyValue::CreateFrom<int64_t>(1)},
                          {"renorm", ge::AnyValue::CreateFrom<int64_t>(0)},
                          {"norm_type", ge::AnyValue::CreateFrom<int64_t>(1)},
...
TEST_F(MoeGatingTopKTiling, moe_gating_top_k_tiling_fail_05)
{
    ...
    auto holder = gert::TilingContextFaker()
                      ...
                      .NodeAttrs({
                          {"k", ge::AnyValue::CreateFrom<int64_t>(8)},
                          {"k_group", ge::AnyValue::CreateFrom<int64_t>(4)},
                          {"group_count", ge::AnyValue::CreateFrom<int64_t>(0)},
                          {"group_select_mode", ge::AnyValue::CreateFrom<int64_t>(1)},
                          {"renorm", ge::AnyValue::CreateFrom<int64_t>(0)},
                          {"norm_type", ge::AnyValue::CreateFrom<int64_t>(1)},
                          {"out_flag", ge::AnyValue::CreateFrom<bool>(false)},
...
TEST_F(MoeGatingTopKTiling, moe_gating_top_k_tiling_fail_07)
{
    ...
    auto holder = gert::TilingContextFaker()
                      ...
                      .NodeAttrs({
                          ...
                          {"k_group", ge::AnyValue::CreateFrom<int64_t>(4)},
                          {"group_count", ge::AnyValue::CreateFrom<int64_t>(8)},
                          {"group_select_mode", ge::AnyValue::CreateFrom<int64_t>(3)},
                          {"renorm", ge::AnyValue::CreateFrom<int64_t>(0)},
                          {"norm_type", ge::AnyValue::CreateFrom<int64_t>(1)},
                          {"out_flag", ge::AnyValue::CreateFrom<bool>(false)},
                          {"routed_scaling_factor", ge::AnyValue::CreateFrom<float>(0)},
...
TEST_F(MoeGatingTopKTiling, moe_gating_top_k_tiling_fail_09)
{
    ...
    auto holder = gert::TilingContextFaker()
                      ...
                      .NodeAttrs({
                          ...
                          {"group_count", ge::AnyValue::CreateFrom<int64_t>(8)},
                          {"group_select_mode", ge::AnyValue::CreateFrom<int64_t>(1)},
                          {"renorm", ge::AnyValue::CreateFrom<int64_t>(-1)},
                          {"norm_type", ge::AnyValue::CreateFrom<int64_t>(1)},
                          {"out_flag", ge::AnyValue::CreateFrom<bool>(false)},
                          {"routed_scaling_factor", ge::AnyValue::CreateFrom<float>(0)},
                          {"eps", ge::AnyValue::CreateFrom<float>(0)},
...
TEST_F(MoeGatingTopKTiling, moe_gating_top_k_tiling_fail_11)
{
    ...
    auto holder = gert::TilingContextFaker()
                      ...
                      .NodeAttrs({
                          ...
                          {"group_select_mode", ge::AnyValue::CreateFrom<int64_t>(1)},
                          {"renorm", ge::AnyValue::CreateFrom<int64_t>(0)},
                          {"norm_type", ge::AnyValue::CreateFrom<int64_t>(2)},
                          {"out_flag", ge::AnyValue::CreateFrom<bool>(false)},
                          {"routed_scaling_factor", ge::AnyValue::CreateFrom<float>(0)},
                          {"eps", ge::AnyValue::CreateFrom<float>(0)},
                      })
...
TEST_F(MoeGatingTopKTiling, moe_gating_top_k_tiling_fail_13)
{
    ...
    auto holder = gert::TilingContextFaker()
                      ...
                      .NodeAttrs({
                          ...
                          {"renorm", ge::AnyValue::CreateFrom<int64_t>(0)},
                          {"norm_type", ge::AnyValue::CreateFrom<int64_t>(1)},
                          {"out_flag", ge::AnyValue::CreateFrom<bool>(true)},
                          {"routed_scaling_factor", ge::AnyValue::CreateFrom<float>(0)},
                          {"eps", ge::AnyValue::CreateFrom<float>(0)},
                      })
                      .TilingData(param.get())
