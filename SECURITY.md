...
| :------------: |:------------------------------------------------------------------------------------------:|:----------------------------------------------------------| :---------------------------------------------------------- |:-----------------------------------------|
|  依赖  | 不涉及  | cmake/external/protobuf.cmake | https://github.com/protocolbuffers/protobuf/archive/v3.13.0.tar.gz | 从github下载protobuf源码，作用编译依赖 |
...
|  依赖  | 不涉及  | cmake/external/secure_c.cmake | https://gitee.com/openeuler/libboundscheck/repository/archive/v1.1.10.tar.gz | 从gitee下载libboundscheck源码，作用编译依赖 |
---
