...
class embedding_bag_onnx_plugin_test : public testing::Test {
 protected:
  static void SetUpTestCase() {
    std::cout << "embedding_bag_onnx_plugin_test SetUp" << std::endl;
  }

  static void TearDownTestCase() {
    std::cout << "embedding_bag_onnx_plugin_test TearDown" << std::endl;
  }
};
...
TEST_F(embedding_bag_onnx_plugin_test, embedding_bag_onnx_plugin_test_case) {
  ...
  std::string modelFile = caseDir + "/test_embedding_bag_onnx_case1.onnx";
