...
public:
    ...
    __aicore__ inline void Init(GM_ADDR cmtx_, GM_ADDR bmtx_, GM_ADDR cb_ws_, GM_ADDR xmtx_, GM_ADDR mmtx_, GM_ADDR outmtx_, GM_ADDR cbmtx_, CustCubeShapeInfo shape_){
        ...
        // L1 Buffers
        l1a.Init((64 * shape.BASEK));
        l1b.Init((64 * shape.BASEK));
        // L0A Buffers
        l0a.Init((64 * shape.BASEK));
        // L0B Buffers
        l0b.Init((64 * shape.BASEK));
        // L0C Buffers
        l0c.Init(4096);
        // UB Buffers
        // Initialize events
    ...
    __aicore__ inline void Compute(){
        ...
        for (int bch=shape.BCH1; bch<shape.BCH2; bch+=1){
            ...
            if ((((h % shape.HPERG) == 0) || (bch == shape.BCH1))){
                for (int m=0; m<shape.L; m+=64){
                    for (int n=0; n<shape.L; n+=64){
                        for (int k=0; k<shape.N; k+=shape.BASEK1){
                            l1_empty.wait();
                            L1ND2NZ(l1a.get(input_cnt), cmtx[((((bc * ((shape.L * shape.G) * shape.N)) + (m * (shape.G * shape.N))) + (g * shape.N)) + (k * 1))], 64, shape.BASEK1, (shape.N * shape.G), 64);
                            L1ND2NZ(l1b.get(input_cnt), bmtx[((((bc * ((shape.L * shape.G) * shape.N)) + (n * (shape.G * shape.N))) + (g * shape.N)) + (k * 1))], 64, shape.BASEK1, (shape.N * shape.G), 64);
                            l1_ready.set();
                            l0_empty.wait();
                            l1_ready.wait();
                            L0NZ2ZZ(l0a.get(input_cnt), l1a.get(input_cnt), 64, shape.BASEK1, 64, shape.BASEK1);
                            LOADL0(l0b.get(input_cnt), l1b.get(input_cnt), 64, shape.BASEK1);
                            l1_empty.set();
                            l0_ready.set();
                            out_empty.wait();
                            l0_ready.wait();
                            MMAD(l0c.get(output_cnt), l0a.get(input_cnt), l0b.get(input_cnt), 64, shape.BASEK1, 64, (k == 0), 0);
                            out_ready.set();
                            l0_empty.set();
                            out_ready.wait();
                            if (((k + shape.BASEK1) >= shape.N)){
                                L0C2GM_NZ2ND(cbmtx[((((bc * ((shape.G * shape.L) * shape.L)) + (g * (shape.L * shape.L))) + (m * shape.L)) + (n * 1))], l0c.get(output_cnt), 64, 64, shape.L, 64, 0);
                                L0C2GM_NZ2ND(cb_ws[(((get_block_idx() * (shape.L * shape.L)) + (m * shape.L)) + (n * 1))], l0c.get(output_cnt), 64, 64, shape.L, 64, 0);
            ...
            WAIT_VEC(3);
            for (int m=0; m<shape.L; m+=64){
                for (int n=0; n<shape.P; n+=64){
                    for (int k=0; k<shape.L; k+=shape.BASEK2){
                        l1_empty.wait();
                        L1ND2NZ(l1a.get(cube1_in_cnt), mmtx[((((bc * ((shape.H * shape.L) * shape.L)) + (h * (shape.L * shape.L))) + (m * shape.L)) + (k * 1))], 64, shape.BASEK2, shape.L, 64);
                        L1ND2NZ(l1b.get(cube1_in_cnt), xmtx[((((bc * ((shape.L * shape.H) * shape.P)) + (k * (shape.H * shape.P))) + (h * shape.P)) + (n * 1))], shape.BASEK2, 64, (shape.H * shape.P), shape.BASEK2);
                        l1_ready.set();
                        l0_empty.wait();
                        l1_ready.wait();
                        L0NZ2ZZ(l0a.get(cube1_in_cnt), l1a.get(cube1_in_cnt), 64, shape.BASEK2, 64, shape.BASEK2);
                        L0NZ2ZN(l0b.get(cube1_in_cnt), l1b.get(cube1_in_cnt), shape.BASEK2, 64, shape.BASEK2, 64);
                        l1_empty.set();
                        l0_ready.set();
                        out_empty.wait();
                        l0_ready.wait();
                        MMAD(l0c.get(cube1_out_cnt), l0a.get(cube1_in_cnt), l0b.get(cube1_in_cnt), 64, shape.BASEK2, 64, (k == 0), 0);
                        out_ready.set();
                        l0_empty.set();
                        out_ready.wait();
                        if (((k + shape.BASEK2) >= shape.L)){
                            L0C2GM_NZ2ND(outmtx[((((bc * ((shape.H * shape.L) * shape.P)) + (h * (shape.L * shape.P))) + (m * shape.P)) + (n * 1))], l0c.get(cube1_out_cnt), 64, 64, shape.P, 64, 0);
