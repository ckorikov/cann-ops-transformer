...
#ifndef KVQUANT_SPARSE_ATTN_SHAREDKV_SCFA_H
#define KVQUANT_SPARSE_ATTN_SHAREDKV_SCFA_H
...
template <typename SAST> class KvQuantSparseAttnSharedkvScfa {
public:
...
private:
    const KvQuantSparseAttnSharedkvTilingData *__restrict tilingData = nullptr;
...
template <typename SAST> __aicore__ inline void KvQuantSparseAttnSharedkvScfa<SAST>::InitTilingData()
{
...
template <typename SAST> __aicore__ inline void KvQuantSparseAttnSharedkvScfa<SAST>::Process()
{
