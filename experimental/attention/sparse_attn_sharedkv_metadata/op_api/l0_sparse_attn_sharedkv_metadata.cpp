...
const aclTensor* SparseAttnSharedkvMetadata(
  ...
  L0_DFX(SparseAttnSharedkvMetadata, cuSeqLensQOptional,
         sequsedKvOptional, batchSize, numHeadsQ,
         numHeadsKv, headDim, topKOptional, cmpRatioOptional, oriMaskModeOptional, cmpMaskModeOptional,
  ...
  auto ret = ADD_TO_LAUNCHER_LIST_AICPU(
      SparseAttnSharedkvMetadata,
      OP_ATTR_NAMES({"batch_size", "num_heads_q", "num_heads_kv", "head_dim",
      ...
      OP_ATTR(batchSize, numHeadsQ, numHeadsKv, headDim, topKOptional,
              cmpRatioOptional, oriMaskModeOptional, cmpMaskModeOptional,
              oriWinLeftOptional, oriWinRightOptional, layoutQOptional,
              layoutKvOptional, hasOriKvOptional, hasCmpKvOptional, socVersion,
