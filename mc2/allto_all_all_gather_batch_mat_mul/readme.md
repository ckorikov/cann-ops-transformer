...
<table style="undefined;table-layout: fixed; width: 1576px">
 ...
 <tbody>
  ...
  <tr>
   <td>weight</td>
   <td>输入</td>
   <td>BatchMatMul计算的右矩阵，类型需与x保持一致。</td>
   <td>FLOAT16、BFLOAT16</td>
   <td>ND</td>
  </tr>
  <tr>
   <td>biasOptional</td>
   <td>输入</td>
   <td>BatchMatMul计算的bias，支持传入空指针。x为FLOAT16时需为FLOAT16，x为BFLOAT16时需为FLOAT32，支持两维或三维。</td>
  ...
  <tr>
   <td>groupEp</td>
   <td>输入</td>
   <td>ep通信域名称（专家并行通信域）。字符串长度需&gt;0且&lt;128。</td>
   <td>STRING</td>
   <td>ND</td>
  </tr>
  <tr>
   <td>groupTp</td>
   <td>输入</td>
   <td>tp通信域名称（Tensor并行通信域）。字符串长度需&gt;0且&lt;128。</td>
   <td>STRING</td>
   <td>ND</td>
  </tr>
  <tr>
  ...
  <tr>
   <td>xShardType</td>
   <td>输入</td>
   <td>0表示在H维度（第2维）上按tp域allgather，1表示在C维度（第1维）上按tp域allgather。</td>
   <td>INT64</td>
   <td>ND</td>
  </tr>
  <tr>
   <td>actType</td>
   <td>输入</td>
   <td>激活函数类型。0：None，1：GELU，2：Silu，3：Relu，4：FastGELU。</td>
   <td>INT64</td>
   <td>ND</td>
  </tr>
  <tr>
   <td>y1Out</td>
   <td>输出</td>
   <td>最终计算结果；有激活函数时为激活函数输出，否则为BatchMatMul输出。</td>
   <td>FLOAT16、BFLOAT16</td>
   <td>ND</td>
  </tr>
  <tr>
   <td>y2OutOptional</td>
   <td>输出</td>
   <td>可选输出，AllGather的结果，反向计算可能需要。空指针表示不需要该输出。</td>
   <td>FLOAT16、BFLOAT16 </td>
   <td>ND</td>
  </tr>
  <tr>
   <td>y3OutOptional</td>
   <td>输出</td>
   <td>可选输出；有激活函数时为BatchMatMul的输出，空指针表示不需要。</td>
   <td>FLOAT16、BFLOAT16 </td>
   <td>ND</td>
  </tr>
 </tbody>
...
| 调用方式  | 样例代码                                  | 说明                                                     |
| :--------: | :----------------------------------------: | :-------------------------------------------------------: |
| aclnn接口 | [test_allto_all_all_gather_batch_mat_mul.cpp](test_allto_all_all_gather_batch_mat_mul.cpp) | 通过[aclnnAlltoAllAllGatherBatchMatMul](aclnnAlltoAllAllGatherBatchMatMul.md)接口方式调用算子。 |
