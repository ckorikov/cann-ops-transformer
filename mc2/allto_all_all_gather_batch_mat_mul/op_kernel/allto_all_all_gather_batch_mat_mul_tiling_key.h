 ...
 * \brief
 */
#ifndef MC2_ALLTOALL_ALLGATHER_BATCHMATMUL_TILING_KET_H
#define MC2_ALLTOALL_ALLGATHER_BATCHMATMUL_TILING_KET_H
...
#endif // MC2_ALLTOALL_ALLGATHER_BATCHMATMUL_TILING_KET_H