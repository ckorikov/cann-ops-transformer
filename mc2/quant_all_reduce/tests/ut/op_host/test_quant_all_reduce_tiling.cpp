...
// tilingDataReservedLen = 43，tilingData前面mc2InitTiling和mc2CcTiling两块数据的地址偏移
static QuantAllReduceTestParam test_cases[] = {
    {"quant_all_reduce_critical_case_1",
     ...
     ge::GRAPH_SUCCESS, 0UL, "1024 5120 80 64 ", {16777216}, 43},
    {"quant_all_reduce_critical_case_2",
     ...
     ge::GRAPH_SUCCESS, 0UL, "2048 5120 40 64 ", {16777216}, 43},
    {"quant_all_reduce_critical_case_3",
     ...
     "group", "sum", ge::DT_FLOAT16, "Ascend910_95",
     ge::GRAPH_SUCCESS, 0UL, "1024 7168 56 64 ", {16777216}, 43},
     ...
     "group", "sum", ge::DT_FLOAT16, "Ascend910_95",
     ge::GRAPH_SUCCESS, 0UL, "8 128 128 64 ", {16777216}, 43},
    {"quant_all_reduce_critical_case_2_x3d",
     ...
     "group", "sum", ge::DT_FLOAT, "Ascend910_95",
     ge::GRAPH_SUCCESS, 0UL, "16 128 128 64 ", {16777216}, 43},
...
// setup & teardown
class TestQuantAllReduceTiling : public testing::TestWithParam<QuantAllReduceTestParam> {
protected:
    static void SetUpTestCase()
    {
        std::cout << "TestQuantAllReduceTiling SetUp." << std::endl;
    }

    static void TearDownTestCase()
    {
        std::cout << "TestQuantAllReduceTiling TearDown." << std::endl;
    }
};

struct QuantAllReduceCompileInfo {} compileInfo;

// ut逻辑
static void TestOneParamCase(const QuantAllReduceTestParam &param)
{
