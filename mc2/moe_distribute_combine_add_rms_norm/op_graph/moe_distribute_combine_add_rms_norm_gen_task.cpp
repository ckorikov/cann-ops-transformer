...
/*!
 * \file moe_distribute_combine_add_rms_norm_gen_task_training.cpp
 * \brief
 */
#include <vector>
#include <map>
...
IMPL_OP_CT(MoeDistributeCombineAddRmsNorm)
  .CalcOpParam(Mc2MoeCalcParamFunc)
  .GenerateTask(Mc2MoeGenTaskFuncV2);

REGISTER_EXT_TASK_TYPE(MoeDistributeCombineAddRmsNorm, fe::ExtTaskType::kAicoreTask);
