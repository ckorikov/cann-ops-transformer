...
void AllGatherQuantBmmTiling::SetMc2Hcomm()
{
    ...
    mc2CcTilingConfig.GetTiling(allGatherMatmulTilingDataFp8_->mc2InitTiling);
    mc2CcTilingConfig.GetTiling(allGatherMatmulTilingDataFp8_->mc2CcTiling);
}
