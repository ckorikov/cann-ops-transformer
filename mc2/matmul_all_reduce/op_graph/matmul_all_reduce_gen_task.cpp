...
static ge::Status MatmulAllReduceCalcOpParam(gert::ExeResGenerationContext* context)
{
    return Mc2GenTaskUtils::CommonKFCMc2CalcParamFunc(context, "aicpu kfc server", "kfc_stream");
}

ge::Status MatmulAllReduceGenTask(
...
IMPL_OP_CT(MatmulAllReduce).CalcOpParam(MatmulAllReduceCalcOpParam).GenerateTask(MatmulAllReduceGenTask);
} // namespace ops
