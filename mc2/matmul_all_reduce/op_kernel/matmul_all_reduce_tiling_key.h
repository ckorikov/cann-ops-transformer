...
#define TPL_PARAMS_QUANT_MM int TRANS, int KERNEL_TEMPLATE_TYPE
#define PARAMS_QUANT_MM TRANS, KERNEL_TEMPLATE_TYPE
...
#define QUANT_BATCH_MATMUl_V3_KERNEL_TEMPLATE_TYPE_TBE 0    // KERNEL_TEMPLATE_TYPE
...
ASCENDC_TPL_ARGS_DECL(
    ...
    ASCENDC_TPL_UINT_DECL(
        KERNEL_TEMPLATE_TYPE, ASCENDC_TPL_2_BW, ASCENDC_TPL_UI_LIST,
        QUANT_BATCH_MATMUl_V3_KERNEL_TEMPLATE_TYPE_TBE,
        QUANT_BATCH_MATMUl_V3_KERNEL_TEMPLATE_TYPE_BASIC, QUANT_BATCH_MATMUl_V3_KERNEL_TEMPLATE_TYPE_OPT),
...
#define SET_NOT_USE_QUANT_MM_TPL_SEL                                                    \
    ...
    ASCENDC_TPL_UINT_SEL(KERNEL_TEMPLATE_TYPE, ASCENDC_TPL_UI_LIST,0)
...
// MATMUL_ALLREDUCE_MM_TYPE_QUANT_MATMUL
    // tiling_key num = 8
    // 4104(1), 36872, 8(0), 32776, 4136, 36904, 40, 32808
#if defined(__CCE_AICORE__) && __CCE_AICORE__ == 220
    ...
    ASCENDC_TPL_ARGS_SEL(
        ...
        ASCENDC_TPL_UINT_SEL(KERNEL_TEMPLATE_TYPE, ASCENDC_TPL_UI_LIST,
            QUANT_BATCH_MATMUl_V3_KERNEL_TEMPLATE_TYPE_TBE,
            QUANT_BATCH_MATMUl_V3_KERNEL_TEMPLATE_TYPE_OPT),
        SET_NOT_USE_WEIGHT_QUANT_MM_TPL_SEL),
    ASCENDC_TPL_ARGS_SEL(
        ASCENDC_TPL_KERNEL_TYPE_SEL(ASCENDC_TPL_MIX_AIC_1_2),
        ASCENDC_TPL_UINT_SEL(AICORE_TYPE, ASCENDC_TPL_UI_LIST,
