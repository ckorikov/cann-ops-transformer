...
END_TILING_DATA_DEF;
REGISTER_TILING_DATA_CLASS(MatmulAllReduce_18446744073709551615, WeightQuantMatmulAllReduceTilingData);
...
REGISTER_TILING_DATA_CLASS(MatmulAllReduce_365057993605889, WeightQuantMatmulAllReduceTilingData);
REGISTER_TILING_DATA_CLASS(MatmulAllReduce_365332871512833, WeightQuantMatmulAllReduceTilingData);
