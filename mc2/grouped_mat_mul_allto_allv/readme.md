...
| 调用方式  | 样例代码                                  | 说明                                                     |
| :--------: | :----------------------------------------: | :-------------------------------------------------------: |
| aclnn接口 | [test_grouped_mat_mul_allto_allv.cpp](test_grouped_mat_mul_allto_allv.cpp) | 通过[aclnnGroupedMatMulAlltoAllv](aclnnGroupedMatMulAlltoAllv.md)接口方式调用grouped_mat_mul_allto_allv算子。 |
