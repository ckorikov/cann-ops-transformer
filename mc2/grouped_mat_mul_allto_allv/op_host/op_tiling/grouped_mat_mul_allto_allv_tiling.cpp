...
static void PrintCommonTilingInfo(GmmAlltoAllvCommonTilingInfo &commonTilingInfo)
{
    ...
    OP_LOGD(A_INNER_DEBUG, " commonTilingInfo.H %lu.", commonTilingInfo.H);
    OP_LOGD(A_INNER_DEBUG, " commonTilingInfo.sharedMatmulH %lu.", commonTilingInfo.sharedMatmulH);
    ...
    OP_LOGD(A_INNER_DEBUG, " commonTilingInfo.isOptionalMatmul %d.", commonTilingInfo.isOptionalMatmul);
    OP_LOGD(A_INNER_DEBUG, " commonTilingInfo.isOptionalSendRecvCountTensors %d.",
