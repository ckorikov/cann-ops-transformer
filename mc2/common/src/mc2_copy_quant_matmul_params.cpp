...
namespace optiling {
void SetMatmulTilingParams(::TCubeTiling& matmulTilingParams, TCubeTiling& matmulTilingData)
{
    ...
    QuantBatchMatmulV3TilingData& quantBmmV3TilingData)
{
    ...
    SetQuantBatchMatmulV3Params(quantBatchMatmulParams.params, quantBmmV3TilingData.params);
