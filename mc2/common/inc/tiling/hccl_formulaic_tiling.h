...
constexpr double ALLGATHERMM_COMMTIME_FACTOR = 2;
constexpr double ALLREDUCE_COMMTIME_FACTOR = 2.0517;
constexpr double REDUCESCATTER_COMMTIME_FACTOR = 2.09136;
