...
class l2_matmul_all_reduce_add_rms_norm_test : public testing::Test {
 protected:
  static void SetUpTestCase() { cout << "l2_matmul_all_reduce_add_rms_norm_test SetUp" << endl; }
...
TEST_F(l2_matmul_all_reduce_add_rms_norm_test, test_mm_all_reduce_add_rms_norm_second_api) {
  void* workspaceAddr;
  uint64_t workspaceSize = 0;
  aclOpExecutor *executor;
  aclrtStream stream;
  aclnnMatmulAllReduceAddRmsNorm(workspaceAddr, workspaceSize, executor, stream);
}
