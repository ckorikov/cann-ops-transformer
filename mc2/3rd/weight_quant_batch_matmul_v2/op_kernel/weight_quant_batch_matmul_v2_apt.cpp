...
using WeightQuantBatchMatmulV2::Arch35::Catlass::InvokeActKernel;
#endif
...
#define DTYPE_BIAS DTYPE_X
    ...
    if (TILING_KEY_IS(2000020003000004101UL)) {
        static constexpr WqmmConfig wqmmCfg = {false,         false, QuantType::MX, false, QuantType::PER_TENSOR,
                                               CubeFormat::NZ};
    ...
    if (TILING_KEY_IS(2000020002000014100UL)) {
        static constexpr WqmmConfig wqmmCfg = {false,         true, QuantType::MX, false, QuantType::PER_TENSOR,
                                               CubeFormat::ND};
        INVOKE_WEIGHT_QUANT_BMM_ADAPTIVE_SPLIT_OP_IMPL(
...
// 当前场景不支持c8输出和fp8输入
    ...
    if (TILING_KEY_IS(100300UL)) {
        ...
        static constexpr WqmmConfig wqmmCfg = {
            false, false, QuantType::PER_CHANNEL, false, QuantType::PER_TENSOR, CubeFormat::NZ};
        INVOKE_WEIGHT_QUANT_BMM_ADAPTIVE_SPLIT_OP_IMPL(
            WeightQuantBatchMatmulV2BasicBlockController, wqmmCfg, VEC_ANTIQUANT_CONFIG_3);
    } else if (TILING_KEY_IS(2000020003000002121UL)) {
        static constexpr WqmmConfig wqmmCfg = {
            false, false, QuantType::PER_CHANNEL, true, QuantType::PER_TENSOR, CubeFormat::NZ};
        INVOKE_WEIGHT_QUANT_BMM_ADAPTIVE_SPLIT_OP_IMPL(
            WeightQuantBatchMatmulV2BasicBlockController, wqmmCfg, VEC_ANTIQUANT_CONFIG_3);
#if defined(A16) && defined(S4)
    ...
    if (TILING_KEY_IS(2000030004000012100UL)) {
        ...
        static constexpr WqmmConfig wqmmCfg = {true,          true, QuantType::PER_CHANNEL, true, QuantType::PER_TENSOR,
                                               CubeFormat::ND};
#if defined(WEIGHT_B8_BRANCH)
        INVOKE_WEIGHT_QUANT_BMM_ADAPTIVE_SPLIT_OP_IMPL(
            WeightQuantBatchMatmulV2BasicBlockController, wqmmCfg, VEC_ANTIQUANT_CONFIG_0);
        ...
        static constexpr WqmmConfig wqmmCfg = {false,         true, QuantType::PER_TENSOR, false, QuantType::PER_TENSOR,
                                               CubeFormat::ND};
#if defined(WEIGHT_B8_BRANCH)
        INVOKE_WEIGHT_QUANT_BMM_ADAPTIVE_SPLIT_OP_IMPL(
            WeightQuantBatchMatmulV2BasicBlockController, wqmmCfg, VEC_ANTIQUANT_CONFIG_0);
        ...
        static constexpr WqmmConfig wqmmCfg = {true,          true, QuantType::PER_TENSOR, false, QuantType::PER_TENSOR,
                                               CubeFormat::ND};
#if defined(WEIGHT_B8_BRANCH)
        INVOKE_WEIGHT_QUANT_BMM_ADAPTIVE_SPLIT_OP_IMPL(
            WeightQuantBatchMatmulV2BasicBlockController, wqmmCfg, VEC_ANTIQUANT_CONFIG_0);
        ...
        static constexpr WqmmConfig wqmmCfg = {false,         true, QuantType::PER_TENSOR, true, QuantType::PER_TENSOR,
                                               CubeFormat::ND};
#if defined(WEIGHT_B8_BRANCH)
        INVOKE_WEIGHT_QUANT_BMM_ADAPTIVE_SPLIT_OP_IMPL(
            WeightQuantBatchMatmulV2BasicBlockController, wqmmCfg, VEC_ANTIQUANT_CONFIG_0);
        ...
        static constexpr WqmmConfig wqmmCfg = {true,          true, QuantType::PER_TENSOR, true, QuantType::PER_TENSOR,
                                               CubeFormat::ND};
#if defined(WEIGHT_B8_BRANCH)
        INVOKE_WEIGHT_QUANT_BMM_ADAPTIVE_SPLIT_OP_IMPL(
            WeightQuantBatchMatmulV2BasicBlockController, wqmmCfg, VEC_ANTIQUANT_CONFIG_0);
        ...
        static constexpr WqmmConfig wqmmCfg = {false,         false, QuantType::PER_TENSOR, true, QuantType::PER_TENSOR,
                                               CubeFormat::ND};
        INVOKE_WEIGHT_QUANT_BMM_ADAPTIVE_SPLIT_OP_IMPL(
            WeightQuantBatchMatmulV2BasicBlockController, wqmmCfg, VEC_ANTIQUANT_CONFIG_3);
    } else if (TILING_KEY_IS(2000030003000021120UL)) {
        static constexpr WqmmConfig wqmmCfg = {true,          false, QuantType::PER_TENSOR, true, QuantType::PER_TENSOR,
                                               CubeFormat::ND};
        INVOKE_WEIGHT_QUANT_BMM_ADAPTIVE_SPLIT_OP_IMPL(
            WeightQuantBatchMatmulV2BasicBlockController, wqmmCfg, VEC_ANTIQUANT_CONFIG_3);
    }
// 下列tiling key只在c8场景和非fp8输入下出现
        ...
        static constexpr WqmmConfig wqmmCfg = {false,         true, QuantType::PER_TENSOR, true, QuantType::PER_CHANNEL,
                                               CubeFormat::ND};
#if defined(WEIGHT_B8_BRANCH)
        INVOKE_WEIGHT_QUANT_BMM_ADAPTIVE_SPLIT_OP_IMPL(
            WeightQuantBatchMatmulV2BasicBlockController, wqmmCfg, VEC_ANTIQUANT_CONFIG_0);
        ...
        static constexpr WqmmConfig wqmmCfg = {true,          true, QuantType::PER_TENSOR, true, QuantType::PER_CHANNEL,
                                               CubeFormat::ND};
#if defined(WEIGHT_B8_BRANCH)
        INVOKE_WEIGHT_QUANT_BMM_ADAPTIVE_SPLIT_OP_IMPL(
            WeightQuantBatchMatmulV2BasicBlockController, wqmmCfg, VEC_ANTIQUANT_CONFIG_0);
...
using DTYPE_BIAS = float
    ...
    if (TILING_KEY_IS(2000020003000004141UL)) {
        static constexpr WqmmConfig wqmmCfg = {false,         false, QuantType::MX, true, QuantType::PER_TENSOR,
                                               CubeFormat::NZ};
        INVOKE_WEIGHT_QUANT_BMM_ADAPTIVE_SPLIT_OP_IMPL(
            WeightQuantBatchMatmulV2BasicBlockController, wqmmCfg, VEC_ANTIQUANT_CONFIG_3);
