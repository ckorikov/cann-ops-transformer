...
/*!
 * \file quant_batch_matmul_v3_pertoken.h
 * \brief
 */
#ifndef MC2_QUANT_BATCH_MATMUL_V3_PERTOKEN_H
...
protected:
    ...
    __aicore__ inline void CalcMAxisOffset(uint32_t loopIdx, uint32_t nLoops)
    {
        ...
        offsetPertokenScale_ += singleTimeM_;
                                          ...
                                          uint64_t baseNOfffset, uint32_t curAicM, uint32_t curAicN)
    {
        ...
        for (uint32_t mUbLoopIdx = 0; mUbLoopIdx < mUbLoops; ++mUbLoopIdx) {
            ...
            DataCopyPad(pertokenScaleLocal, pertokenScaleGm_[scaleOffset], scale2UbParams, padParams);
...
#endif  // QUANT_BATCH_MATMUL_V3_PERTOKEN_H