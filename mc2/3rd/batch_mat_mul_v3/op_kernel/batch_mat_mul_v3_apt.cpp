    ...
    GM_ADDR cGM, GM_ADDR workspaceGM, GM_ADDR tilingGM)
{
    ...
    REGISTER_TILING_FOR_TILINGKEY("TILING_KEY_VAR >= 10001900009002090000UL", BatchMatMulV3BasicTilingData);
    ...
    if (TILING_KEY_IS(10001900009000190000UL)) {
        ...
        GET_TILING_DATA_WITH_STRUCT(BatchMatMulV3BasicTilingData, tilingData, tilingGM);
        MatMulActKernel<DTYPE_X1, DTYPE_X2, DTYPE_Y, DTYPE_BIAS, layout::ColumnMajor, layout::RowMajor,
                        layout::RowMajor>(aGM, bGM, biasGM, cGM, workspaceGM, tilingData.matMulTilingData,
                                          tilingData.batchDimAll);
    } else if (TILING_KEY_IS(10001900009000090002UL)) {
        GET_TILING_DATA_WITH_STRUCT(BatchMatMulV3BasicTilingData, tilingData, tilingGM);
        MatMulActKernel<DTYPE_X1, DTYPE_X2, DTYPE_Y, DTYPE_BIAS, layout::RowMajor, layout::ColumnMajor,
                        layout::RowMajor>(aGM, bGM, biasGM, cGM, workspaceGM, tilingData.matMulTilingData,
                                          tilingData.batchDimAll);
    } else if (TILING_KEY_IS(10001900009000090003UL)) {
        GET_TILING_DATA_WITH_STRUCT(BatchMatMulV3BasicTilingData, tilingData, tilingGM);
        MatMulActKernel<DTYPE_X1, DTYPE_X2, DTYPE_Y, DTYPE_BIAS, layout::ColumnMajor, layout::ColumnMajor,
                        layout::RowMajor>(aGM, bGM, biasGM, cGM, workspaceGM, tilingData.matMulTilingData,
                                          tilingData.batchDimAll);
    } else if (TILING_KEY_IS(10001900009002090000UL)) {
        GET_TILING_DATA_WITH_STRUCT(BatchMatMulV3BasicTilingData, tilingData, tilingGM);
        MatMulActKernel<DTYPE_X1, DTYPE_X2, DTYPE_Y, DTYPE_BIAS, layout::RowMajor, layout::RowMajor, layout::RowMajor,
                        B_FULL_LOAD_MODE>(aGM, bGM, biasGM, cGM, workspaceGM, tilingData.matMulTilingData,
                                          tilingData.batchDimAll);
        ...
        BMMV3_IMPL_CLASS_COMMON_TRNAS(false, false, BatchMatMulV3Advanced::BatchMatMulAswKernel,
            BatchMatMulV3Advanced::BatchMatMulAswBlock, MM_CFG_NO_PRELOAD);
    } else if (TILING_KEY_IS(10000900009000090001UL)) {
        BMMV3_IMPL_CLASS_COMMON_TRNAS(true, false, BatchMatMulV3Advanced::BatchMatMulAswKernel,
            BatchMatMulV3Advanced::BatchMatMulAswBlock, MM_CFG_NO_PRELOAD);
    } else if (TILING_KEY_IS(10000900009000090002UL)) {
        BMMV3_IMPL_CLASS_COMMON_TRNAS(false, true, BatchMatMulV3Advanced::BatchMatMulAswKernel,
            BatchMatMulV3Advanced::BatchMatMulAswBlock, MM_CFG_NO_PRELOAD);
    } else if (TILING_KEY_IS(10000900009000090003UL)) {
        BMMV3_IMPL_CLASS_COMMON_TRNAS(true, true, BatchMatMulV3Advanced::BatchMatMulAswKernel,
            BatchMatMulV3Advanced::BatchMatMulAswBlock, MM_CFG_NO_PRELOAD);
    } else if (TILING_KEY_IS(10000900009000490000UL)) {
        BMMV3_IMPL_CLASS_COMMON_TRNAS(false, false, BatchMatMulV3Advanced::BatchMatMulAswKernel,
            BatchMatMulV3Advanced::BatchMatMulDaswBlock, MM_CFG_NO_PRELOAD);
        ...
        BMMV3_IMPL_CLASS_TRANS(false, false, BatchMatMulV3Advanced::BatchMatMulMultiBatchKernel,
            BatchMatMulV3Advanced::BatchMatMulMultiBatchBaseBlock, MM_CFG_MULTI_BATCH_OUT_BATCH_BIAS);
    } else if (TILING_KEY_IS(10000900009000190001UL)) {
        BMMV3_IMPL_CLASS_TRANS(true, false, BatchMatMulV3Advanced::BatchMatMulMultiBatchKernel,
            BatchMatMulV3Advanced::BatchMatMulMultiBatchBaseBlock, MM_CFG_MULTI_BATCH_OUT_BATCH_BIAS);
    } else if (TILING_KEY_IS(10000900009000190002UL)) {
        BMMV3_IMPL_CLASS_TRANS(false, true, BatchMatMulV3Advanced::BatchMatMulMultiBatchKernel,
            BatchMatMulV3Advanced::BatchMatMulMultiBatchBaseBlock, MM_CFG_MULTI_BATCH_OUT_BATCH_BIAS);
    } else if (TILING_KEY_IS(10000900009000190003UL)) {
        BMMV3_IMPL_CLASS_TRANS(true, true, BatchMatMulV3Advanced::BatchMatMulMultiBatchKernel,
            BatchMatMulV3Advanced::BatchMatMulMultiBatchBaseBlock, MM_CFG_MULTI_BATCH_OUT_BATCH_BIAS);
        ...
        BMMV3_IMPL_CLASS_COMMON_TRNAS(false, false, BatchMatMulV3Advanced::BatchMatMulAswAL1FullLoadKernel,
            BatchMatMulV3Advanced::BatchMatMulAswBlock, MM_CFG_NO_PRELOAD);
    } else if (TILING_KEY_IS(10000900009001090001UL)) {
        BMMV3_IMPL_CLASS_COMMON_TRNAS(true, false, BatchMatMulV3Advanced::BatchMatMulAswAL1FullLoadKernel,
            BatchMatMulV3Advanced::BatchMatMulAswBlock, MM_CFG_NO_PRELOAD);
    } else if (TILING_KEY_IS(10000900009001090002UL)) {
        BMMV3_IMPL_CLASS_COMMON_TRNAS(false, true, BatchMatMulV3Advanced::BatchMatMulAswAL1FullLoadKernel,
            BatchMatMulV3Advanced::BatchMatMulAswBlock, MM_CFG_NO_PRELOAD);
    } else if (TILING_KEY_IS(10000900009001090003UL)) {
        BMMV3_IMPL_CLASS_COMMON_TRNAS(true, true, BatchMatMulV3Advanced::BatchMatMulAswAL1FullLoadKernel,
            BatchMatMulV3Advanced::BatchMatMulAswBlock, MM_CFG_NO_PRELOAD);
        ...
        BMMV3_IMPL_CLASS_COMMON_TRNAS(false, false, BatchMatMulV3Advanced::BatchMatMulAswBL1FullLoadKernel,
            BatchMatMulV3Advanced::BatchMatMulAswBlock, MM_CFG_NO_PRELOAD);
    } else if (TILING_KEY_IS(10000900009002090001UL)) {
        BMMV3_IMPL_CLASS_COMMON_TRNAS(true, false, BatchMatMulV3Advanced::BatchMatMulAswBL1FullLoadKernel,
            BatchMatMulV3Advanced::BatchMatMulAswBlock, MM_CFG_NO_PRELOAD);
    } else if (TILING_KEY_IS(10000900009002090002UL)) {
        BMMV3_IMPL_CLASS_COMMON_TRNAS(false, true, BatchMatMulV3Advanced::BatchMatMulAswBL1FullLoadKernel,
            BatchMatMulV3Advanced::BatchMatMulAswBlock, MM_CFG_NO_PRELOAD);
    } else if (TILING_KEY_IS(10000900009002090003UL)) {
        BMMV3_IMPL_CLASS_COMMON_TRNAS(true, true, BatchMatMulV3Advanced::BatchMatMulAswBL1FullLoadKernel,
            BatchMatMulV3Advanced::BatchMatMulAswBlock, MM_CFG_NO_PRELOAD);
