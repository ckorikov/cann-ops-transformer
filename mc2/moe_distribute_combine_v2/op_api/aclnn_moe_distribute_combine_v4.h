 ...
 *
 */
ACLNN_API aclnnStatus aclnnMoeDistributeCombineV4GetWorkspaceSize(const aclTensor* expandX, const aclTensor* expertIds,
 ...
 */
ACLNN_API aclnnStatus aclnnMoeDistributeCombineV4(void* workspace, uint64_t workspaceSize, aclOpExecutor* executor,
                                                aclrtStream stream);
