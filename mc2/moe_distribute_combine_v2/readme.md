...
| 调用方式  | 样例代码                                  | 说明                                                     |
| :--------: | :----------------------------------------: | :-------------------------------------------------------: |
| aclnn接口 | [test_moe_distribute_combine_v2.cpp](test_moe_distribute_combine_v2.cpp) | 通过[aclnnMoeDistributeCombineV2](aclnnMoeDistributeCombineV2.md)接口方式调用moe_distribute_combine_v2算子。 |
