...
- **Shape变量约束**：
  ...
  | localExpertNum | 本卡专家数，取值范围为0 < localExpertNum ≤128：<ul><li>对于共享专家卡，localExpertNum = 1；</li><li>对于MoE专家卡，localExpertNum = <code>moeExpertNum/(epWorldSize-sharedExpertRankNum)</code>，localExpertNum > 1时不支持TP通信。 |
