...
<table style="undefined;table-layout: fixed; width: 1567px"> <colgroup>
 ...
 <tbody>
  <tr>
   <td>expandX</td>
   <td>输入</td>
   <td>根据expertIds进行扩展过的token特征，Device侧的aclTensor。 </td>
   <td><li>要求为一个2D的Tensor。</li><li>Atlas A2 训练系列产品/Atlas 800I A2 推理产品/A200I A2 Box 异构组件：不支持共享专家场景。</li></td>
  ...
  <tr>
   <td>expertIds</td>
   <td>输入</td>
   <td>每个token的topK个专家索引，Device侧的aclTensor。</td>
  ...
  <tr>
   ...
   <td>输入</td>
   <td>对应<code>aclnnMoeDistributeDispatchV3</code>的<code>assistInfoForCombineOut</code>输出，Device侧的aclTensor。</td>
  ...
  <tr>
   <td>epSendCounts</td>
   <td>输入</td>
   <td>对应<code>aclnnMoeDistributeDispatchV3</code>的<code>epRecvCounts</code>输出，Device侧的aclTensor。</td>
   <td>要求是一个1D的Tensor。</td>
   <td>INT32</td>
   <td><li>Atlas A2 训练系列产品/Atlas 800I A2 推理产品/A200I A2 Box 异构组件：要求shape为<code>(moeExpertNum + 2 * globalBs * K * serverNum, )</code>，前<code>moeExpertNum</code>个数表示从EP通信域各卡接收的token数，<code>2 * globalBs * K * serverNum</code>存储了机间机内做通信前combine可以提前做reduce的token个数和token在通信区中的偏移，globalBs传入0时在此处应当按照<code>Bs * epWorldSize</code>计算。</li><li>Atlas A3 训练系列产品/Atlas A3 推理系列产品：要求shape为 <code>(epWorldSize * max(tpWorldSize, 1) * localExpertNum, )</code>。</li></td>
   <td>ND</td>
  ...
  <tr>
   <td>expertScales</td>
   <td>输入</td>
   <td>每个token的topK个专家的权重，Device侧的aclTensor。</td>
  ...
  <tr>
   ...
   <td>有TP域通信时传参，否则传空指针：<br><term>Atlas A2 训练系列产品/Atlas 800I A2 推理产品/A200I A2 Box 异构组件</term>：当前不支持TP域通信。<br><term>Atlas A3 训练系列产品/Atlas A3 推理系列产品</term>：当有TP域通信时，要求是一个1D的Tensor，shape为 <code>(tpWorldSize, )</code>。
   <td>INT32</td>
   <td>ND</td>
   <td>当有TP域通信时，要求是一个1D的Tensor，shape为 <code>(tpWorldSize, )</code></td>
   <td>√</td>
  </tr>
  <tr>
  ...
  <tr>
   ...
   <td><br><term>Atlas A2 训练系列产品/Atlas 800I A2 推理产品/A200I A2 Box 异构组件</term>：要求是一个1D的Tensor。<br><term>Atlas A3 训练系列产品/Atlas A3 推理系列产品</term>：预留参数，当前版本不支持，传空指针即可。</td>
   <td>FLOAT32</td>
   <td>ND</td>
   <td><code>(A, )</code></td>
   <td>√</td>
  ...
  <tr>
   ...
   <td>输入</td>
   <td>表示共享专家计算后的token，Device侧的aclTensor。</td>
   <td><br><term>Atlas A2 训练系列产品/Atlas 800I A2 推理产品/A200I A2 Box 异构组件</term>：预留参数，当前版本不支持，传空指针即可。<br><term>Atlas A3 训练系列产品/Atlas A3 推理系列产品</term>：要求是一个2D或3D的Tensor，当Tensor为2D时，；当Tensor为3D时，前两位的乘积需等于Bs，第三维需等于H。数据类型需跟<code>expandX</code>保持一致。可传/可不传，传入时，<code>sharedExpertRankNum</code>需为0。</td>
   <td>FLOAT16、BFLOAT16</td>
   <td>ND</td>
  ...
  <tr>
   <td>oriXOptional</td>
   <td>输入</td>
   <td>Device侧的aclTensor，表示未经过FFN（Feed-Forward Neural network）的token数据。</td>
   <td>在使能copyExpert或使能constExpert的场景下需要本输入数据。可选择传入有效数据或填空指针，当<code>copyExpertNum</code>不为0或<code>constExpertNum</code>不为0时必须传入有效输入；当传入有效数据时，要求是一个2D的Tensor，数据类型需跟expandX保持一致。<br><term>Atlas A2 训练系列产品/Atlas 800I A2 推理产品/A200I A2 Box 异构组件</term>：当commAlg="hierarchy"时，当前版本不支持，传空指针即可。</td>
   <td>FLOAT16、BFLOAT16</td>
   <td>ND</td>
   <td><code>(Bs, H)</code></td>
   <td>√</td>
  ...
  <tr>
   ...
   <td><br><term>Atlas A2 训练系列产品/Atlas 800I A2 推理产品/A200I A2 Box 异构组件</term>：预留参数，当前版本不支持，传空指针即可。<br><term>Atlas A3 训练系列产品/Atlas A3 推理系列产品</term>：可选择传入有效数据或填空指针，当constExpertNum不为0时必须传入有效输入；当传入有效数据时，要求是一个2D的Tensor，数据类型需跟expandX保持一致。</td>
   <td>FLOAT16、BFLOAT16</td>
   <td>ND</td>
   <td><code>(constExpertNum, H)</code></td>
   <td>√</td>
  </tr>
  <tr>
  ...
  <tr>
   ...
   <td>单次算子调用各卡通信耗时会累加到该Tensor上，用户使用前按需清零。<br><term>Atlas A2 训练系列产品/Atlas 800I A2 推理产品/A200I A2 Box 异构组件</term>：可选择传入有效数据或填空指针，传入空指针时表示不使能记录通信耗时功能；当传入有效数据时，要求是一个1D的Tensor，shape为(ep\_world\_size,)，数据类型支持int64；数据格式要求为ND，支持非连续的Tensor。<br><term>Atlas A3 训练系列产品/Atlas A3 推理系列产品</term>：预留参数，当前版本不支持，传空指针即可。</td>
   <td>INT64</td>
   <td>ND</td>
   <td>-</td>
   <td>√</td>
  ...
  <tr>
   ...
   <td>输入</td>
   <td>EP通信域大小。</td>
   <td><br><term>Atlas A2 训练系列产品/Atlas 800I A2 推理产品/A200I A2 Box 异构组件</term>：依commAlg取值，"fullmesh"支持16、32、64、128、256；"hierarchy"支持16、32、64。<br><term>Atlas A3 训练系列产品/Atlas A3 推理系列产品</term>：取值支持[2, 768]。</td>
   <td>INT64</td>
   <td>-</td>
   <td>-</td>
   <td>-</td>
  ...
  <tr>
   ...
   <td>输入</td>
   <td>MoE专家数量。</td>
   <td>满足 <code>moeExpertNum % (epWorldSize - sharedExpertRankNum) = 0</code>：<br><term>Atlas A2 训练系列产品/Atlas 800I A2 推理产品/A200I A2 Box 异构组件</term>: 取值范围(0, 512], 还需满足<code>moeExpertNum / (epWorldSize - sharedExpertRankNum) <= 24</code>。<br><term>Atlas A3 训练系列产品/Atlas A3 推理系列产品</term>：取值范围(0, 1024]。</td>
   <td>INT64</td>
   <td>-</td>
   <td>-</td>
   <td>-</td>
  ...
  <tr>
   ...
   <td>输入</td>
   <td>TP通信域名称（数据并行）。</td>
   <td><br><term>Atlas A2 训练系列产品/Atlas 800I A2 推理产品/A200I A2 Box 异构组件</term>：当前版本不支持，传空字符即可。<br><term>Atlas A3 训练系列产品/Atlas A3 推理系列产品</term>：字符串长度范围为[1, 128)，不能和groupEp相同。</td>
   <td>STRING</td>
   <td>-</td>
   <td>-</td>
   <td>-</td>
  ...
  <tr>
   ...
   <td>输入</td>
   <td>TP通信域大小。</td>
   <td><br><term>Atlas A2 训练系列产品/Atlas 800I A2 推理产品/A200I A2 Box 异构组件</term>：当前版本不支持，传0即可。<br>><term>Atlas A3 训练系列产品/Atlas A3 推理系列产品：取值范围[0, 2]，0和1表示无TP域通信，有TP域通信时仅支持2。</term></td>
   <td>INT64</td>
   <td>-</td>
   <td>-</td>
   <td>-</td>
  ...
  <tr>
   ...
   <td>输入</td>
   <td>TP域本卡ID。</td>
   <td><br><term>Atlas A2 训练系列产品/Atlas 800I A2 推理产品/A200I A2 Box 异构组件</term>：当前版本不支持，传0即可。<br><term>Atlas A3 训练系列产品/Atlas A3 推理系列产品</term>：取值范围[0, 1]，同一个TP通信域中各卡的tpRankId不重复。无TP域通信时，传0即可。</td>
   <td>INT64</td>
   <td>-</td>
   <td>-</td>
   <td>-</td>
  ...
  <tr>
   ...
   <td>输入</td>
   <td>共享专家卡分布类型。</td>
   <td><br><term>Atlas A2 训练系列产品/Atlas 800I A2 推理产品/A200I A2 Box 异构组件</term>：当前版本不支持，传0即可。<br><term>Atlas A3 训练系列产品/Atlas A3 推理系列产品</term>：当前仅支持传0，表示共享专家卡排在MoE专家卡前面。</td>
   <td>INT64</td>
   <td>-</td>
   <td>-</td>
   <td>-</td>
  ...
  <tr>
   ...
   <td>输入</td>
   <td>共享专家卡分布类型。</td>
   <td><br><term>Atlas A2 训练系列产品/Atlas 800I A2 推理产品/A200I A2 Box 异构组件</term>：当前版本不支持，传0即可。<br><term>Atlas A3 训练系列产品/Atlas A3 推理系列产品</term>：当前取值范围[0, 4]。</td>
   <td>INT64</td>
   <td>-</td>
   <td>-</td>
   <td>-</td>
  ...
  <tr>
   ...
   <td>输入</td>
   <td>共享专家卡数量。</td>
   <td><br><term>Atlas A2 训练系列产品/Atlas 800I A2 推理产品/A200I A2 Box 异构组件</term>：当前版本不支持，传0即可.<br><term>Atlas A3 训练系列产品/Atlas A3 推理系列产品</term>：当前取值范围[0, epWorldSize)，为0时需满足sharedExpertNum为0或1，不为0时需满足<code>sharedExpertRankNum % sharedExpertNum = 0</code>。</td>
   <td>INT64</td>
   <td>-</td>
   <td>-</td>
   <td>-</td>
  ...
  <tr>
   ...
   <td>输入</td>
   <td>通信量化类型。</td>
   <td>取值范围0或者2，0表示通信时不进行量化，2表示通信时进行int8量化<br><term>Atlas A2 训练系列产品/Atlas 800I A2 推理产品/A200I A2 Box 异构组件</term>：2仅当commAlg配置为"hierarchy"或HCCL_INTRA_PCIE_ENABLE为1且HCCL_INTRA_ROCE_ENABLE为0且驱动版本不低于25.0.RC1.1时支持。<br><term>Atlas A3 训练系列产品/Atlas A3 推理系列产品</term>：int8量化当且仅当tpWorldSize < 2时可使能。</td>
   <td>INT64</td>
   <td>-</td>
   <td>-</td>
   <td>-</td>
  ...
  <tr>
   ...
   <td>输入</td>
   <td>常量专家数量。</td>
   <td><br><term>Atlas A2 训练系列产品/Atlas 800I A2 推理产品/A200I A2 Box 异构组件</term>：当前版本不支持，传0即可；<br><term>Atlas A3 训练系列产品/Atlas A3 推理系列产品</term>：取值范围:[0, MAX_INT32)，MAX_INT32 = 2^31 - 1, 合法的常量专家的ID的值是[<code>moeExpertNum + zeroExpertNum + copyExpertNum</code>, <code>moeExpertNum + zeroExpertNum + copyExpertNum + constExpertNum</code>)。</td>
   <td>INT64</td>
   <td>-</td>
   <td>-</td>
   <td>-</td>
...
<colgroup>
 ...
 <tbody>
  ...
  <tr>
   <td>workspaceSize</td>
   <td>输入</td>
   <td>在Device侧申请的workspace大小，由第一段接口<code>aclnnMoeDistributeCombineV4GetWorkspaceSize</code>获取。</td>
   <td>uint64_t</td>
  </tr>
  <tr>
   <td>executor</td>
...
- **通信域使用约束**：
    ...
    - 一个模型中的`aclnnMoeDistributeCombineV4`和`aclnnMoeDistributeDispatchV4`仅支持相同TP通信域或都不支持TP通信域；有TP通信域时，该通信域中不允许有其他算子。
