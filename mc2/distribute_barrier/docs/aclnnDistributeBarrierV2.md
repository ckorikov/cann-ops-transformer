...
- **参数说明**
    ...
    - <term>Atlas A2 训练系列产品/Atlas 800I A2 推理产品/A200I A2 Box 异构组件</term>：该产品下`elasticInfoOptional`仅支持传入空指针。
