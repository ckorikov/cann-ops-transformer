...
static ge::Status InplaceMatmulAllReduceAddRmsNormCalcOpParam(gert::ExeResGenerationContext* context)
{
    return Mc2GenTaskUtils::CommonKFCMc2CalcParamFunc(context, "aicpu kfc server", "kfc_stream");
}

ge::Status InplaceMatmulAllReduceAddRmsNormGenTask(
...
IMPL_OP_CT(InplaceMatmulAllReduceAddRmsNorm)
    .CalcOpParam(InplaceMatmulAllReduceAddRmsNormCalcOpParam)
    .GenerateTask(InplaceMatmulAllReduceAddRmsNormGenTask);
} // namespace ops
