...
<td>sendCounts</td>
<td>输入</td>
<td>表示发送给其他卡的token数，取值大小为e * epWorldSize，最大为256。</td>
<td>INT64（aclIntArray*）</td>
<td>ND</td>
</tr>
<tr>
<td>recvCounts</td>
<td>输入</td>
<td>表示接收其他卡的token数，取值大小为e * epWorldSize，最大为256。</td>
<td>INT64（aclIntArray*）</td>
<td>ND</td>
</tr>
<tr>
...
<td>gmmY</td>
<td>输出</td>
<td>表示最终的计算结果，数据类型与输入gmmX保持一致，支持2维，shape为(A, N1)。</td>
<td>FLOAT16、BFLOAT16</td>
<td>ND</td>
</tr>
<tr>
...
<td>输出</td>
<td>permute之后的输出，数据类型与gmmX保持一致。</td>
<td>FLOAT16、BFLOAT16</td>
<td>ND</td>
</tr>
</tbody>
...
| 调用方式  | 样例代码                                  | 说明                                                     |
| :--------: | :----------------------------------------: | :-------------------------------------------------------: |
| aclnn接口 | [test_allto_allv_grouped_mat_mul.cpp](test_allto_allv_grouped_mat_mul.cpp) | 通过[aclnnAlltoAllvGroupedMatMul](aclnnAlltoAllvGroupedMatMul.md)接口方式调用算子。 |