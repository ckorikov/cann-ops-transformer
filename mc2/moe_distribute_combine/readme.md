...
- HCCL_BUFFSIZE：
    ...
    - <term>昇腾910_95 AI处理器</term>：要求 >= aivNum \* 32 + 2 \* epWorldSize \* BS \* H \* 2 \* localExpertNum，aivNum表示核数，localExpertNum需使用MoE专家卡的本卡专家数。 
...
| 调用方式  | 样例代码                                  | 说明                                                     |
| :--------: | :----------------------------------------: | :-------------------------------------------------------: |
| aclnn接口 | [test_moe_distribute_combine.cpp](test_moe_distribute_combine.cpp) | 通过[aclnnMoeDistributeCombine](aclnnMoeDistributeCombine.md)接口方式调用moe_distribute_combine算子。 |
