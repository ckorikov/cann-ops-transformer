...
CreateInnerReduceInfo(uint32_t serverIdx)
{
    ...
    GlobalTensor<uint16_t> innerU16Gt = innerU8Gt.ReinterpretCast<uint16_t>();
    ...
    if (aivId_ != serverId_) {
        ...
        innerU16Gt = innerU8Gt.ReinterpretCast<uint16_t>();
        DataCopyPadExtParams<uint16_t> bsPadParams;
