...
<table style="undefined;table-layout: fixed; width: 1567px"> <colgroup>
 ...
 <tbody>
  <tr>
   <td>x</td>
   <td>输入</td>
   <td>本卡发送的token数据，Device侧的aclTensor。</td>
   <td>要求为2D Tensor。</td>
  ...
  <tr>
   <td>scales</td>
   <td>输入</td>
   <td>每个专家的平滑权重、融合量化平滑权重的量化系数或量化系数，Device侧的aclTensor。</td>
  ...
  <tr>
   <td>expertScales</td>
   <td>输入</td>
   <td>每个Token的topK个专家权重，Device侧的aclTensor。</td>
   <td>要求为2D Tensor。</td>
   <td>FLOAT32</td>
   <td>ND</td>
   <td>-</td>
  ...
  <tr>
   ...
   <td>输入</td>
   <td>表示量化模式。</td>
   <td>支持0：非量化，1：静态量化，2：pertoken动态量化，3：pergroup动态量化，4：mx量化。</td>
   <td>INT64</td>
   <td>ND</td>
   <td>-</td>
   <td>-</td>
  ...
  <tr>
   ...
   <td>要求为1D Tensor，仅当quantMode=2时有输出。</td>
   <td>FLOAT32</td>
   <td>ND</td>
   <td>(A, )</td>
   <td>√</td>
  ...
  <tr>
   ...
   <td>输出</td>
   <td>表示给同一专家发送的token个数（对应CombineV2系列算子中的assistInfoForCombine），Device侧的aclTensor。</td>
   <td>要求为1D Tensor。</td>
   <td>INT32</td>
   <td>ND</td>
   <td>(A*128, )</td>
  ...
  <tr>
   ...
   <td>输出</td>
   <td>表示每个专家收到的token个数，Device侧的aclTensor。</td>
   <td>要求为1D Tensor。</td>
   <td>INT64</td>
   <td>ND</td>
  ...
  <tr>
   ...
   <td>输出</td>
   <td>从EP通信域各卡接收的token数（对应CombineV2系列算子中的epSendCounts），Device侧的aclTensor。</td>
   <td>要求为1D Tensor。</td>
   <td>INT32</td>
   <td>ND</td>
   <td>-</td>
  ...
  <tr>
   ...
   <td>输出</td>
   <td>从TP通信域各卡接收的token数（对应CombineV2系列算子中的tpSendCounts），Device侧的aclTensor。</td>
  ...
  <tr>
   ...
   <td>输出</td>
   <td>表示本卡输出token的权重（对应CombineV2系列算子中的expertScalesOptional），Device侧的aclTensor。</td>
   <td>-</td>
   <td>FLOAT32</td>
   <td>ND</td>
   <td>-</td>
...
2. 在不同产品型号、不同通信算法或不同版本中，`aclnnMoeDistributeDispatchV2`的Tensor输出`assistInfoForCombineOut`、`epRecvCountsOut`、`tpRecvCountsOut`、`expandScalesOut`中的元素值可能不同，使用时直接将上述Tensor传给CombineV2系列算子对应参数即可，模型其他业务逻辑不应对其存在依赖。
