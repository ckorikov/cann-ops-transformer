...
#define TILINGKEY_DYNAMIC_QUANT 2
...
ASCENDC_TPL_ARGS_DECL(MoeDistributeDispatchV2,
    ...
    ASCENDC_TPL_UINT_DECL(TILINGKEY_QUANT_MODE, ASCENDC_TPL_4_BW, ASCENDC_TPL_UI_LIST, 
                        TILINGKEY_NO_QUANT, TILINGKEY_STATIC_QUANT, TILINGKEY_DYNAMIC_QUANT),
    ...
    ASCENDC_TPL_UINT_DECL(TILINGKEY_LAYER_MODE,ASCENDC_TPL_2_BW, ASCENDC_TPL_UI_LIST, 
                        TILINGKEY_TPL_MTE, TILINGKEY_TPL_AICPU),
    ASCENDC_TPL_UINT_DECL(ARCH_TAG, ASCENDC_TPL_2_BW, ASCENDC_TPL_UI_LIST, 
                        TILINGKEY_TPL_A2, TILINGKEY_TPL_A3),
);
ASCENDC_TPL_SEL(
    // A3
    ...
    ASCENDC_TPL_ARGS_SEL(
        ASCENDC_TPL_BOOL_SEL(TILINGKEY_TP, 0, 1),
        ASCENDC_TPL_UINT_SEL(TILINGKEY_QUANT_MODE, ASCENDC_TPL_UI_LIST, TILINGKEY_DYNAMIC_QUANT),
    ...
    ASCENDC_TPL_ARGS_SEL(
        ...
        ASCENDC_TPL_BOOL_SEL(TILINGKEY_SCALE, 0, 1), // A2
        ASCENDC_TPL_UINT_SEL(TILINGKEY_FULLMESH, ASCENDC_TPL_UI_LIST, TILINGKEY_NO_FULLMESH),
