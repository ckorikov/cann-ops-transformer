...
static bool CheckAttrsEmpty(const gert::TilingContext *context, const char *nodeName)
{
...
static bool CheckAttrValid(const gert::TilingContext *context, const char *nodeName, std::string &groupTp)
{
    auto attrs = context->GetAttrs();
    ...
    MoeDistributeDispatchV2TilingData &tilingData, std::string &groupEp, std::string &groupTp, bool &isSetCommAlg)
{
    ...
    OP_TILING_CHECK(!CheckAttrsEmpty(context, nodeName), OP_LOGE(nodeName, "empty attrs exist."), return ge::GRAPH_FAILED);
    OP_TILING_CHECK(!CheckAttrValid(context, nodeName, groupTp), OP_LOGE(nodeName, "invalid attrs exist."), return ge::GRAPH_FAILED);
...
static void CalTilingKey(const gert::TilingContext *context, MoeDistributeDispatchV2TilingData *tilingData, const char *nodeName,
