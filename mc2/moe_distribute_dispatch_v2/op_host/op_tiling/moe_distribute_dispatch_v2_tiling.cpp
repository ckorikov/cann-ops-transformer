...
static void CalTilingKey(const gert::TilingContext *context, MoeDistributeDispatchV2TilingData *tilingData, const bool isScales, 
    const uint32_t quantMode, const bool isSetCommAlg)
{
...
static ge::graphStatus SetAivInfo(const gert::TilingContext *context, MoeDistributeDispatchV2TilingData *tilingData, const char *nodeName)
{
...
static ge::graphStatus MoeDistributeDispatchA3TilingFuncImpl(gert::TilingContext *context)
{
    ...
    CalTilingKey(context, tilingData, isScales, quantMode, isSetCommAlg);
