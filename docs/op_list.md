...
| attention   | [mla_prolog_v3](../attention/mla_prolog_v3/README.md) |  推理MlaPrologV3WeightNz算子 |
...
| gmm         | [quant_grouped_matmul_inplace_add](../gmm/quant_grouped_matmul_inplace_add/README.md) | AI Core | 实现分组矩阵乘计算和加法计算 |
