...
#include "transformer/interleave_rope/op_host/interleave_rope_tiling.h"
...
TEST_F(InterleaveRopeTiling, interleave_rope_tiling_000)
{
    ...
    platform_info.Init();
    // compile info
    optiling::InterleaveRopeCompileInfo compile_info;

    std::string op_type("InterleaveRope");
...
{
    dlog_setlevel(0, 0, 0);
    gert::StorageShape x_shape = {{32, 32, 1, 63}, {32, 32, 1, 63}};
    gert::StorageShape cos_shape = {{32, 1, 1, 64}, {32, 1, 1, 64}};
    gert::StorageShape sin_shape = {{32, 1, 1, 64}, {32, 1, 1, 64}};
    gert::StorageShape y_shape = {{32, 32, 1, 64}, {32, 32, 1, 64}};
...
{
    dlog_setlevel(0, 0, 0);
    gert::StorageShape x_shape = {{32, 32, 1}, {32, 32, 1}};
    gert::StorageShape cos_shape = {{32, 1, 1, 64}, {32, 1, 1, 64}};
    gert::StorageShape sin_shape = {{32, 1, 1, 64}, {32, 1, 1, 64}};
    gert::StorageShape y_shape = {{32, 32, 1, 64}, {32, 32, 1, 64}};
...
TEST_F(InterleaveRopeTiling, interleave_rope_tiling_sin_not_eq_cos)
{
    ...
    gert::StorageShape x_shape = {{32, 32, 1, 63}, {32, 32, 1, 63}};
    gert::StorageShape cos_shape = {{32, 1, 1, 64}, {32, 1, 1, 64}};
    gert::StorageShape sin_shape = {{33, 1, 1, 64}, {33, 1, 1, 64}};
    gert::StorageShape y_shape = {{32, 32, 1, 64}, {32, 32, 1, 64}};
...
TEST_F(InterleaveRopeTiling, interleave_rope_tiling_cosB_not_eq_batch_size)
{
    dlog_setlevel(0, 0, 0);
    gert::StorageShape x_shape = {{32, 32, 1, 64}, {32, 32, 1, 64}};
    gert::StorageShape cos_shape = {{3, 1, 1, 64}, {3, 1, 1, 64}};
    gert::StorageShape sin_shape = {{3, 1, 1, 64}, {3, 1, 1, 64}};
    gert::StorageShape y_shape = {{32, 32, 1, 64}, {32, 32, 1, 64}};
...
TEST_F(InterleaveRopeTiling, interleave_rope_tiling_cosN_not_eq_1)
{
    dlog_setlevel(0, 0, 0);
    gert::StorageShape x_shape = {{32, 32, 1, 64}, {32, 32, 1, 64}};
    gert::StorageShape cos_shape = {{32, 3, 1, 64}, {32, 3, 1, 64}};
    gert::StorageShape sin_shape = {{32, 3, 1, 64}, {32, 3, 1, 64}};
    gert::StorageShape y_shape = {{32, 32, 1, 64}, {32, 32, 1, 64}};
...
TEST_F(InterleaveRopeTiling, interleave_rope_tiling_cosD_not_eq_HiddenDim)
{
    dlog_setlevel(0, 0, 0);
    gert::StorageShape x_shape = {{32, 32, 1, 64}, {32, 32, 1, 64}};
    gert::StorageShape cos_shape = {{32, 1, 1, 62}, {32, 1, 1, 62}};
    gert::StorageShape sin_shape = {{32, 1, 1, 62}, {32, 1, 1, 62}};
    gert::StorageShape y_shape = {{32, 32, 1, 64}, {32, 32, 1, 64}};
