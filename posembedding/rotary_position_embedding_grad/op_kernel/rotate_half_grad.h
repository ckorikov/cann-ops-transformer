...
protected:
    ...
    // init vector buffer
    TBuf<TPosition::VECCALC> tmpCalcBufOutCosGrad, tmpCalcBufOutSinGrad, tmpCalcBufA, tmpCalcBufB, tmpCalcBufC,
        tmpCalcBufCastRes, tmpCalcBufCastInCos, tmpCalcBufCastInSin, tmpCalcBufCastInGrad;
