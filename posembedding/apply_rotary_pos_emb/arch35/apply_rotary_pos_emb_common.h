...
constexpr uint32_t VL_FLOAT32_SIZE = platform::GetVRegSize() / sizeof(float);
constexpr uint32_t VL_FLOAT16_SIZE = platform::GetVRegSize() / sizeof(half);
constexpr uint32_t BLOCK_TYPE_SIZE = platform::GetUbBlockSize();
