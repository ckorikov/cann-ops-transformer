...
#include "fusedop/rope_with_sin_cos_cache/op_host/rope_with_sin_cos_cache_tiling.h"
...
TEST_F(RopeWithSinCosCacheTiling, test_tiling_bf16_true)
{
    ...
    gert::StorageShape queryOutShape = {{48, 256}, {48, 256}};
    gert::StorageShape keyOutShape = {{48, 512}, {48, 512}};
    ...
    std::string op_type("RopeWithSinCosCache");
    ...
    auto holder = gert::TilingContextFaker()
                      ...
                      .OutputShapes({&queryOutShape, &keyOutShape})
    ...
    auto holder = gert::TilingContextFaker()
                      ...
                      .NodeAttrs(
                          {{"numQHeads", ge::AnyValue::CreateFrom<int64_t>(2)},
                           ...
                           {"qstride", ge::AnyValue::CreateFrom<int64_t>(256)},
                           {"kstride", ge::AnyValue::CreateFrom<int64_t>(512)},
                           {"isNeoxStyle", ge::AnyValue::CreateFrom<int64_t>(0)}})
                      .TilingData(param.get())
                      .Workspace(ws_size)
                      .Build();
